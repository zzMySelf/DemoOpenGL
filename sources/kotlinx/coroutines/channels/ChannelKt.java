...
public final class ChannelKt {
    ...
    public static final <T> T m10414getOrElseWpGqRn0(Object $this$getOrElse, Function1<? super Throwable, ? extends T> onFailure) {
        return $this$getOrElse instanceof ChannelResult.Failed ? onFailure.invoke(ChannelResult.m10422exceptionOrNullimpl($this$getOrElse)) : $this$getOrElse;
    }

    /* renamed from: onSuccess-WpGqRn0  reason: not valid java name */
    public static final <T> Object m10417onSuccessWpGqRn0(Object $this$onSuccess, Function1<? super T, Unit> action) {
    ...
    public static final <T> Object m10416onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            action.invoke(ChannelResult.m10422exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0  reason: not valid java name */
    public static final <T> Object m10415onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> action) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            action.invoke(ChannelResult.m10422exceptionOrNullimpl($this$onClosed));
        }
    ...
    public static final <E> Channel<E> Channel(int capacity, BufferOverflow onBufferOverflow, Function1<? super E, Unit> onUndeliveredElement) {
        ...
        switch (capacity) {
            case -2:
                ...
                return new ArrayChannel<>(i2, onBufferOverflow, onUndeliveredElement);
            case -1:
                if (onBufferOverflow != BufferOverflow.SUSPEND) {
                    i2 = 0;
                }
    ...
    public static /* synthetic */ Channel Channel$default(int i2, int i3, Object obj) {
        ...
        return Channel$default(i2, (BufferOverflow) null, (Function1) null, 6, (Object) null);
    }
}
