...
public final class DelayKt {
    ...
    public static final Object m10399delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m10400toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m10400toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m10256compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m10359getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m10275getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
