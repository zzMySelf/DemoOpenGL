...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable it = Result.m8974exceptionOrNullimpl(result);
        if (it != null) {
    ...
    public Object emit(T value, Continuation<? super Unit> $completion) {
        try {
            ...
            this.lastEmissionContext = new DownstreamExceptionElement(e2);
            throw e2;
        }
    }
    ...
    private final void exceptionTransparencyViolated(DownstreamExceptionElement exception, Object value) {
        throw new IllegalStateException(StringsKt.trimIndent("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + exception.f7789e + ", but then emission attempt of value '" + value + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
}
