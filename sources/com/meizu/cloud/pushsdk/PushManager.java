...
public class PushManager {
    ...
    public static final String TAG = "4.2.7";
    ...
    public static String getPushId(Context context) {
        int h2 = com.meizu.q0.b.h(context, context.getPackageName());
        if (h2 == 0 || System.currentTimeMillis() / 1000 <= ((long) h2)) {
            return com.meizu.q0.b.g(context, context.getPackageName());
        }
        return null;
    }
