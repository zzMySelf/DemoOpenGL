...
public class LoadingUtil {
    ...
    private static View createView(Context context, String str) {
        ...
        if (confignation == null || (!DarkModeUtil.isDarkMode(context) && !confignation.isNightMode)) {
            view2 = from.inflate(R.layout.layout_sapi_sdk_common_loading, (ViewGroup) null);
        } else {
            view2 = from.inflate(R.layout.layout_sapi_sdk_common_night_loading, (ViewGroup) null);
        }
        ((TextView) view2.findViewById(R.id.sapi_sdk_toast_msg_tv)).setText(str);
        return view2;
    }
