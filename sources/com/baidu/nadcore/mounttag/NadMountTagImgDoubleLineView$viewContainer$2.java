...
final class NadMountTagImgDoubleLineView$viewContainer$2 extends Lambda implements Function0<FrameLayout> {
    final /* synthetic */ NadMountTagImgDoubleLineView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadMountTagImgDoubleLineView$viewContainer$2(NadMountTagImgDoubleLineView nadMountTagImgDoubleLineView) {
        super(0);
        this.this$0 = nadMountTagImgDoubleLineView;
    }

    public final FrameLayout invoke() {
        return (FrameLayout) this.this$0.findViewById(R.id.mount_tag_container);
    }
}
