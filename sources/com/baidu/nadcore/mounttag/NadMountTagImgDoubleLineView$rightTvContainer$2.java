...
final class NadMountTagImgDoubleLineView$rightTvContainer$2 extends Lambda implements Function0<LinearLayout> {
    final /* synthetic */ NadMountTagImgDoubleLineView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadMountTagImgDoubleLineView$rightTvContainer$2(NadMountTagImgDoubleLineView nadMountTagImgDoubleLineView) {
        super(0);
        this.this$0 = nadMountTagImgDoubleLineView;
    }

    public final LinearLayout invoke() {
        return (LinearLayout) this.this$0.findViewById(R.id.right_tv_bg);
    }
}
