...
final class NadRewardImageView$imageContainer$2 extends Lambda implements Function0<FrameLayout> {
    final /* synthetic */ NadRewardImageView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadRewardImageView$imageContainer$2(NadRewardImageView nadRewardImageView) {
        super(0);
        this.this$0 = nadRewardImageView;
    }

    public final FrameLayout invoke() {
        return (FrameLayout) this.this$0.findViewById(R.id.image_container);
    }
}
