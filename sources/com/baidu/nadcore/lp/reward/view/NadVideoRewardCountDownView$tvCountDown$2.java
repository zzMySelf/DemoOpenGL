...
final class NadVideoRewardCountDownView$tvCountDown$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ NadVideoRewardCountDownView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadVideoRewardCountDownView$tvCountDown$2(NadVideoRewardCountDownView nadVideoRewardCountDownView) {
        super(0);
        this.this$0 = nadVideoRewardCountDownView;
    }

    public final TextView invoke() {
        return (TextView) this.this$0.findViewById(R.id.tv_countdown);
    }
}
