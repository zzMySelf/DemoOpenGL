...
final class NadRewardFullTailView$moreBtnIcon$2 extends Lambda implements Function0<AdImageView> {
    final /* synthetic */ NadRewardFullTailView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadRewardFullTailView$moreBtnIcon$2(NadRewardFullTailView nadRewardFullTailView) {
        super(0);
        this.this$0 = nadRewardFullTailView;
    }

    public final AdImageView invoke() {
        return (AdImageView) this.this$0.findViewById(R.id.more_btn_icon);
    }
}
