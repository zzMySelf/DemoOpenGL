...
final class NadCarouselBaseView$closeIcon$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ NadCarouselBaseView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadCarouselBaseView$closeIcon$2(NadCarouselBaseView nadCarouselBaseView) {
        super(0);
        this.this$0 = nadCarouselBaseView;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.nad_carousel_close);
    }
}
