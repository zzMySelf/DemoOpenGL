...
final class NadCarouselBaseView$brandSubTitle$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ NadCarouselBaseView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NadCarouselBaseView$brandSubTitle$2(NadCarouselBaseView nadCarouselBaseView) {
        super(0);
        this.this$0 = nadCarouselBaseView;
    }

    public final TextView invoke() {
        return (TextView) this.this$0.findViewById(R.id.carousel_sub_title);
    }
}
