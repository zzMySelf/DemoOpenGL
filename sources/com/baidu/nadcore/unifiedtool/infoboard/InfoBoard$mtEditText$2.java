...
final class InfoBoard$mtEditText$2 extends Lambda implements Function0<EditText> {
    final /* synthetic */ InfoBoard this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InfoBoard$mtEditText$2(InfoBoard infoBoard) {
        super(0);
        this.this$0 = infoBoard;
    }

    public final EditText invoke() {
        return (EditText) this.this$0.findViewById(R.id.nad_als_board_edit_text_mt);
    }
}
