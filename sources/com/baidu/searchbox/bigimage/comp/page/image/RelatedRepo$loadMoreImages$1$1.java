...
final class RelatedRepo$loadMoreImages$1$1 extends Lambda implements Function1<String, Object> {
    final /* synthetic */ RelatedRepo this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RelatedRepo$loadMoreImages$1$1(RelatedRepo relatedRepo) {
        super(1);
    ...
    public final Object invoke(String data) {
        if (data != null && !TextUtils.isEmpty(data)) {
            return this.this$0.parseMoreImages(new JSONObject(data));
        }
