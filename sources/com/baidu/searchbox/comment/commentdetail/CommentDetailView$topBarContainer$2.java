...
final class CommentDetailView$topBarContainer$2 extends Lambda implements Function0<RelativeLayout> {
    final /* synthetic */ CommentDetailView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CommentDetailView$topBarContainer$2(CommentDetailView commentDetailView) {
        super(0);
        this.this$0 = commentDetailView;
    }

    public final RelativeLayout invoke() {
        return (RelativeLayout) this.this$0.findViewById(R.id.comment_detail_title_bar);
    }
}
