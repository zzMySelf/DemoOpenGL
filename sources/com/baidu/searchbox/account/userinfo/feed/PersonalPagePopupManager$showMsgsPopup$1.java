...
final class PersonalPagePopupManager$showMsgsPopup$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ String $popup;
    final /* synthetic */ PersonalPagePopupManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PersonalPagePopupManager$showMsgsPopup$1(PersonalPagePopupManager personalPagePopupManager, String str) {
        super(1);
    ...
    public final void invoke(boolean success) {
        if (success) {
            this.this$0.showTalosBallOnce(this.$popup);
        }
    }
}
