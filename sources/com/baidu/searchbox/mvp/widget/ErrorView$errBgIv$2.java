...
final class ErrorView$errBgIv$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ ErrorView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ErrorView$errBgIv$2(ErrorView errorView) {
        super(0);
        this.this$0 = errorView;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.err_bg_iv);
    }
}
