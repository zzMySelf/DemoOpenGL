...
final class FileSearchActivity$mSearchOrCancelText$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ FileSearchActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FileSearchActivity$mSearchOrCancelText$2(FileSearchActivity fileSearchActivity) {
        super(0);
        this.this$0 = fileSearchActivity;
    }

    public final TextView invoke() {
        return (TextView) this.this$0.findViewById(R.id.search_or_cancel);
    }
}
