...
public class DownloadStatisticConstants {
    ...
    public static final String UBC_EXT_KEY_NAME = "name";
    public static final String UBC_EXT_KEY_PARTNER = "partner";
    public static final String UBC_EXT_KEY_PARTNER_NAME = "partner_name";
    ...
    public static final String UBC_TYPE_LIVE_PLAY = "live_play";
    ...
    public static final String UBC_VALUE_BASE = "base";
    public static final String UBC_VALUE_BEIFEN = "beifen";
    ...
    public static final String UBC_VALUE_FAST_DOWNLOAD = "fastdownload";
    ...
    public static final String UBC_VALUE_RESTART = "restart";
    ...
    public static final String UBC_VALUE_WENJIAN = "wenjian";
