...
public abstract class SQLiteTransaction {
    ...
    public void run(android.database.sqlite.SQLiteDatabase r4) {
        ...
        L_0x0023:
            r0 = move-exception
            boolean r1 = com.baidu.searchbox.config.AppConfig.isDebug()     // Catch:{ all -> 0x0021 }
        ...
        L_0x0048:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.searchbox.ai.model.SQLiteTransaction.run(android.database.sqlite.SQLiteDatabase):void");
    }
