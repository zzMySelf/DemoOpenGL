...
/* compiled from: YouthHomeResourceProcessor.kt */
final class YouthHomeResourceProcessor$checkResources$downloadFileHandler$1 extends Lambda implements Function2<Boolean, DownloadTaskInfo, CancelableTask> {
    final /* synthetic */ YouthHomeResModel $downloadInfo;
    ...
    final /* synthetic */ YouthHomeResourceProcessor this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YouthHomeResourceProcessor$checkResources$downloadFileHandler$1(YouthHomeResModel youthHomeResModel, Ref.ObjectRef<Map<String, String>> objectRef, YouthHomeResourceProcessor youthHomeResourceProcessor, List<String> list, Function1<? super Boolean, Unit> function1) {
        super(2);
        this.$downloadInfo = youthHomeResModel;
        this.$pathMap = objectRef;
        this.this$0 = youthHomeResourceProcessor;
    ...
    public final CancelableTask invoke(boolean isSucceed, DownloadTaskInfo taskInfo) {
        ...
        final YouthHomeResModel youthHomeResModel = this.$downloadInfo;
        final Ref.ObjectRef<Map<String, String>> objectRef = this.$pathMap;
        final YouthHomeResourceProcessor youthHomeResourceProcessor = this.this$0;
        ...
        return YouthHomeCommonKt.youthHomeAsyncWork(new Function0<Unit>() {
            public final void invoke() {
                if (z) {
                    String md5 = youthHomeResModel.getMd5();
                    ...
                    if (Intrinsics.areEqual((Object) HashUtilsKt.getFileMD5(downloadedPath), (Object) md5)) {
                        objectRef.element = youthHomeResourceProcessor.handleResZip(youthHomeResModel, list, downloadedPath);
                    }
                }
