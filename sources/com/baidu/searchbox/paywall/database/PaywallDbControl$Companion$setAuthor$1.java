...
final class PaywallDbControl$Companion$setAuthor$1 extends Lambda implements Function3<PaywallDbControl.COLUMN, Cursor, PaywallItem, Unit> {
    public static final PaywallDbControl$Companion$setAuthor$1 INSTANCE = new PaywallDbControl$Companion$setAuthor$1();

    PaywallDbControl$Companion$setAuthor$1() {
        super(3);
    }
