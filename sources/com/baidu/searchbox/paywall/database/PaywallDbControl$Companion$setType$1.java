...
final class PaywallDbControl$Companion$setType$1 extends Lambda implements Function3<PaywallDbControl.COLUMN, Cursor, PaywallItem, Unit> {
    public static final PaywallDbControl$Companion$setType$1 INSTANCE = new PaywallDbControl$Companion$setType$1();

    PaywallDbControl$Companion$setType$1() {
        super(3);
    }
