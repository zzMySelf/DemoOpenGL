...
final class PaywallWebApi$Companion$searchResource$2 extends Lambda implements Function1<ErrorInfo, Unit> {
    final /* synthetic */ PaywallWebApi.Callback<ArrayList<PaywallItem>> $callback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PaywallWebApi$Companion$searchResource$2(PaywallWebApi.Callback<ArrayList<PaywallItem>> callback) {
        super(1);
    ...
    public final void invoke(ErrorInfo it) {
        ...
        PaywallWebApi.Callback.DefaultImpls.onFail$default(this.$callback, (String) null, 1, (Object) null);
    }
}
