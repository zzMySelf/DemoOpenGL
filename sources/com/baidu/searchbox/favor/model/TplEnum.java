...
public class TplEnum {
    ...
    public static final String TPL_FAVOR_PRODUCT = "product";
    public static final String TPL_FEED_AD = "feed_ad";
    public static final String TPL_FEED_ATLAS = "feed_atlas";
    public static final String TPL_FEED_AUDIO = "feed_audio";
    public static final String TPL_FEED_COLLECTION = "feed_collection";
    ...
    public static final String TPL_FEED_PLAYLET = "feed_playlet";
    ...
    public static final String TPL_SEARCH_VIDEO_COLLECTION = "search_video_collection";
    public static final String TPL_SEARCH_VIDEO_PLAYLET = "search_video_playlet";
    ...
    public static final String TPL_WENKU_IMAGE = "wenku_image";

    public static boolean isTemplateVideo(String tplId) {
        if (TextUtils.isEmpty(tplId)) {
            return false;
        }
        if (tplId.equals("common_video") || tplId.equals("common_collection") || tplId.equals("feed_video") || tplId.equals("feed_collection") || tplId.equals("feed_playlet") || tplId.equals("feed_minivideo") || tplId.equals("mars_video") || tplId.equals("search_video") || tplId.equals("search_minivideo") || tplId.equals(TPL_SEARCH_VIDEO_COLLECTION) || tplId.equals(TPL_SEARCH_VIDEO_PLAYLET)) {
            return true;
        }
        return false;
    }
