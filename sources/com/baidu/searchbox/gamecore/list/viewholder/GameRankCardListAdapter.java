...
public class GameRankCardListAdapter extends GameBaseRecyclerViewAdapter<GameRankCardListItemViewHolder> {
    ...
    public GameRankCardListItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new GameRankCardListItemViewHolder(this.mRankModule, parent);
    }

    public void onBindViewHolder(GameRankCardListItemViewHolder holder, int listPosition) {
        super.onBindViewHolder(holder, listPosition);
        holder.bindData(this.mRankItemDataList.get(listPosition), this.mRankTitle, listPosition, this.mViewPagerPosition, this.mParentCardPosition);
    }
