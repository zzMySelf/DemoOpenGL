...
final class AiCreativeImageCreatingComponentRegister$collectPlugin$3 extends Lambda implements Function0<IPlugin> {
    public static final AiCreativeImageCreatingComponentRegister$collectPlugin$3 INSTANCE = new AiCreativeImageCreatingComponentRegister$collectPlugin$3();

    AiCreativeImageCreatingComponentRegister$collectPlugin$3() {
        super(0);
    }

    public final IPlugin invoke() {
        return new AiCreativeImageCreatingPlugin();
    }
}
