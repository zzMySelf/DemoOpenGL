...
final class BaseRecErrorView$title$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ BaseRecErrorView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseRecErrorView$title$2(BaseRecErrorView baseRecErrorView) {
        super(0);
        this.this$0 = baseRecErrorView;
    }

    public final TextView invoke() {
        return (TextView) this.this$0.findViewById(R.id.browser_rec_error_view_title);
    }
}
