...
final class DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$2 extends Lambda implements Function3<Context, String, String, DeviceIdBag> {
    public static final DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$2 INSTANCE = new DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$2();

    DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$2() {
        super(3);
    }
