...
final class DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$4 extends Lambda implements Function3<Context, String, String, DeviceIdBag> {
    public static final DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$4 INSTANCE = new DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$4();

    DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$4() {
        super(3);
    }
