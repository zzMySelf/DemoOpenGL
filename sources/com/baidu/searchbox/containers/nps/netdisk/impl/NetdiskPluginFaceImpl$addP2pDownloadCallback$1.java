...
final class NetdiskPluginFaceImpl$addP2pDownloadCallback$1 extends Lambda implements Function3<Integer, Integer, String, Unit> {
    final /* synthetic */ Function2<Integer, String, Unit> $onNetdiskPluginInvokeFailed;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NetdiskPluginFaceImpl$addP2pDownloadCallback$1(Function2<? super Integer, ? super String, Unit> function2) {
        super(3);
