...
final class NetdiskPluginFaceImpl$queryMagnetSeedResInfo$1 extends Lambda implements Function3<Integer, Integer, String, Unit> {
    ...
    NetdiskPluginFaceImpl$queryMagnetSeedResInfo$1(NetdiskPluginFaceImpl netdiskPluginFaceImpl, Function2<? super Integer, ? super String, Unit> function2) {
        super(3);
    ...
    public final void invoke(Integer failedStage, Integer errorCode, String errorMsg) {
        this.this$0.doNetdiskInvokeUbc("magnet", false, failedStage, errorCode, errorMsg);
