...
final class NetdiskPluginFaceImpl$gotoBackupPage$1 extends Lambda implements Function4<Boolean, Integer, Integer, String, Unit> {
    ...
    NetdiskPluginFaceImpl$gotoBackupPage$1(NetdiskPluginFaceImpl netdiskPluginFaceImpl, NetdiskInvokeExtInfo netdiskInvokeExtInfo, Function3<? super Boolean, ? super Integer, ? super String, Unit> function3) {
        super(4);
