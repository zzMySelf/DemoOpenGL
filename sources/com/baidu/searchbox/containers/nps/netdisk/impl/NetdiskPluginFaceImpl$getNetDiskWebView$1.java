...
final class NetdiskPluginFaceImpl$getNetDiskWebView$1 extends Lambda implements Function3<Integer, Integer, String, Unit> {
    final /* synthetic */ Function1<INetDiskWebView, Unit> $callback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NetdiskPluginFaceImpl$getNetDiskWebView$1(Function1<? super INetDiskWebView, Unit> function1) {
        super(3);
