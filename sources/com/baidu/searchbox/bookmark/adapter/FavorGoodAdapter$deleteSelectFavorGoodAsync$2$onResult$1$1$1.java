...
/* compiled from: FavorGoodAdapter.kt */
final class FavorGoodAdapter$deleteSelectFavorGoodAsync$2$onResult$1$1$1 extends Lambda implements Function1<FavorModel, Boolean> {
    final /* synthetic */ String $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FavorGoodAdapter$deleteSelectFavorGoodAsync$2$onResult$1$1$1(String str) {
        super(1);
        this.$key = str;
    }
