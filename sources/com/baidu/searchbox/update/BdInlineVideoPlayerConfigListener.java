...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\b\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J0\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u00042\b\u0010\u0011\u001a\u0004\u0018\u00010\u00042\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013H\u0016J6\u0010\u0014\u001a\u00020\u00152\b\u0010\u000e\u001a\u0004\u0018\u00010\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u00042\b\u0010\u0011\u001a\u0004\u0018\u00010\u00042\u000e\u0010\u0016\u001a\n\u0012\u0004\u0012\u00020\u0018\u0018\u00010\u0017H\u0016J&\u0010\u0019\u001a\u00020\u00042\b\u0010\u000e\u001a\u0004\u0018\u00010\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u00042\b\u0010\u0011\u001a\u0004\u0018\u00010\u0004H\u0016J\u0010\u0010\u001a\u001a\u00020\r2\u0006\u0010\u001b\u001a\u00020\u0018H\u0002R+\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u00048B@BX\u0002¢\u0006\u0012\n\u0004\b\n\u0010\u000b\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\u001c"}, d2 = {"Lcom/baidu/searchbox/update/BdInlineVideoPlayerConfigListener;", "Lcom/baidu/searchbox/net/update/v2/JSONObjectCommandListener;", "()V", "<set-?>", "", "versionData", "getVersionData", "()Ljava/lang/String;", "setVersionData", "(Ljava/lang/String;)V", "versionData$delegate", "Lcom/baidu/searchbox/video/detail/switcher/VideoSPData;", "addPostData", "", "context", "Landroid/content/Context;", "module", "action", "postData", "Lcom/baidu/searchbox/net/update/CommandPostData;", "executeCommand", "", "value", "Lcom/baidu/searchbox/net/update/v2/ActionData;", "Lorg/json/JSONObject;", "getLocalVersion", "saveConfig", "data", "lib-feed-video_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* compiled from: BdInlineVideoPlayerConfigListener.kt */
public final class BdInlineVideoPlayerConfigListener extends JSONObjectCommandListener {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.mutableProperty1(new MutablePropertyReference1Impl(BdInlineVideoPlayerConfigListener.class, "versionData", "getVersionData()Ljava/lang/String;", 0))};
    private final VideoSPData versionData$delegate = new VideoSPData("video_player_inline_referer_config_version", "0", false, (String) null, 12, (DefaultConstructorMarker) null);
    ...
    public void addPostData(Context context, String module, String action, CommandPostData postData) {
        ...
        if (postData != null && (version = postData.getVersion()) != null) {
            version.put("video_player_inline_referer_config", getLocalVersion(context, module, action));
        }
    }
    ...
    public boolean executeCommand(Context context, String module, String action, ActionData<JSONObject> value) {
        ...
        if (!(charSequence == null || charSequence.length() == 0)) {
            ...
            if (jSONObject == null || !Intrinsics.areEqual((Object) action, (Object) "video_player_inline_referer_config") || Intrinsics.areEqual((Object) getLocalVersion(context, module, action), (Object) value.version)) {
                return false;
            }
    ...
    private final void saveConfig(JSONObject data) {
        BdInlineVideoPlayerConfig.setRefererEnabled(data.optBoolean("video_player_inline_referer_switch", true));
    }
}
