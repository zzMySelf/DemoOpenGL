...
final class CollectionFlowComponentRegister$collectPlugin$2 extends Lambda implements Function0<IPlugin> {
    public static final CollectionFlowComponentRegister$collectPlugin$2 INSTANCE = new CollectionFlowComponentRegister$collectPlugin$2();

    CollectionFlowComponentRegister$collectPlugin$2() {
        super(0);
    }
