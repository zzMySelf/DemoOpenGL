...
final class ChannelTabComponentRegister$collectPlugin$8 extends Lambda implements Function0<IPlugin> {
    public static final ChannelTabComponentRegister$collectPlugin$8 INSTANCE = new ChannelTabComponentRegister$collectPlugin$8();

    ChannelTabComponentRegister$collectPlugin$8() {
        super(0);
    }
