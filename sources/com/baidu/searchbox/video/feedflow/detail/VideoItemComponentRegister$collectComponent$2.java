...
final class VideoItemComponentRegister$collectComponent$2 extends Lambda implements Function0<UiComponent> {
    public static final VideoItemComponentRegister$collectComponent$2 INSTANCE = new VideoItemComponentRegister$collectComponent$2();

    VideoItemComponentRegister$collectComponent$2() {
        super(0);
    }
