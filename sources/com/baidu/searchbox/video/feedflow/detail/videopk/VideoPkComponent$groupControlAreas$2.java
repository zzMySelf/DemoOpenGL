...
final class VideoPkComponent$groupControlAreas$2 extends Lambda implements Function0<List<GroupControlArea>> {
    public static final VideoPkComponent$groupControlAreas$2 INSTANCE = new VideoPkComponent$groupControlAreas$2();

    VideoPkComponent$groupControlAreas$2() {
        super(0);
    }
