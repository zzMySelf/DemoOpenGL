...
/* compiled from: PersonalizedContentItemStore.kt */
public final class PersonalizedContentItemStoreKt {
    public static final List<Middleware<CommonState>> collectionMiddleware() {
        ...
        $this$collectionMiddleware_u24lambda_u2d0.add(new PersonalizedContentItemMiddlewareAdapter());
        $this$collectionMiddleware_u24lambda_u2d0.addAll(StaticContentAutoPlayTimerUnit.INSTANCE.createMiddlewares());
        $this$collectionMiddleware_u24lambda_u2d0.addAll(PersonalizedContentUnit.INSTANCE.createMiddlewares());
        return arrayList;
    }
    ...
    public static final List<Reducer<CommonState>> collectReducer() {
        ...
        $this$collectReducer_u24lambda_u2d1.add(PersonalizedContentUnit.INSTANCE.createReducer());
