...
final class DynamicItemComponentRegister$collectPlugin$12 extends Lambda implements Function0<IPlugin> {
    public static final DynamicItemComponentRegister$collectPlugin$12 INSTANCE = new DynamicItemComponentRegister$collectPlugin$12();

    DynamicItemComponentRegister$collectPlugin$12() {
        super(0);
    }

    public final IPlugin invoke() {
        return new TalosPanelPlugin();
    }
}
