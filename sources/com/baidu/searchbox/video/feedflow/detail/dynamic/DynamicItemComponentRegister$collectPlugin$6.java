...
final class DynamicItemComponentRegister$collectPlugin$6 extends Lambda implements Function0<IPlugin> {
    public static final DynamicItemComponentRegister$collectPlugin$6 INSTANCE = new DynamicItemComponentRegister$collectPlugin$6();

    DynamicItemComponentRegister$collectPlugin$6() {
        super(0);
    }
