...
/* compiled from: BottomDiversionComponent.kt */
final class BottomDiversionComponent$groupControlAreas$2 extends Lambda implements Function0<List<GroupControlArea>> {
    public static final BottomDiversionComponent$groupControlAreas$2 INSTANCE = new BottomDiversionComponent$groupControlAreas$2();

    BottomDiversionComponent$groupControlAreas$2() {
        super(0);
    }
