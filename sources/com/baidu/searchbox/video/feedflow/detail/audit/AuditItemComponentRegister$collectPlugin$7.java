...
final class AuditItemComponentRegister$collectPlugin$7 extends Lambda implements Function0<IPlugin> {
    public static final AuditItemComponentRegister$collectPlugin$7 INSTANCE = new AuditItemComponentRegister$collectPlugin$7();

    AuditItemComponentRegister$collectPlugin$7() {
        super(0);
    }
