...
final class AuditItemComponentRegister$collectPlugin$5 extends Lambda implements Function0<IPlugin> {
    public static final AuditItemComponentRegister$collectPlugin$5 INSTANCE = new AuditItemComponentRegister$collectPlugin$5();

    AuditItemComponentRegister$collectPlugin$5() {
        super(0);
    }
