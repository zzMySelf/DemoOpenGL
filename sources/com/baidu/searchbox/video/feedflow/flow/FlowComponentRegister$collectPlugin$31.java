...
final class FlowComponentRegister$collectPlugin$31 extends Lambda implements Function0<IPlugin> {
    public static final FlowComponentRegister$collectPlugin$31 INSTANCE = new FlowComponentRegister$collectPlugin$31();

    FlowComponentRegister$collectPlugin$31() {
        super(0);
    }
