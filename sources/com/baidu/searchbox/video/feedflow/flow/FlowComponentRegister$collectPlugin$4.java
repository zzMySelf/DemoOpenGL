...
final class FlowComponentRegister$collectPlugin$4 extends Lambda implements Function0<IPlugin> {
    public static final FlowComponentRegister$collectPlugin$4 INSTANCE = new FlowComponentRegister$collectPlugin$4();

    FlowComponentRegister$collectPlugin$4() {
        super(0);
    }
