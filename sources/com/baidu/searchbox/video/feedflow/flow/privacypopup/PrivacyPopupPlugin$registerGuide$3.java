...
final class PrivacyPopupPlugin$registerGuide$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ PrivacyPopupPlugin this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PrivacyPopupPlugin$registerGuide$3(PrivacyPopupPlugin privacyPopupPlugin) {
        super(0);
