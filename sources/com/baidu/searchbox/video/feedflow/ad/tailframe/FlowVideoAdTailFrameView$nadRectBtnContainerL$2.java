...
final class FlowVideoAdTailFrameView$nadRectBtnContainerL$2 extends Lambda implements Function0<FrameLayout> {
    final /* synthetic */ FlowVideoAdTailFrameView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FlowVideoAdTailFrameView$nadRectBtnContainerL$2(FlowVideoAdTailFrameView flowVideoAdTailFrameView) {
        super(0);
        this.this$0 = flowVideoAdTailFrameView;
    }

    public final FrameLayout invoke() {
        return (FrameLayout) this.this$0.findViewById(R.id.tail_frame_convert_btn_container_nad_rect_landscape);
    }
}
