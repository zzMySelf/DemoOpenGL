...
final class FlowVideoAdTailFrameView$replayBtnIcon$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ FlowVideoAdTailFrameView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FlowVideoAdTailFrameView$replayBtnIcon$2(FlowVideoAdTailFrameView flowVideoAdTailFrameView) {
        super(0);
        this.this$0 = flowVideoAdTailFrameView;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.tail_frame_replay_btn_icon);
    }
}
