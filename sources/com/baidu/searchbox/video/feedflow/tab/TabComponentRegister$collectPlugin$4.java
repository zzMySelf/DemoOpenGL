...
final class TabComponentRegister$collectPlugin$4 extends Lambda implements Function0<IPlugin> {
    public static final TabComponentRegister$collectPlugin$4 INSTANCE = new TabComponentRegister$collectPlugin$4();

    TabComponentRegister$collectPlugin$4() {
        super(0);
    }

    public final IPlugin invoke() {
        return DurationPadUnit.INSTANCE.createPlugin();
    }
}
