...
final class TabComponentRegister$collectPlugin$35 extends Lambda implements Function0<IPlugin> {
    public static final TabComponentRegister$collectPlugin$35 INSTANCE = new TabComponentRegister$collectPlugin$35();

    TabComponentRegister$collectPlugin$35() {
        super(0);
    }
