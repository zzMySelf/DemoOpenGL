...
final class TabComponentRegister$collectPlugin$33 extends Lambda implements Function0<IPlugin> {
    public static final TabComponentRegister$collectPlugin$33 INSTANCE = new TabComponentRegister$collectPlugin$33();

    TabComponentRegister$collectPlugin$33() {
        super(0);
    }

    public final IPlugin invoke() {
        return ClearScreenNewUnit.INSTANCE.createPlugin();
    }
}
