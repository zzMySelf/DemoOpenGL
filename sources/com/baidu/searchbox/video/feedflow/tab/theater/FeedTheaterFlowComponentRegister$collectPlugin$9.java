...
final class FeedTheaterFlowComponentRegister$collectPlugin$9 extends Lambda implements Function0<IPlugin> {
    public static final FeedTheaterFlowComponentRegister$collectPlugin$9 INSTANCE = new FeedTheaterFlowComponentRegister$collectPlugin$9();

    FeedTheaterFlowComponentRegister$collectPlugin$9() {
        super(0);
    }
