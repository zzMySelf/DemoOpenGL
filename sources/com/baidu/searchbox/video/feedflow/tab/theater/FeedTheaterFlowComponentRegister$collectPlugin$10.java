...
final class FeedTheaterFlowComponentRegister$collectPlugin$10 extends Lambda implements Function0<IPlugin> {
    public static final FeedTheaterFlowComponentRegister$collectPlugin$10 INSTANCE = new FeedTheaterFlowComponentRegister$collectPlugin$10();

    FeedTheaterFlowComponentRegister$collectPlugin$10() {
        super(0);
    }

    public final IPlugin invoke() {
        return FastSlideUnit.INSTANCE.createPlugin();
    }
}
