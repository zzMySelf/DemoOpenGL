...
final class FeedTheaterFlowComponentRegister$collectPlugin$7 extends Lambda implements Function0<IPlugin> {
    public static final FeedTheaterFlowComponentRegister$collectPlugin$7 INSTANCE = new FeedTheaterFlowComponentRegister$collectPlugin$7();

    FeedTheaterFlowComponentRegister$collectPlugin$7() {
        super(0);
    }
