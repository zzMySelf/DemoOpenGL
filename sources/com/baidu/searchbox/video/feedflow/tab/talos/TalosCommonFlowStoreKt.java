...
import com.baidu.searchbox.video.feedflow.flow.more.adapter.TalosMoreFlowReducerAdapterMiddleware;
import com.baidu.searchbox.video.feedflow.flow.nid.FirstJumpNidState;
import com.baidu.searchbox.video.feedflow.flow.talos.common.FlowTalosCommonReducer;
...
@Metadata(d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u001a\u0014\u0010\u0000\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u0001H\u0002\u001a\u0014\u0010\u0004\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00050\u0001H\u0002\u001a\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0003H\u0002¨\u0006\t"}, d2 = {"collectReducer", "", "Lcom/baidu/searchbox/feed/detail/frame/Reducer;", "Lcom/baidu/searchbox/feed/detail/arch/ext/CommonState;", "collectionMiddleware", "Lcom/baidu/searchbox/feed/detail/frame/Middleware;", "initState", "", "state", "feed-flow_release"}, k = 2, mv = {1, 6, 0}, xi = 48)
/* compiled from: TalosCommonFlowStore.kt */
public final class TalosCommonFlowStoreKt {
    ...
    public static final List<Middleware<CommonState>> collectionMiddleware() {
        ...
        $this$collectionMiddleware_u24lambda_u2d0.add(new TalosMoreFlowReducerAdapterMiddleware());
        return arrayList;
    }
    ...
    public static final List<Reducer<CommonState>> collectReducer() {
        ...
        $this$collectReducer_u24lambda_u2d1.add(new FlowTalosCommonReducer());
