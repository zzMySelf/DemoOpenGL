...
final class CollectionDetailComponentRegister$collectPlugin$3 extends Lambda implements Function0<IPlugin> {
    public static final CollectionDetailComponentRegister$collectPlugin$3 INSTANCE = new CollectionDetailComponentRegister$collectPlugin$3();

    CollectionDetailComponentRegister$collectPlugin$3() {
        super(0);
    }
