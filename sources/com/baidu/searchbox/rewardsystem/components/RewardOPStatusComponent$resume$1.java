...
final class RewardOPStatusComponent$resume$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ RewardOPStatusComponent this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RewardOPStatusComponent$resume$1(RewardOPStatusComponent rewardOPStatusComponent) {
        super(0);
        this.this$0 = rewardOPStatusComponent;
    }

    public final Unit invoke() {
        this.this$0.curTimerStatus = 2;
        BaseRewardOPComponent access$getCurComponent$p = this.this$0.curComponent;
        if (access$getCurComponent$p == null) {
            return null;
        }
        access$getCurComponent$p.resume();
