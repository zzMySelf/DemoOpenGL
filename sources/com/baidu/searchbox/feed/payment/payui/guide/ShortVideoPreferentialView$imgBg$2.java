...
final class ShortVideoPreferentialView$imgBg$2 extends Lambda implements Function0<BdBaseImageView> {
    final /* synthetic */ ShortVideoPreferentialView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ShortVideoPreferentialView$imgBg$2(ShortVideoPreferentialView shortVideoPreferentialView) {
        super(0);
        this.this$0 = shortVideoPreferentialView;
    }

    public final BdBaseImageView invoke() {
        return (BdBaseImageView) this.this$0.findViewById(R.id.short_video_discount_number_bg);
    }
}
