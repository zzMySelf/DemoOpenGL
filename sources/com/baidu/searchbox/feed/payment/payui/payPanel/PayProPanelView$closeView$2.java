...
final class PayProPanelView$closeView$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ PayProPanelView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PayProPanelView$closeView$2(PayProPanelView payProPanelView) {
        super(0);
        this.this$0 = payProPanelView;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.getRootView().findViewById(R.id.pay_panel_close);
    }
}
