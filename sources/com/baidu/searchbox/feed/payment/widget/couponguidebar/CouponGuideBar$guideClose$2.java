...
final class CouponGuideBar$guideClose$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ CouponGuideBar this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CouponGuideBar$guideClose$2(CouponGuideBar couponGuideBar) {
        super(0);
        this.this$0 = couponGuideBar;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.feed_pay_coupon_guide_close);
    }
}
