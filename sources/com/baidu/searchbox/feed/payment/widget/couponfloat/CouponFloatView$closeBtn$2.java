...
final class CouponFloatView$closeBtn$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ CouponFloatView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CouponFloatView$closeBtn$2(CouponFloatView couponFloatView) {
        super(0);
        this.this$0 = couponFloatView;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.feed_pay_coupon_float_close);
    }
}
