...
final class MvpPublisherComponentRegister$collectPlugin$5 extends Lambda implements Function0<IPlugin> {
    public static final MvpPublisherComponentRegister$collectPlugin$5 INSTANCE = new MvpPublisherComponentRegister$collectPlugin$5();

    MvpPublisherComponentRegister$collectPlugin$5() {
        super(0);
    }

    public final IPlugin invoke() {
        return new AIPublisherPackagingGeneratePlugin();
    }
}
