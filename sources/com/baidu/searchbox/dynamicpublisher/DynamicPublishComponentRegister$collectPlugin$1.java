...
final class DynamicPublishComponentRegister$collectPlugin$1 extends Lambda implements Function0<IPlugin> {
    public static final DynamicPublishComponentRegister$collectPlugin$1 INSTANCE = new DynamicPublishComponentRegister$collectPlugin$1();

    DynamicPublishComponentRegister$collectPlugin$1() {
        super(0);
    }
