...
final class AiPanelView$rootLayout$2 extends Lambda implements Function0<FrameLayout> {
    final /* synthetic */ AiPanelView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AiPanelView$rootLayout$2(AiPanelView aiPanelView) {
        super(0);
        this.this$0 = aiPanelView;
    }

    public final FrameLayout invoke() {
        return (FrameLayout) this.this$0.findViewById(R.id.ai_panel_root_layout);
    }
}
