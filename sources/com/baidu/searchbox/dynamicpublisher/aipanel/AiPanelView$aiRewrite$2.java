...
final class AiPanelView$aiRewrite$2 extends Lambda implements Function0<View> {
    final /* synthetic */ AiPanelView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AiPanelView$aiRewrite$2(AiPanelView aiPanelView) {
        super(0);
        this.this$0 = aiPanelView;
    }

    public final View invoke() {
        return this.this$0.findViewById(R.id.ai_rewrite);
    }
}
