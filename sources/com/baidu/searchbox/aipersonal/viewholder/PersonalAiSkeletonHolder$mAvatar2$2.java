...
final class PersonalAiSkeletonHolder$mAvatar2$2 extends Lambda implements Function0<BdBaseImageView> {
    final /* synthetic */ View $itemView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PersonalAiSkeletonHolder$mAvatar2$2(View view2) {
        super(0);
        this.$itemView = view2;
    }

    public final BdBaseImageView invoke() {
        return (BdBaseImageView) this.$itemView.findViewById(R.id.avatar2);
    }
}
