...
final class PersonalAiSongHolder$mTvSeeMore$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ View $itemView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PersonalAiSongHolder$mTvSeeMore$2(View view2) {
        super(0);
        this.$itemView = view2;
    }

    public final TextView invoke() {
        return (TextView) this.$itemView.findViewById(R.id.tv_see_more);
    }
}
