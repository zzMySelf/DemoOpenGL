...
/* compiled from: AiSmartHistorySwanHolder.kt */
final class AiSmartHistorySwanHolder$mSubTitle$2 extends Lambda implements Function0<TextView> {
    final /* synthetic */ View $itemView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AiSmartHistorySwanHolder$mSubTitle$2(View view2) {
        super(0);
        this.$itemView = view2;
    }
