...
final class PersonalAiSongRecommendCardItemViewHolder$mIvPlay$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ View $itemView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PersonalAiSongRecommendCardItemViewHolder$mIvPlay$2(View view2) {
        super(0);
        this.$itemView = view2;
    }

    public final ImageView invoke() {
        return (ImageView) this.$itemView.findViewById(R.id.iv_play);
    }
}
