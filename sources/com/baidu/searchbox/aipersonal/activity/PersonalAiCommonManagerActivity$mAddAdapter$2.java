...
final class PersonalAiCommonManagerActivity$mAddAdapter$2 extends Lambda implements Function0<PersonalAiMoreFunctionAdapter> {
    final /* synthetic */ PersonalAiCommonManagerActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PersonalAiCommonManagerActivity$mAddAdapter$2(PersonalAiCommonManagerActivity personalAiCommonManagerActivity) {
        super(0);
        this.this$0 = personalAiCommonManagerActivity;
    }

    public final PersonalAiMoreFunctionAdapter invoke() {
        PersonalAiCommonManagerActivity personalAiCommonManagerActivity = this.this$0;
        return new PersonalAiMoreFunctionAdapter(personalAiCommonManagerActivity, personalAiCommonManagerActivity.getItemsShownHistorySet());
    }
}
