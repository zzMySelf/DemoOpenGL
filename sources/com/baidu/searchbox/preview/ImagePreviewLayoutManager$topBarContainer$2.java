...
final class ImagePreviewLayoutManager$topBarContainer$2 extends Lambda implements Function0<FrameLayout> {
    final /* synthetic */ ImagePreviewLayoutManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ImagePreviewLayoutManager$topBarContainer$2(ImagePreviewLayoutManager imagePreviewLayoutManager) {
        super(0);
        this.this$0 = imagePreviewLayoutManager;
    }

    public final FrameLayout invoke() {
        return (FrameLayout) this.this$0.getContainer().findViewById(R.id.image_preview_top_bar);
    }
}
