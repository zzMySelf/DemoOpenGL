...
public abstract class WebViewFactoryProvider {
    public static final int GPU_RASTER_CLOSE = 0;
    public static final int GPU_RASTER_NONE = -1;
    public static final int GPU_RASTER_OPEN = 1;
    private static final String LOG_TAG = "WebViewFactoryProvider";
    public static final String SETTING_AD_BLOCK = "ADBlock";
    public static final Boolean SETTING_AD_BLOCK_VALUE = Boolean.FALSE;
    public static final String SETTING_DEBUG = "Debug";
    public static final Boolean SETTING_DEBUG_VALUE = Boolean.FALSE;
    public static final String SETTING_ENABLE_JS_PROMPT = "JsPromptEnable";
    public static final Boolean SETTING_ENABLE_JS_PROMPT_VALUE = Boolean.FALSE;
    public static final String SETTING_EYE_SHIELD_MODE = "EyeShieldMode";
    public static final Boolean SETTING_EYE_SHIELD_MODE_VALUE = Boolean.FALSE;
    ...
    public static final Boolean SETTING_GIF_FIRST_FRAME_VALUE = Boolean.FALSE;
    ...
    public static final Boolean SETTING_MONITOR_VALUE = Boolean.FALSE;
    public static final String SETTING_NA2_WEB_ENABLE = "NA2WebEnable";
    public static final Boolean SETTING_NA2_WEB_VALUE = Boolean.FALSE;
    public static final String SETTING_NIGHT_THEME = "NightTheme";
    public static final Boolean SETTING_NIGHT_THEME_VALUE = Boolean.FALSE;
    public static final String SETTING_NO_IMAGE_MODE = "NoImageMode";
    public static final Boolean SETTING_NO_IMAGE_MODE_VALUE = Boolean.FALSE;
    ...
    public static final Boolean SETTING_SAVE_FLOW_VALUE = Boolean.FALSE;
    public static final String SETTING_SPDY = "Spdy";
    public static final Boolean SETTING_SPDY_VALUE = Boolean.FALSE;
    public static final String SETTING_UA_EMULATE = "UaEmulate";
    public static final Boolean SETTING_UA_EMULATE_VALUE = Boolean.FALSE;
    public static final String SETTING_URL_SAFE_CHECK = "UrlSafeCheck";
    public static final Boolean SETTING_URL_SAFE_CHECK_VALUE = Boolean.FALSE;
    public static final int STATIC_SETTING_SIZE = 16;
    protected HashMap<String, Object> mStaticWebSettings;
    ...
    public interface SettingsStatics {
        ...
        String getBDLog(HttpURLConnection httpURLConnection);
        ...
        int getErrorCode(IOException iOException);
        ...
        String resolveHost(String str, boolean z, int i2);
        ...
        void setBDLogPreparedCallback(HttpURLConnection httpURLConnection, Runnable runnable);
    ...
    public interface Statics {
        ...
        void setGpuRasterState(int i2, boolean z, boolean z2);
