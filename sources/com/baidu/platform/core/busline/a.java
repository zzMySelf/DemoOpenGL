    ...
    public boolean a(String str, BusLineResult busLineResult) {
        if (str != null && !"".equals(str)) {
            try {
                ...
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat(TimeUtil.LONG_TIME_FORMAT1);
                try {
                ...
                List<List<LatLng>> decodeLocationList2D = CoordUtil.decodeLocationList2D(optJSONObject2.optString(IGdtAdRequestParameter.DEVICE_GEO));
                ...
                if (optJSONArray2 != null) {
                    ...
                    for (int i2 = 0; i2 < optJSONArray2.length(); i2++) {
                        ...
                        if (optJSONObject3 != null) {
                            ...
                            busStation.setLocation(CoordUtil.decodeLocation(optJSONObject3.optString(IGdtAdRequestParameter.DEVICE_GEO)));
