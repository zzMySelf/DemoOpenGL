...
final class Params$index$2 extends Lambda implements Function1<JSONObject, Integer> {
    public static final Params$index$2 INSTANCE = new Params$index$2();
    ...
    public final Integer invoke(JSONObject $this$modelDataDelegate) {
        ...
        return Integer.valueOf($this$modelDataDelegate.optInt("index", 0));
    }
}
