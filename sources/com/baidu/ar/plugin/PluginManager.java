    ...
    private void saveSignatures(PackageInfo packageInfo) {
        ...
        if (packageInfo != null && (signatureArr = packageInfo.signatures) != null) {
            ...
            while (i2 < length) {
                ...
                File file = new File(PluginDirHelper.getPluginSignatureFile(this.mContext, packageInfo.packageName, i3));
                try {
    ...
    public int installPackage(String str, boolean z) {
        ...
        if (!z) {
            try {
                ...
                str2 = PluginDirHelper.getPluginApkFile(this.mContext, packageArchiveInfo.packageName);
            } catch (Exception e2) {
                if (0 != 0) {
            ...
            str2 = PluginDirHelper.getPluginApkFile(this.mContext, "com.google.ar.core");
        }
