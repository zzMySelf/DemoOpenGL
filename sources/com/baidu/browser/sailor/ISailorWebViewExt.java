...
public interface ISailorWebViewExt {
    void addNoStatePrefetch(String str, String str2);

    void addNoStatePrefetch(String str, Map<String, String> map);
    ...
    int getEvilLocationCount(String str);
    ...
    void selectElementByIdExt(String str);
    ...
    void startDeadChainDetect(String str);
