...
final class PromptSwitchOperator$expandPopFrequency$2 extends Lambda implements Function0<Integer> {
    final /* synthetic */ PromptSwitchOperator this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PromptSwitchOperator$expandPopFrequency$2(PromptSwitchOperator promptSwitchOperator) {
        super(0);
    ...
    public final Integer invoke() {
        ...
        if (access$getAbTestService != null) {
            i2 = access$getAbTestService.getSwitch("search_safeguard_expand_pop_frequency", 0);
        }
