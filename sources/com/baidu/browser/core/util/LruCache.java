...
public class LruCache<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x0055:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.browser.core.util.LruCache.get(java.lang.Object):java.lang.Object");
    }
    ...
    public void trimToSize(int r6) {
        ...
        L_0x0073:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.browser.core.util.LruCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        int accesses;
        i2 = this.hitCount;
        accesses = this.missCount + i2;
        return String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(accesses != 0 ? (i2 * 100) / accesses : 0)});
    }
}
