...
final class LiveFeedSearchPresenter$followClick$manager$2 extends Lambda implements Function0<AccountManagerService> {
    public static final LiveFeedSearchPresenter$followClick$manager$2 INSTANCE = new LiveFeedSearchPresenter$followClick$manager$2();

    LiveFeedSearchPresenter$followClick$manager$2() {
        super(0);
    }
