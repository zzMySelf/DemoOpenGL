...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public void clear() {
        ...
        Node<K, V> e2 = header2.next;
        while (e2 != header2) {
            Node<K, V> next = e2.next;
            e2.prev = null;
            e2.next = null;
            e2 = next;
        }
        ...
        if (nearest2 != null) {
            ...
            while (true) {
                if (comparableKey != null) {
                    i2 = comparableKey.compareTo(nearest2.key);
                } else {
                    i2 = comparator2.compare(comparable, nearest2.key);
                }
                int comparison2 = i2;
                if (comparison2 == 0) {
                    return nearest2;
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> replacement) {
        ...
        if (parent == null) {
            ...
            nodeArr[i2 & (nodeArr.length - 1)] = replacement;
