...
public enum gd {
    ...
    GSLB_TCP_NOACCESS(Track2DAR.MST_TYPE_OPEN_ALGO_TRACK),
    ...
    CHANNEL_TIMER_DELAYED(LoginManagerJavaScriptInterface.REQUST_CODE_LOGIN_FROM_MAINFRAME);
    ...
    public static gd a(int i2) {
        switch (i2) {
            ...
            case LoginManagerJavaScriptInterface.REQUST_CODE_LOGIN_FROM_MAINFRAME /*50001*/:
