...
public class MoveViewJob extends ViewPortJob {
    ...
    public void run() {
        ...
        this.mViewPortHandler.centerViewPort(this.pts, this.f2923view);
        recycleInstance(this);
    }

    /* access modifiers changed from: protected */
    public ObjectPool.Poolable instantiate() {
        return new MoveViewJob(this.mViewPortHandler, this.xValue, this.yValue, this.mTrans, this.f2923view);
    }
}
