...
public class e extends d {
    ...
    private ReverseGeoCodeResult.AddressComponent a(JSONObject jSONObject, String str) {
        ...
        addressComponent.district = optJSONObject.optString(PushLocationManager.LOCATION_DISTRICT);
        addressComponent.province = optJSONObject.optString("province");
        addressComponent.adcode = optJSONObject.optInt("adcode");
        addressComponent.street = optJSONObject.optString(HomeWeatherManager.KEY_STREET);
        addressComponent.streetNumber = optJSONObject.optString(HomeWeatherManager.KEY_STREET_NUMBER);
    ...
    private List<PoiInfo> a(JSONObject jSONObject, String str, String str2) {
        ...
        for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
            ...
            if (optJSONObject != null) {
                ...
                poiInfo.setPhoneNum(optJSONObject.optString(IFeedbackConstants.KEY_USER_TELEPHONE));
    ...
    private LatLng d(JSONObject jSONObject, String str) {
        ...
        LatLng latLng = new LatLng(optJSONObject.optDouble("lat"), optJSONObject.optDouble(SuggestAddrField.KEY_LNG));
        return SDKInitializer.getCoordType() == CoordType.GCJ02 ? CoordTrans.baiduToGcj(latLng) : latLng;
    }
