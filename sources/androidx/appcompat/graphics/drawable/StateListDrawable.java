            ...
            if (next != i2) {
                ...
                if (depth < innerDepth && type2 == 3) {
                    ...
                    if (depth2 > innerDepth) {
                        ...
                        TypedArray a2 = TypedArrayUtils.obtainAttributes(r, theme, attributeSet, R.styleable.StateListDrawableItem);
                        Drawable dr = null;
    ...
    public int[] extractStateSet(AttributeSet attrs) {
        ...
        for (int i2 = 0; i2 < numAttrs; i2++) {
            ...
            switch (stateResId) {
                ...
                default:
                    int j3 = j2 + 1;
                    states[j2] = attrs.getAttributeBooleanValue(i2, false) ? stateResId : -stateResId;
                    j2 = j3;
                    break;
            }
        }
    ...
    static class StateListState extends DrawableContainer.DrawableContainerState {
        ...
        public void mutate() {
            ...
            for (int i2 = iArr.length - 1; i2 >= 0; i2--) {
                int[] iArr2 = this.mStateSets[i2];
                stateSets[i2] = iArr2 != null ? (int[]) iArr2.clone() : null;
            }
        ...
        public int indexOfStateSet(int[] stateSet) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                if (StateSet.stateSetMatches(stateSets[i2], stateSet)) {
                    return i2;
                }
            }
            return -1;
