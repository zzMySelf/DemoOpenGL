...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            int i2 = 0;
            if (view2 != null) {
                int availableWidth2 = measureChildView(view2, availableWidth, childSpecHeight, 0);
            ...
            View view3 = this.mCustomView;
            if (view3 != null) {
                ViewGroup.LayoutParams lp2 = view3.getLayoutParams();
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b2) {
        ...
        View view3 = this.mCustomView;
        if (view3 != null) {
            int x4 = x + positionChild(view3, x, y, contentHeight, isLayoutRtl);
        }
