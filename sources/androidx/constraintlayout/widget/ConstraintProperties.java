...
public class ConstraintProperties {
    ...
    public ConstraintProperties addToHorizontalChain(int leftId, int rightId) {
        ...
        if (leftId != 0) {
            ...
            new ConstraintProperties(viewGroup.findViewById(leftId)).connect(2, this.mView.getId(), 1, 0);
        }
        if (rightId != 0) {
            ViewGroup viewGroup3 = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup4 = viewGroup3;
            new ConstraintProperties(viewGroup3.findViewById(rightId)).connect(1, this.mView.getId(), 2, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties addToHorizontalChainRTL(int leftId, int rightId) {
        ...
        if (leftId != 0) {
            ViewGroup viewGroup = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup2 = viewGroup;
            new ConstraintProperties(viewGroup.findViewById(leftId)).connect(7, this.mView.getId(), 6, 0);
        }
        if (rightId != 0) {
            ViewGroup viewGroup3 = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup4 = viewGroup3;
            new ConstraintProperties(viewGroup3.findViewById(rightId)).connect(6, this.mView.getId(), 7, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties addToVerticalChain(int topId, int bottomId) {
        ...
        if (topId != 0) {
            ViewGroup viewGroup = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup2 = viewGroup;
            new ConstraintProperties(viewGroup.findViewById(topId)).connect(4, this.mView.getId(), 3, 0);
        }
        if (bottomId != 0) {
            ViewGroup viewGroup3 = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup4 = viewGroup3;
            new ConstraintProperties(viewGroup3.findViewById(bottomId)).connect(3, this.mView.getId(), 4, 0);
        }
        return this;
    }
    ...
    public ConstraintProperties removeFromVerticalChain() {
        ...
        if (!(topId == -1 && bottomId == -1)) {
            ViewGroup viewGroup = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup2 = viewGroup;
            ConstraintProperties topProp = new ConstraintProperties(viewGroup.findViewById(topId));
            ViewGroup viewGroup3 = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup4 = viewGroup3;
            ConstraintProperties bottomProp = new ConstraintProperties(viewGroup3.findViewById(bottomId));
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (leftId == -1 && rightId == -1) {
            ...
            if (!(startId == -1 && endId == -1)) {
                ViewGroup viewGroup = (ViewGroup) this.mView.getParent();
                ViewGroup viewGroup2 = viewGroup;
                ConstraintProperties startProp = new ConstraintProperties(viewGroup.findViewById(startId));
                ViewGroup viewGroup3 = (ViewGroup) this.mView.getParent();
                ViewGroup viewGroup4 = viewGroup3;
                ConstraintProperties endProp = new ConstraintProperties(viewGroup3.findViewById(endId));
                ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
                if (startId != -1 && endId != -1) {
                    startProp.connect(7, endId, 6, 0);
                    endProp.connect(6, leftId, 7, 0);
                } else if (!(leftId == -1 && endId == -1)) {
                    int i2 = layoutParams2.rightToRight;
                    ConstraintLayout.LayoutParams layoutParams3 = this.mParams;
                    if (i2 != -1) {
                        startProp.connect(7, layoutParams3.rightToRight, 7, 0);
                    } else {
                        int i3 = layoutParams3.leftToLeft;
            ...
            ConstraintProperties leftProp = new ConstraintProperties(viewGroup5.findViewById(leftId));
            ViewGroup viewGroup7 = (ViewGroup) this.mView.getParent();
            ViewGroup viewGroup8 = viewGroup7;
            ConstraintProperties rightProp = new ConstraintProperties(viewGroup7.findViewById(rightId));
