...
public class ImageFilterView extends AppCompatImageView {
    ...
    static class ImageMatrix {
        ...
        public void updateMatrix(ImageView view2) {
            ...
            if (filter) {
                view2.setColorFilter(new ColorMatrixColorFilter(this.mColorMatrix));
            } else {
    ...
    public void setRoundPercent(float round) {
        ...
        if (round != 0.0f) {
                ...
                if (this.mViewOutlineProvider == null) {
                    AnonymousClass1 r2 = new ViewOutlineProvider() {
                        public void getOutline(View view2, Outline outline) {
                            ...
                            int h2 = ImageFilterView.this.getHeight();
                            outline.setRoundRect(0, 0, w, h2, (((float) Math.min(w, h2)) * ImageFilterView.this.mRoundPercent) / 2.0f);
                        }
                    };
            ...
            int w = getWidth();
            int h2 = getHeight();
            float r = (((float) Math.min(w, h2)) * this.mRoundPercent) / 2.0f;
            this.mRect.set(0.0f, 0.0f, (float) w, (float) h2);
            this.mPath.reset();
