...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState copy, Drawable.Callback owner, Resources res) {
            if (copy != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i2 = 0; i2 < numAnimators; i2++) {
                        Animator anim = copy.mAnimators.get(i2);
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimators = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i2 = 0; i2 < childAnimators.size(); i2++) {
                setupColorAnimator(childAnimators.get(i2));
            }
        }
                    ...
                    this.mAnimatorListener = new AnimatorListenerAdapter() {
                        public void onAnimationStart(Animator animation) {
                            ...
                            for (int i2 = 0; i2 < size; i2++) {
                                tmpCallbacks.get(i2).onAnimationStart(AnimatedVectorDrawableCompat.this);
                            }
                        }
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            int size = tmpCallbacks.size();
                            for (int i2 = 0; i2 < size; i2++) {
                                tmpCallbacks.get(i2).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                            }
                        }
                    };
                }
