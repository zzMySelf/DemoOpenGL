...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rect.left = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingLeft, defaultPadding);
        rect.top = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingTop, defaultPadding);
        rect.right = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingRight, defaultPadding);
        rect.bottom = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingBottom, defaultPadding);
