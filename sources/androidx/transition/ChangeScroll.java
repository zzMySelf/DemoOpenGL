...
public class ChangeScroll extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        transitionValues.values.put(PROPNAME_SCROLL_X, Integer.valueOf(transitionValues.f1208view.getScrollX()));
        transitionValues.values.put(PROPNAME_SCROLL_Y, Integer.valueOf(transitionValues.f1208view.getScrollY()));
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        View view2 = endValues.f1208view;
        ...
        if (startX != endX) {
            view2.setScrollX(startX);
            scrollXAnimator = ObjectAnimator.ofInt(view2, "scrollX", new int[]{startX, endX});
        }
        if (startY != endY) {
            view2.setScrollY(startY);
            scrollYAnimator = ObjectAnimator.ofInt(view2, "scrollY", new int[]{startY, endY});
        }
