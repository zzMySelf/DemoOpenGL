...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
            ...
            if (savedInstanceState.containsKey(NEXT_CANDIDATE_REQUEST_INDEX_TAG)) {
                ...
                if (requestCodes == null || fragmentWhos == null || requestCodes.length != fragmentWhos.length) {
                    ...
                    for (int i2 = 0; i2 < requestCodes.length; i2++) {
                        this.mPendingFragmentActivityResults.put(requestCodes[i2], fragmentWhos[i2]);
                    }
                }
            }
        }
    ...
    public boolean onPreparePanel(int featureId, View view2, Menu menu) {
        if (featureId == 0) {
            return onPrepareOptionsPanel(view2, menu) | this.mFragments.dispatchPrepareOptionsMenu(menu);
        }
        return super.onPreparePanel(featureId, view2, menu);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (this.mPendingFragmentActivityResults.size() > 0) {
            ...
            for (int i2 = 0; i2 < this.mPendingFragmentActivityResults.size(); i2++) {
                requestCodes[i2] = this.mPendingFragmentActivityResults.keyAt(i2);
                fragmentWhos[i2] = this.mPendingFragmentActivityResults.valueAt(i2);
            }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        String innerPrefix = prefix + TextViewExtKt.TEXT_WITH_ICON_END_TEXT_SPACE;
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        ...
        if (i2 == -1) {
            ...
            checkForValidRequestCode(requestCode);
            ActivityCompat.startIntentSenderForResult(this, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (65535 & i2), fillInIntent, flagsMask, flagsValues, extraFlags, options);
            this.mStartedIntentSenderFromFragment = false;
        }
    }
