...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    public static Fragment instantiate(Context context, String fname, Bundle args) {
        try {
            Fragment f2 = (Fragment) FragmentFactory.loadFragmentClass(context.getClassLoader(), fname).getConstructor(new Class[0]).newInstance(new Object[0]);
            if (args != null) {
    ...
    public void restoreChildFragmentState(Bundle savedInstanceState) {
        Parcelable p;
        if (savedInstanceState != null && (p = savedInstanceState.getParcelable(PersonalActivity.KEY_FRAGMENTS_TAG)) != null) {
    ...
    public void unregisterForContextMenu(View view2) {
        view2.setOnCreateContextMenuListener((View.OnCreateContextMenuListener) null);
    }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        this.mChildFragmentManager.dump(prefix + TextViewExtKt.TEXT_WITH_ICON_END_TEXT_SPACE, fd, writer, args);
    }
    ...
    public void performSaveInstanceState(Bundle outState) {
        ...
        if (p != null) {
            outState.putParcelable(PersonalActivity.KEY_FRAGMENTS_TAG, p);
        }
    }
