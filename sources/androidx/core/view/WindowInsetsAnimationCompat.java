...
public final class WindowInsetsAnimationCompat {
    ...
    public static final class BoundsCompat {
        ...
        public String toString() {
            return "Bounds{lower=" + this.mLowerBound + " upper=" + this.mUpperBound + i.f2534d;
        }
    ...
    static void setCallback(View view2, Callback callback) {
        if (Build.VERSION.SDK_INT >= 30) {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view2, Callback callback) {
            Object userListener = view2.getTag(R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view2.setTag(R.id.tag_window_insets_animation_callback, (Object) null);
                if (userListener == null) {
                    view2.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) null);
                    return;
                }
                return;
            }
            View.OnApplyWindowInsetsListener proxyListener = createProxyListener(view2, callback);
            view2.setTag(R.id.tag_window_insets_animation_callback, proxyListener);
            if (userListener == null) {
                view2.setOnApplyWindowInsetsListener(proxyListener);
            }
        }

        private static View.OnApplyWindowInsetsListener createProxyListener(View view2, Callback callback) {
        ...
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat target, WindowInsetsCompat starting, float fraction, int typeMask) {
            ...
            for (int i2 = 1; i2 <= 256; i2 <<= 1) {
                if ((typeMask & i2) == 0) {
                    builder.setInsets(i2, target.getInsets(i2));
                } else {
                    Insets targetInsets = target.getInsets(i2);
                    Insets startingInsets = starting.getInsets(i2);
                    builder.setInsets(i2, WindowInsetsCompat.insetInsets(targetInsets, (int) (((double) (((float) (targetInsets.left - startingInsets.left)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.top - startingInsets.top)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.right - startingInsets.right)) * (1.0f - fraction))) + 0.5d), (int) (((double) (((float) (targetInsets.bottom - startingInsets.bottom)) * (1.0f - fraction))) + 0.5d)));
                }
            }
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            Impl21OnApplyWindowInsetsListener(View view2, Callback callback) {
            ...
            public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                ...
                WindowInsetsCompat targetInsets = WindowInsetsCompat.toWindowInsetsCompat(windowInsets, view2);
                ...
                Impl21.dispatchOnPrepare(view2, anim, windowInsets, false);
                ...
                AnonymousClass1 r0 = new ValueAnimator.AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        Impl21.dispatchOnProgress(view3, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat2, windowInsetsAnimationCompat.getInterpolatedFraction(), i2), Collections.singletonList(windowInsetsAnimationCompat));
                    }
                };
                ...
                animator.addListener(new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        ...
                        Impl21.dispatchOnEnd(view2, anim);
                    }
                });
                final View view4 = v;
                ...
                OneShotPreDrawListener.add(view2, new Runnable() {
                    public void run() {
                        Impl21.dispatchOnStart(view4, windowInsetsAnimationCompat2, boundsCompat);
                        valueAnimator.start();
                    }
                });
                this.mLastInsets = targetInsets;
        ...
        static void dispatchOnPrepare(View v, WindowInsetsAnimationCompat anim, WindowInsets insets, boolean stopDispatch) {
            ...
            if (v instanceof ViewGroup) {
                ...
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i2), anim, insets, stopDispatch);
                }
            }
        }
        ...
        static void dispatchOnStart(View v, WindowInsetsAnimationCompat anim, BoundsCompat animationBounds) {
            ...
            if (v instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) v;
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    dispatchOnStart(viewGroup.getChildAt(i2), anim, animationBounds);
                }
            }
        }
        ...
        static void dispatchOnProgress(View v, WindowInsetsCompat interpolateInsets, List<WindowInsetsAnimationCompat> runningAnimations) {
            ...
            if (v instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) v;
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    dispatchOnProgress(viewGroup.getChildAt(i2), insets, runningAnimations);
                }
            }
        }
        ...
        static void dispatchOnEnd(View v, WindowInsetsAnimationCompat anim) {
            ...
            if (v instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) v;
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    dispatchOnEnd(viewGroup.getChildAt(i2), anim);
                }
            }
        }
    ...
    private static class Impl30 extends Impl {
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets insets, List<WindowInsetsAnimation> runningAnimations) {
                ...
                for (int i2 = runningAnimations.size() - 1; i2 >= 0; i2--) {
                    WindowInsetsAnimation animation = runningAnimations.get(i2);
        ...
        public static void setCallback(View view2, Callback callback) {
            view2.setWindowInsetsAnimationCallback(callback != null ? new ProxyCallback(callback) : null);
        }
