...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public static MediaItem fromMediaItem(Object itemObj) {
            ...
            return new MediaItem(MediaDescriptionCompat.fromMediaDescription(Api21Impl.getDescription(itemFwk)), Api21Impl.getFlags(itemFwk));
        }
        ...
        private class SubscriptionCallbackApi21 extends MediaBrowser.SubscriptionCallback {
            ...
            public void onChildrenLoaded(String parentId, List<MediaBrowser.MediaItem> children) {
                ...
                for (int i2 = 0; i2 < callbacks.size(); i2++) {
                    Bundle options = optionsList.get(i2);
                    if (options == null) {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        while (i2 < callbackList.size()) {
                            ...
                            this.mServiceBinderWrapper.addSubscription(id, callbackList.get(i2).mToken, optionsList.get(i2), this.mCallbacksMessenger);
                            i2++;
                            it = it2;
                        }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            try {
                ...
                Log.e(MediaBrowserCompat.TAG, "Unexpected IllegalStateException", e3);
            }
        }
