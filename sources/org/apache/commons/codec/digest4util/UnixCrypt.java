...
public class UnixCrypt {
    ...
    public static java.lang.String crypt(byte[] r16, java.lang.String r17) {
        ...
        L_0x00ca:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.codec.digest4util.UnixCrypt.crypt(byte[], java.lang.String):java.lang.String");
    }
    ...
    private static int[] body(int[] schedule, int eSwap0, int eSwap1) {
        ...
        for (int j2 = 0; j2 < 25; j2++) {
            for (int i2 = 0; i2 < 32; i2 += 4) {
                left = dEncrypt(left, right, i2, eSwap0, eSwap1, schedule);
                right = dEncrypt(right, left, i2 + 2, eSwap0, eSwap1, schedule);
            }
            int t = left;
            left = right;
            right = t;
    ...
    private static int[] desSetKey(byte[] key) {
        ...
        int d2 = results[0];
        permOp(hPermOp(d2, -2, -859045888), hPermOp(results[1], -2, -859045888), 1, 1431655765, results);
        permOp(results[1], results[0], 8, 16711935, results);
        permOp(results[1], results[0], 1, 1431655765, results);
        int d3 = results[0];
        int c3 = results[1];
        int d4 = ((d3 & 255) << 16) | (65280 & d3) | ((16711680 & d3) >>> 16) | ((-268435456 & c3) >>> 4);
        int c4 = c3 & 268435455;
        int j2 = 0;
        int i4 = 0;
        while (i4 < 16) {
            ...
            d4 = (i3 | i2) & 268435455;
            int[][] iArr = SKB;
            int s = iArr[0][c4 & 63] | iArr[1][((c4 >>> 6) & 3) | ((c4 >>> 7) & 60)] | iArr[2][((c4 >>> 13) & 15) | ((c4 >>> 14) & 48)] | iArr[3][((c4 >>> 20) & 1) | ((c4 >>> 21) & 6) | ((c4 >>> 22) & 56)];
            int t = iArr[7][((d4 >>> 21) & 15) | ((d4 >>> 22) & 48)] | iArr[4][d4 & 63] | iArr[5][((d4 >>> 7) & 3) | ((d4 >>> 8) & 60)] | iArr[6][(d4 >>> 15) & 63];
            int j3 = j2 + 1;
            schedule[j2] = (t << 16) | (s & 65535);
            int s2 = (s >>> 16) | (t & SupportMenu.CATEGORY_MASK);
            schedule[j3] = (s2 << 4) | (s2 >>> 28);
            i4++;
            j2 = j3 + 1;
        }
        return schedule;
    ...
    private static int fourBytesToInt(byte[] b2, int offset) {
        ...
        int value = byteToUnsigned(b2[offset]) | (byteToUnsigned(b2[offset2]) << 8);
        int offset4 = offset3 + 1;
        int value2 = value | (byteToUnsigned(b2[offset3]) << 16);
        int i2 = offset4 + 1;
        return value2 | (byteToUnsigned(b2[offset4]) << 24);
    }

    private static int hPermOp(int a2, int n, int m) {
        int t = ((a2 << (16 - n)) ^ a2) & m;
        return (a2 ^ t) ^ (t >>> (16 - n));
    }
    ...
    private static void intToFourBytes(int iValue, byte[] b2, int offset) {
        int offset2 = offset + 1;
        b2[offset] = (byte) (iValue & 255);
        int offset3 = offset2 + 1;
        b2[offset2] = (byte) ((iValue >>> 8) & 255);
        int offset4 = offset3 + 1;
        b2[offset3] = (byte) ((iValue >>> 16) & 255);
        int i2 = offset4 + 1;
        b2[offset4] = (byte) ((iValue >>> 24) & 255);
    }

    private static void permOp(int a2, int b2, int n, int m, int[] results) {
        int t = ((a2 >>> n) ^ b2) & m;
        results[0] = a2 ^ (t << n);
        results[1] = b2 ^ t;
    }
