...
public final class DelegatingAnkoContext<T extends ViewGroup> implements AnkoContext<T> {
    ...
    private final View f2924view = getOwner();

    public DelegatingAnkoContext(T owner2) {
    ...
    public void updateViewLayout(View view2, ViewGroup.LayoutParams params) {
        ...
        AnkoContext.DefaultImpls.updateViewLayout(this, view2, params);
    }
