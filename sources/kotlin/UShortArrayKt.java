...
public final class UShortArrayKt {
    private static final short[] UShortArray(int size, Function1<? super Integer, UShort> init) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            sArr[i2] = init.invoke(Integer.valueOf(i2)).m9298unboximpl();
        }
        return UShortArray.m9301constructorimpl(sArr);
    }

    /* renamed from: ushortArrayOf-rL5Bavg  reason: not valid java name */
    private static final short[] m9317ushortArrayOfrL5Bavg(short... elements) {
