...
final class MutableMapWithDefaultImpl<K, V> implements MutableMapWithDefault<K, V> {
    ...
    private final Function1<K, V> f1092default;
    ...
    public V getOrImplicitDefault(K key) {
        ...
        return (value$iv != null || $this$getOrElseNullable$iv.containsKey(key)) ? value$iv : this.f1092default.invoke(key);
    }
}
