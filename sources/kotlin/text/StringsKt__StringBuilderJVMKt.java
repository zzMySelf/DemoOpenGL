...
class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    static /* synthetic */ void toCharArray$default(StringBuilder $this$toCharArray_u24default, char[] destination, int destinationOffset, int startIndex, int endIndex, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            destinationOffset = 0;
        }
        if ((i2 & 4) != 0) {
