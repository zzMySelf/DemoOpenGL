...
public final class SequentialSubscription extends AtomicReference<Subscription> implements Subscription {
    ...
    public Subscription current() {
        ...
        return subscription == Unsubscribed.INSTANCE ? fe.ad() : subscription;
    }
    ...
    public void unsubscribe() {
        ...
        if (subscription2 != unsubscribed && (subscription = (Subscription) getAndSet(unsubscribed)) != null && subscription != Unsubscribed.INSTANCE) {
            subscription.unsubscribe();
        }
    }
