...
import p041if.de;
import p041if.rg.qw.vvv;
import rx.Observer;
import rx.Producer;
import rx.Subscription;

public final class OperatorOnBackpressureLatest$LatestEmitter<T> extends AtomicLong implements Producer, Subscription, Observer<T> {
    ...
    public void emit() {
        ...
        L_0x001b:
            ...
            if.de<? super T> r2 = r9.child     // Catch:{ all -> 0x006d }
        ...
        L_0x003e:
            ...
            if.de<? super T> r3 = r9.child     // Catch:{ all -> 0x006d }
