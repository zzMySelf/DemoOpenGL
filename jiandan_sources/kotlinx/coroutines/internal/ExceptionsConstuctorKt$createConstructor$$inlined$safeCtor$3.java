...
public final class ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$3 extends Lambda implements Function1<Throwable, Throwable> {
    ...
    public final Throwable invoke(@NotNull Throwable th2) {
        ...
        try {
            ...
            Object newInstance = this.$constructor$inlined.newInstance(new Object[]{th2.getMessage()});
            if (newInstance != null) {
                Throwable th3 = (Throwable) newInstance;
                th3.initCause(th2);
                obj = Result.m1155constructorimpl(th3);
            ...
            obj = Result.m1155constructorimpl(ResultKt.createFailure(th4));
        }
    }
}
