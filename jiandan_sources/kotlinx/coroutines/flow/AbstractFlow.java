...
public abstract class AbstractFlow<T> implements Flow<T>, CancellableFlow<T> {
    ...
    public final java.lang.Object fe(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
        ...
        L_0x0037:
            ...
            java.lang.Object r6 = r5.yj(r7, r0)     // Catch:{ all -> 0x0055 }
        ...
        L_0x0059:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.AbstractFlow.fe(kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object");
    }

    @Nullable
    public abstract Object yj(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<? super Unit> continuation);
}
