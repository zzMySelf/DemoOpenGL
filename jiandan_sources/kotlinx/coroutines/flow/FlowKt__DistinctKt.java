...
public final /* synthetic */ class FlowKt__DistinctKt {
    ...
    public static final Function2<Object, Object, Boolean> f6382ad = FlowKt__DistinctKt$defaultAreEquivalent$1.INSTANCE;
    @NotNull
    public static final Function1<Object, Object> qw = FlowKt__DistinctKt$defaultKeySelector$1.INSTANCE;

    public static final <T> Flow<T> ad(Flow<? extends T> flow, Function1<? super T, ? extends Object> function1, Function2<Object, Object, Boolean> function2) {
        if (flow instanceof DistinctFlowImpl) {
            DistinctFlowImpl distinctFlowImpl = (DistinctFlowImpl) flow;
            if (distinctFlowImpl.f6370th == function1 && distinctFlowImpl.f6371yj == function2) {
                return flow;
            }
        }
    ...
    @NotNull
    public static final <T> Flow<T> qw(@NotNull Flow<? extends T> flow) {
        return flow instanceof StateFlow ? flow : ad(flow, qw, f6382ad);
    }
}
