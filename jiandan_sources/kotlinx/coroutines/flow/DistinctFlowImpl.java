...
public final class DistinctFlowImpl<T> implements Flow<T> {
    ...
    public final Flow<T> f6369ad;
    @NotNull
    @JvmField

    /* renamed from: th  reason: collision with root package name */
    public final Function1<T, Object> f6370th;
    @NotNull
    @JvmField

    /* renamed from: yj  reason: collision with root package name */
    public final Function2<Object, Object, Boolean> f6371yj;
    ...
    public DistinctFlowImpl(@NotNull Flow<? extends T> flow, @NotNull Function1<? super T, ? extends Object> function1, @NotNull Function2<Object, Object, Boolean> function2) {
        this.f6369ad = flow;
        this.f6370th = function1;
        this.f6371yj = function2;
    }

    @Nullable
    public Object fe(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = Cswitch.qw;
        Object fe2 = this.f6369ad.fe(new DistinctFlowImpl$collect$$inlined$collect$1(this, objectRef, flowCollector), continuation);
        if (fe2 == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            return fe2;
        }
