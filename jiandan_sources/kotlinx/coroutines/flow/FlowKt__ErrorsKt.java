...
public final /* synthetic */ class FlowKt__ErrorsKt {
    public static final boolean ad(Throwable th2, CoroutineContext coroutineContext) {
        Job job = (Job) coroutineContext.get(Job.f6325fe);
        if (job == null || !job.isCancelled()) {
            return false;
        }
        return de(th2, job.rg());
    }

    public static final boolean de(Throwable th2, Throwable th3) {
        if (th3 != null) {
            if (k.fe()) {
                th3 = b.m412switch(th3);
            }
            if (k.fe()) {
                th2 = b.m412switch(th2);
            }
            if (Intrinsics.areEqual((Object) th3, (Object) th2)) {
                return true;
            }
        }
        return false;
    ...
    public static final <T> java.lang.Object qw(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.Flow<? extends T> r4, @org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.lang.Throwable> r6) {
        /*
        ...
        L_0x0037:
            ...
            r6.<init>()
            kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1 r2 = new kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1     // Catch:{ all -> 0x0051 }
            r2.<init>(r5, r6)     // Catch:{ all -> 0x0051 }
            r0.L$0 = r6     // Catch:{ all -> 0x0051 }
            r0.label = r3     // Catch:{ all -> 0x0051 }
            java.lang.Object r4 = r4.fe(r2, r0)     // Catch:{ all -> 0x0051 }
        ...
        L_0x0068:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.qw(kotlinx.coroutines.flow.Flow, kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
