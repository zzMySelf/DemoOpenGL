...
import i.qw.r0;
import i.qw.w1.i0.pf;
import i.qw.w1.i0.yj;
...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public SafeCollector(@NotNull FlowCollector<? super T> flowCollector, @NotNull CoroutineContext coroutineContext) {
        super(pf.f6233ad, EmptyCoroutineContext.INSTANCE);
    ...
    private final void checkContext(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, T t) {
        if (coroutineContext2 instanceof yj) {
            exceptionTransparencyViolated((yj) coroutineContext2, t);
        }
        SafeCollector_commonKt.qw(this, coroutineContext);
        this.lastEmissionContext = coroutineContext;
    }

    private final void exceptionTransparencyViolated(yj yjVar, Object obj) {
        throw new IllegalStateException(StringsKt__IndentKt.trimIndent("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + yjVar.f6243ad + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
        try {
            ...
            this.lastEmissionContext = new yj(th2);
            throw th2;
        }
    }
    ...
    public Object invokeSuspend(@NotNull Object obj) {
        ...
        if (r0 != null) {
            this.lastEmissionContext = new yj(r0);
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    private final Object emit(Continuation<? super Unit> continuation, T t) {
        ...
        return SafeCollectorKt.qw.invoke(this.collector, t, this);
    }
}
