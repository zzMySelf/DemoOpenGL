...
public final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class qw implements FlowCollector<T2> {

        /* renamed from: ad  reason: collision with root package name */
        public final /* synthetic */ ProducerScope f6437ad;

        public qw(ProducerScope producerScope) {
            this.f6437ad = producerScope;
        }

        @Nullable
        public Object emit(T2 t2, @NotNull Continuation<? super Unit> continuation) {
            SendChannel uk2 = this.f6437ad.uk();
            if (t2 == null) {
                t2 = Cswitch.qw;
            }
            Object d = uk2.d(t2, continuation);
