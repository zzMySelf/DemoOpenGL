...
public final class CombineKt {
    @Nullable
    @PublishedApi
    public static final <R, T> Object qw(@NotNull FlowCollector<? super R> flowCollector, @NotNull Flow<? extends T>[] flowArr, @NotNull Function0<T[]> function0, @NotNull Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, @NotNull Continuation<? super Unit> continuation) {
        Object qw = i.qw(new CombineKt$combineInternal$2(flowArr, function0, function3, flowCollector, (Continuation<? super CombineKt$combineInternal$2>) null), continuation);
        return qw == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? qw : Unit.INSTANCE;
    }
}
