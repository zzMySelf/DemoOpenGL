...
public final /* synthetic */ class FlowKt__CollectionKt {
    ...
    public static final class qw implements FlowCollector<T> {
        ...
        public final /* synthetic */ Collection f6376ad;

        public qw(Collection collection) {
            this.f6376ad = collection;
        }
    ...
    public static final <T, C extends java.util.Collection<? super T>> java.lang.Object qw(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.Flow<? extends T> r4, @org.jetbrains.annotations.NotNull C r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super C> r6) {
        /*
        ...
        L_0x0036:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlinx.coroutines.flow.FlowKt__CollectionKt$qw r6 = new kotlinx.coroutines.flow.FlowKt__CollectionKt$qw
            r6.<init>(r5)
            r0.L$0 = r5
            r0.label = r3
            java.lang.Object r4 = r4.fe(r6, r0)
            if (r4 != r1) goto L_0x0049
            return r1
        L_0x0049:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__CollectionKt.qw(kotlinx.coroutines.flow.Flow, java.util.Collection, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
