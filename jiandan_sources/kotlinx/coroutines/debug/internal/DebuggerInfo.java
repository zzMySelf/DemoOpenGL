...
public final class DebuggerInfo implements Serializable {
    ...
    public DebuggerInfo(@NotNull ad adVar, @NotNull CoroutineContext coroutineContext) {
        Thread.State state2;
        g gVar = (g) coroutineContext.get(g.f6124th);
        String str = null;
        this.coroutineId = gVar == null ? null : Long.valueOf(gVar.xxx());
        ...
        this.name = hVar == null ? null : hVar.xxx();
        this.state = adVar.fe();
        Thread thread = adVar.f6209ad;
        this.lastObservedThreadState = (thread == null || (state2 = thread.getState()) == null) ? null : state2.toString();
        Thread thread2 = adVar.f6209ad;
        this.lastObservedThreadName = thread2 != null ? thread2.getName() : str;
        this.lastObservedStackTrace = adVar.rg();
        this.sequenceNumber = adVar.qw;
    }
