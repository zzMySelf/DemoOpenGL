...
public interface CancellableContinuation<T> extends Continuation<T> {
    ...
    public static final class qw {
        public static /* synthetic */ Object qw(CancellableContinuation cancellableContinuation, Object obj, Object obj2, int i2, Object obj3) {
            if (obj3 == null) {
                if ((i2 & 2) != 0) {
                    obj2 = null;
                }
                return cancellableContinuation.ad(obj, obj2);
            }
    ...
    @Nullable
    Object ad(T t, @Nullable Object obj);
    ...
    @Nullable
    Object o(@NotNull Throwable th2);

    void ppp(T t, @Nullable Function1<? super Throwable, Unit> function1);

    boolean vvv(@Nullable Throwable th2);
}
