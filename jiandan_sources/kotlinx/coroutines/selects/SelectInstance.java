...
public interface SelectInstance<R> {
    @Nullable
    Object ggg(@NotNull ad adVar);

    /* renamed from: if  reason: not valid java name */
    boolean m668if();

    @Nullable
    Object pf(@Nullable ggg.de deVar);

    boolean rg();

    @NotNull
    /* renamed from: switch  reason: not valid java name */
    Continuation<R> m669switch();

    void uk(@NotNull DisposableHandle disposableHandle);

    void when(@NotNull Throwable th2);
}
