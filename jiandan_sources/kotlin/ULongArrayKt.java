...
public final class ULongArrayKt {
    ...
    public static final long[] ULongArray(int i2, Function1<? super Integer, ULong> function1) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            jArr[i3] = function1.invoke(Integer.valueOf(i3)).m1378unboximpl();
        }
        return ULongArray.m1381constructorimpl(jArr);
    }
    ...
    public static final long[] m1397ulongArrayOfQwZRm1k(long... jArr) {
