...
public final class RunSuspend implements Continuation<Unit> {
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m2342getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m1164unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m2342getResultxLWZpok() {
        return this.result;
    }

    public void resumeWith(@NotNull Object obj) {
        synchronized (this) {
            this.result = Result.m1154boximpl(obj);
            notifyAll();
