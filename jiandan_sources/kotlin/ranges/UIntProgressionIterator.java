...
public final class UIntProgressionIterator extends UIntIterator {
    ...
    public UIntProgressionIterator(int i2, int i3, int i4) {
        ...
        this.hasNext = z;
        this.step = UInt.m1249constructorimpl(i4);
        this.next = !this.hasNext ? this.finalElement : i2;
    }
    ...
    public int m442nextUIntpVg5ArA() {
        int i2 = this.next;
        if (i2 != this.finalElement) {
            this.next = UInt.m1249constructorimpl(this.step + i2);
