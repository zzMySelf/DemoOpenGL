...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public String toString() {
        return CollectionsKt___CollectionsKt.joinToString$default(entrySet(), StringUtil.ARRAY_ELEMENT_SEPARATOR, StringUtil.ARRAY_START, "}", 0, (CharSequence) null, new AbstractMap$toString$1(this), 24, (Object) null);
    }
    ...
    public final String toString(Map.Entry<? extends K, ? extends V> entry) {
        return toString((Object) entry.getKey()) + a.h + toString((Object) entry.getValue());
    }
