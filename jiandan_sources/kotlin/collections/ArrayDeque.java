...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final void copyElements(int i2) {
        ...
        int i3 = this.head;
        ArraysKt___ArraysJvmKt.copyInto((T[]) objArr3, (T[]) objArr, length - i3, 0, i3);
        this.head = 0;
        this.elementData = objArr;
    }

    private final int decremented(int i2) {
        return i2 == 0 ? ArraysKt___ArraysKt.getLastIndex((T[]) this.elementData) : i2 - 1;
    }
    ...
    private final int incremented(int i2) {
        if (i2 == ArraysKt___ArraysKt.getLastIndex((T[]) this.elementData)) {
            return 0;
        }
        return i2 + 1;
    }
    ...
    public void clear() {
        ...
        int i2 = this.head;
        if (i2 < positiveMod) {
            ArraysKt___ArraysJvmKt.fill((T[]) this.elementData, null, i2, positiveMod);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
    ...
    public E get(int i2) {
        ...
        return this.elementData[positiveMod(this.head + i2)];
    }
    ...
    public E removeAt(int i2) {
        ...
        if (i2 < (size() >> 1)) {
            ...
            if (positiveMod >= i3) {
                Object[] objArr = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto((T[]) objArr, (T[]) objArr, i3 + 1, i3, positiveMod);
            } else {
                Object[] objArr2 = this.elementData;
                ...
                int i4 = this.head;
                ArraysKt___ArraysJvmKt.copyInto((T[]) objArr3, (T[]) objArr3, i4 + 1, i4, objArr3.length - 1);
            }
    ...
    public <T> T[] toArray(@NotNull T[] tArr) {
        ...
        int i2 = this.head;
        if (i2 < positiveMod) {
            ArraysKt___ArraysJvmKt.copyInto$default(this.elementData, (Object[]) tArr, 0, i2, positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
        ...
        if (i2 == size()) {
            ...
            if (i2 < ((size() + 1) >> 1)) {
                ...
                if (decremented >= i3) {
                    ...
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr, (T[]) objArr, i3, i3 + 1, decremented + 1);
                } else {
                    Object[] objArr2 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr2, (T[]) objArr2, i3 - 1, i3, objArr2.length);
                    Object[] objArr3 = this.elementData;
    ...
    public boolean addAll(int i2, @NotNull Collection<? extends E> collection) {
        ...
        if (i2 < ((size() + 1) >> 1)) {
            ...
            if (positiveMod2 < i3) {
                Object[] objArr = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto((T[]) objArr, (T[]) objArr, i4, i3, objArr.length);
                ...
                Object[] objArr5 = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto((T[]) objArr5, (T[]) objArr5, i4, i3, positiveMod2);
            } else {
                Object[] objArr6 = this.elementData;
                i4 += objArr6.length;
                ...
                if (length >= i5) {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr6, (T[]) objArr6, i4, i3, positiveMod2);
                } else {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr6, (T[]) objArr6, i4, i3, i3 + length);
                    Object[] objArr7 = this.elementData;
            ...
            int i6 = positiveMod2 + size2;
            if (positiveMod2 < positiveMod) {
                int i7 = size2 + positiveMod;
                Object[] objArr8 = this.elementData;
                if (i7 <= objArr8.length) {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr8, (T[]) objArr8, i6, positiveMod2, positiveMod);
                } else if (i6 >= objArr8.length) {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr8, (T[]) objArr8, i6 - objArr8.length, positiveMod2, positiveMod);
                } else {
                    int length2 = positiveMod - (i7 - objArr8.length);
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr8, (T[]) objArr8, 0, length2, positiveMod);
                    Object[] objArr9 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr9, (T[]) objArr9, i6, positiveMod2, length2);
                }
            } else {
                ...
                if (i6 >= objArr11.length) {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr11, (T[]) objArr11, i6 - objArr11.length, positiveMod2, objArr11.length);
                } else {
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr11, (T[]) objArr11, 0, objArr11.length - size2, objArr11.length);
                    Object[] objArr12 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto((T[]) objArr12, (T[]) objArr12, i6, positiveMod2, objArr12.length - size2);
                }
            }
