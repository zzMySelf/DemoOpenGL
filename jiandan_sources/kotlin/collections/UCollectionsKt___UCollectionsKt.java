...
public class UCollectionsKt___UCollectionsKt {
    ...
    public static final byte[] toUByteArray(@NotNull Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m1224constructorimpl(collection.size());
        int i2 = 0;
        for (UByte r2 : collection) {
            UByteArray.m1235setVurrAj0(r0, i2, r2.m1222unboximpl());
            i2++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(@NotNull Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m1302constructorimpl(collection.size());
        int i2 = 0;
        for (UInt r2 : collection) {
            UIntArray.m1313setVXSXFK8(r0, i2, r2.m1300unboximpl());
            i2++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(@NotNull Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m1380constructorimpl(collection.size());
        int i2 = 0;
        for (ULong r2 : collection) {
            ULongArray.m1391setk8EXiF4(r0, i2, r2.m1378unboximpl());
            i2++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(@NotNull Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m1484constructorimpl(collection.size());
        int i2 = 0;
        for (UShort r2 : collection) {
            UShortArray.m1495set01HTLdE(r0, i2, r2.m1482unboximpl());
            i2++;
        }
        return r0;
    }
