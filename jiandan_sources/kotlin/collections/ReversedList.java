...
public final class ReversedList<T> extends AbstractMutableList<T> {
    ...
    public void add(int i2, T t) {
        this.delegate.add(CollectionsKt__ReversedViewsKt.reversePositionIndex$CollectionsKt__ReversedViewsKt(this, i2), t);
    }
    ...
    public T set(int i2, T t) {
        return this.delegate.set(CollectionsKt__ReversedViewsKt.reverseElementIndex$CollectionsKt__ReversedViewsKt(this, i2), t);
    }
}
