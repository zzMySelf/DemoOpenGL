...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    public static final class EntryRef<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
        ...
        public V setValue(V v) {
            ...
            int i2 = this.index;
            V v2 = access$allocateValuesArray[i2];
            access$allocateValuesArray[i2] = v;
            return v2;
        }
    ...
    private final void ensureCapacity(int i2) {
        if (i2 < 0) {
        ...
        } else if (i2 > getCapacity()) {
            int capacity = (getCapacity() * 3) / 2;
            if (i2 <= capacity) {
                i2 = capacity;
            }
            this.keysArray = ListBuilderKt.copyOfUninitializedElements(this.keysArray, i2);
            V[] vArr = this.valuesArray;
            ...
            int access$computeHashSize = Companion.computeHashSize(i2);
    ...
    private final int findKey(K k) {
        ...
        while (true) {
            ...
            if (i3 > 0) {
                int i4 = i3 - 1;
                if (Intrinsics.areEqual((Object) this.keysArray[i4], (Object) k)) {
                    return i4;
                }
            }
            i2--;
    ...
    private final boolean putEntry(Map.Entry<? extends K, ? extends V> entry) {
        ...
        if (Intrinsics.areEqual((Object) entry.getValue(), allocateValuesArray[i2])) {
            return false;
        }
    ...
    public final int addKey$kotlin_stdlib(K k) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                } else if (Intrinsics.areEqual((Object) this.keysArray[i3 - 1], (Object) k)) {
                    return -i3;
                } else {
                    i2++;
                    if (i2 > coerceAtMost) {
    ...
    public MapBuilder(int i2) {
        this(ListBuilderKt.arrayOfUninitializedElements(i2), (V[]) null, new int[i2], new int[Companion.computeHashSize(i2)], 2, 0);
    }
}
