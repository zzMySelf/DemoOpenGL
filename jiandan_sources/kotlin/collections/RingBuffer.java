...
public final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public RingBuffer(@NotNull Object[] objArr, int i2) {
        ...
        boolean z = true;
        if (i2 >= 0) {
            if (i2 > this.buffer.length ? false : z) {
    ...
    public T get(int i2) {
        ...
        return this.buffer[(this.startIndex + i2) % this.capacity];
    }
    ...
    public final void removeFirst(int i2) {
        ...
        if (i2 >= 0) {
            ...
            if (!z) {
                ...
                int access$getCapacity$p = (i3 + i2) % this.capacity;
                if (i3 > access$getCapacity$p) {
                    ArraysKt___ArraysJvmKt.fill((T[]) this.buffer, null, i3, this.capacity);
                    ArraysKt___ArraysJvmKt.fill((T[]) this.buffer, null, 0, access$getCapacity$p);
                } else {
                    ArraysKt___ArraysJvmKt.fill((T[]) this.buffer, null, i3, access$getCapacity$p);
                }
    ...
    public <T> T[] toArray(@NotNull T[] tArr) {
        ...
        int i3 = 0;
        int i4 = 0;
        while (i4 < size2 && i2 < this.capacity) {
            tArr[i4] = this.buffer[i2];
            i4++;
            i2++;
        }
        while (i4 < size2) {
