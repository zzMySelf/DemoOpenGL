...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(@NotNull List<? extends T> list, @Nullable T t, int i2, int i3) {
        ...
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
            int compareValues = ComparisonsKt__ComparisonsKt.compareValues((Comparable) list.get(i5), t);
            if (compareValues < 0) {
                i2 = i5 + 1;
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(@NotNull List<? extends T> list, @Nullable K k, int i2, int i3, @NotNull Function1<? super T, ? extends K> function1) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(function1, "selector");
        return binarySearch(list, i2, i3, new CollectionsKt__CollectionsKt$binarySearchBy$1(function1, k));
    }
