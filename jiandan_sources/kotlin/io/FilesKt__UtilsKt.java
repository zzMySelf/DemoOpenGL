...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getNameWithoutExtension(@NotNull File file) {
        ...
        String name = file.getName();
        Intrinsics.checkNotNullExpressionValue(name, "name");
        return StringsKt__StringsKt.substringBeforeLast$default(name, IStringUtil.CURRENT_PATH, (String) null, 2, (Object) null);
    }
    ...
    public static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        while (i2 < min && Intrinsics.areEqual((Object) normalize$FilesKt__UtilsKt.getSegments().get(i2), (Object) normalize$FilesKt__UtilsKt2.getSegments().get(i2))) {
            i2++;
        }
        StringBuilder sb = new StringBuilder();
        int i3 = size - 1;
        if (i2 <= i3) {
            while (!Intrinsics.areEqual((Object) normalize$FilesKt__UtilsKt2.getSegments().get(i3).getName(), (Object) IStringUtil.TOP_PATH)) {
        ...
        if (i2 < size2) {
            ...
            List<T> drop = CollectionsKt___CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i2);
            String str = File.separator;
            Intrinsics.checkNotNullExpressionValue(str, "separator");
    ...
    public static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            String name = file.getName();
            if (!Intrinsics.areEqual((Object) name, (Object) IStringUtil.CURRENT_PATH)) {
                if (!Intrinsics.areEqual((Object) name, (Object) IStringUtil.TOP_PATH)) {
                    arrayList.add(file);
                } else if (arrayList.isEmpty() || Intrinsics.areEqual((Object) ((File) CollectionsKt___CollectionsKt.last(arrayList)).getName(), (Object) IStringUtil.TOP_PATH)) {
                    arrayList.add(file);
                } else {
