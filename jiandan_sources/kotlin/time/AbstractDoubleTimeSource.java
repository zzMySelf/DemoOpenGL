...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    public static final class DoubleTimeMark extends TimeMark {
        ...
        public long m508elapsedNowUwyO8pc() {
        ...
        public TimeMark m509plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m555plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }
    ...
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m621getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
