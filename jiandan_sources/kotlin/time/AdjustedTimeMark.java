...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public long m512elapsedNowUwyO8pc() {
        return Duration.m554minusLRDsOJo(this.mark.m648elapsedNowUwyO8pc(), m513getAdjustmentUwyO8pc());
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m513getAdjustmentUwyO8pc() {
    ...
    public TimeMark m514plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m555plusLRDsOJo(m513getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
