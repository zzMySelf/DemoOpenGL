...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m651copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            t = timedValue.value;
        }
        if ((i2 & 2) != 0) {
        ...
        return timedValue.m653copyRFiDyg4(t, j);
    }
    ...
    public final long m652component2UwyO8pc() {
        return this.duration;
    }

    @NotNull
    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m653copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m524equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc  reason: not valid java name */
    public final long m654getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m547hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m568toStringimpl(this.duration) + ')';
    }
}
