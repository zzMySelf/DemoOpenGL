...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    public static final class LongTimeMark extends TimeMark {
        ...
        public long m510elapsedNowUwyO8pc() {
            return Duration.m554minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @NotNull
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark m511plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m555plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m621getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
