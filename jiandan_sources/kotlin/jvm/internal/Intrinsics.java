...
public class Intrinsics {
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + str + IStringUtil.CURRENT_PATH + str2)));
        }
    }
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + str + IStringUtil.CURRENT_PATH + str2)));
        }
    }
    ...
    public static String createParameterIsNullExceptionMessage(String str) {
        ...
        return "Parameter specified as non-null is null: method " + className + IStringUtil.CURRENT_PATH + methodName + ", parameter " + str;
    }
