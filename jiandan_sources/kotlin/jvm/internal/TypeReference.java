...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean z) {
        ...
        if (getArguments().isEmpty()) {
            ...
            str2 = CollectionsKt___CollectionsKt.joinToString$default(getArguments(), StringUtil.ARRAY_ELEMENT_SEPARATOR, "<", ">", 0, (CharSequence) null, new TypeReference$asString$args$1(this), 24, (Object) null);
        }
        if (isMarkedNullable()) {
            str3 = "?";
        }
        ...
        return '(' + str4 + IStringUtil.TOP_PATH + asString + ')';
    }
