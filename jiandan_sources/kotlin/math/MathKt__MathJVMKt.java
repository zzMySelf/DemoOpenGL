...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    public static final double withSign(double d, int i2) {
        return Math.copySign(d, (double) i2);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    public static final float pow(float f, int i2) {
        return (float) Math.pow((double) f, (double) i2);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    public static final float withSign(float f, int i2) {
        return Math.copySign(f, (float) i2);
    }
