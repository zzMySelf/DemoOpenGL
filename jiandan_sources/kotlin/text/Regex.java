...
public final class Regex implements Serializable {
    ...
    @Nullable
    public final MatchResult find(@NotNull CharSequence charSequence, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "input");
        Matcher matcher = this.nativePattern.matcher(charSequence);
        Intrinsics.checkNotNullExpressionValue(matcher, "nativePattern.matcher(input)");
        return RegexKt.findNext(matcher, i2, charSequence);
    }

    @NotNull
    public final Sequence<MatchResult> findAll(@NotNull CharSequence charSequence, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "input");
        if (i2 >= 0 && i2 <= charSequence.length()) {
            return SequencesKt__SequencesKt.generateSequence(new Regex$findAll$1(this, charSequence, i2), Regex$findAll$2.INSTANCE);
        }
    ...
    public final MatchResult matchAt(@NotNull CharSequence charSequence, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "input");
    ...
    @SinceKotlin(version = "1.5")
    @ExperimentalStdlibApi
    public final boolean matchesAt(@NotNull CharSequence charSequence, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "input");
    ...
    public final List<String> split(@NotNull CharSequence charSequence, int i2) {
        ...
        int i3 = 10;
        if (i2 > 0) {
            i3 = RangesKt___RangesKt.coerceAtMost(i2, 10);
        }
    ...
    public final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "input");
        StringsKt__StringsKt.requireNonNegativeLimit(i2);
        return SequencesKt__SequenceBuilderKt.sequence(new Regex$splitToSequence$1(this, charSequence, i2, (Continuation<? super Regex$splitToSequence$1>) null));
    }
