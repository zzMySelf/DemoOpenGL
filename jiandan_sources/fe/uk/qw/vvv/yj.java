...
public class yj extends FilterInputStream {

    /* renamed from: ad  reason: collision with root package name */
    public int f6059ad = Integer.MIN_VALUE;

    public yj(@NonNull InputStream inputStream) {
        super(inputStream);
    }
    ...
    public synchronized void reset() throws IOException {
        super.reset();
        this.f6059ad = Integer.MIN_VALUE;
    }
