...
public final class ad {
    ...
    public static final void de(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @Nullable Map<String, ? extends Object> map) {
        ...
        try {
            ...
            Result.m1155constructorimpl(jSONObject.put("loginInfo", qw.qw.pf() ? "load" : "Unload"));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.Companion;
            Result.m1155constructorimpl(ResultKt.createFailure(th2));
        }
        rg.ad("7481", str3, "display", str2, str, str4, jSONObject);
    }

    public static /* synthetic */ void fe(String str, String str2, String str3, String str4, Map map, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            str3 = "aiscan";
        }
        if ((i2 & 8) != 0) {
    ...
    public static final void qw(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @Nullable Map<String, ? extends Object> map) {
        ...
        rg.ad("7481", str3, "clk", str2, str, str4, jSONObject);
    }
}
