...
public final class yj extends fe {
    ...
    public static final void fe(com.tera.scan.business.textrecognition.TextRecognitionActivity r9, java.util.List r10, com.mars.kotlin.service.Result r11) {
        /*
            ...
            if (r11 == 0) goto L_0x0032
            fe.mmm.qw.rg.de.nn.yj$qw r2 = new fe.mmm.qw.rg.de.nn.yj$qw
            r2.<init>()
        ...
        L_0x005b:
            ...
            r5.put(r8, r6)
            java.lang.Object r6 = kotlin.collections.CollectionsKt___CollectionsKt.getOrNull(r10, r2)
            fe.mmm.qw.rg.de.ddd.qw r6 = (fe.mmm.qw.rg.de.ddd.qw) r6
        ...
        L_0x006e:
            r6 = r7
        L_0x006f:
            java.lang.String r8 = "original_text"
            r5.put(r8, r6)
            java.lang.String r3 = r3.getAfterTranslate()
            if (r3 != 0) goto L_0x007b
            r3 = r7
        L_0x007b:
            java.lang.String r6 = "translate_text"
            r5.put(r6, r3)
        ...
        L_0x009a:
            ...
            java.lang.String r10 = "/netdisk/translate_pdf_result"
            fe.mmm.qw.p024if.when.qw.de(r9, r10, r0)
            r9.finish()
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fe.mmm.qw.rg.de.nn.yj.fe(com.tera.scan.business.textrecognition.TextRecognitionActivity, java.util.List, com.mars.kotlin.service.Result):void");
    }

    public void de() {
        ScanAnalyticsBaseEvent.qw.qw(fe.mmm.qw.ggg.qw.qw, "file_preview_translate_loading_show", (List) null, 2, (Object) null);
    }
    ...
    public void qw(@NotNull TextRecognitionActivity textRecognitionActivity, @NotNull List<fe.mmm.qw.rg.de.ddd.qw> list, @NotNull String str) {
        ...
        try {
            ...
            obj = Result.m1155constructorimpl(fe.mmm.qw.j.yj.fe(arrayList));
        } catch (Throwable th2) {
        ...
        new AiTranslateTextManager(textRecognitionActivity).qw("SC3IQL", "", displayLanguage, str2).observe(textRecognitionActivity, new de(textRecognitionActivity, list));
    }
}
