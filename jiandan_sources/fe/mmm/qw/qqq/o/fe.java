...
public abstract class fe {
    ...
    public static final class ad extends fe {

        /* renamed from: ad  reason: collision with root package name */
        public final int f8206ad;
        @NotNull
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            ad adVar = (ad) obj;
            return Intrinsics.areEqual((Object) this.qw, (Object) adVar.qw) && this.f8206ad == adVar.f8206ad;
        }

        public int hashCode() {
            return (this.qw.hashCode() * 31) + this.f8206ad;
        }
        ...
        public String toString() {
            return "MergePdfSuccess(scanRecordExportFile=" + this.qw + ", pdfPageCount=" + this.f8206ad + ')';
        }
    }

    public static final class qw extends fe {
        public final int qw;
        ...
        @NotNull
        public String toString() {
            return "MergePdfFail(msgId=" + this.qw + ')';
        }
    }
