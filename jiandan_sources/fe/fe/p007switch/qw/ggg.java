...
/* renamed from: fe.fe.switch.qw.ggg  reason: invalid package */
public final class ggg {
    ...
    public static String fe(byte[] bArr) throws UnsupportedEncodingException {
        return qw(bArr, a.h);
    }

    public static String qw(byte[] bArr, String str) throws UnsupportedEncodingException {
