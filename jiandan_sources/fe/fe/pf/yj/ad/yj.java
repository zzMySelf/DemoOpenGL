...
public class yj {
    ...
    public final byte[] f2959ad;

    /* renamed from: de  reason: collision with root package name */
    public final int f2960de;
    ...
    public void ad(byte[] bArr, int i2, int i3) {
        if (i3 > 0) {
            ...
            int i5 = this.f2962rg;
            if (i5 + i3 < 16) {
                System.arraycopy(bArr, i2, this.f2959ad, i5, i3);
                this.f2962rg += i3;
                return;
            }
            if (i5 > 0) {
                int i6 = 16 - i5;
                System.arraycopy(bArr, i2, this.f2959ad, i5, i6);
                rg(this.f2959ad, 0);
                i2 += i6;
            }
            int i7 = i4 - 16;
            ...
            if (i2 < i4) {
                int i8 = i4 - i2;
                this.f2962rg = i8;
                System.arraycopy(bArr, i2, this.f2959ad, 0, i8);
            }
        }
    }
    ...
    public long de() {
        int i2 = 0;
        int rotateLeft = (this.f2961fe > 16 ? Integer.rotateLeft(this.qw[0], 1) + Integer.rotateLeft(this.qw[1], 7) + Integer.rotateLeft(this.qw[2], 12) + Integer.rotateLeft(this.qw[3], 18) : this.qw[2] + XXHash32.PRIME5) + this.f2961fe;
        int i3 = this.f2962rg - 4;
        while (i2 <= i3) {
            rotateLeft = Integer.rotateLeft(rotateLeft + (qw(this.f2959ad, i2) * XXHash32.PRIME3), 17) * XXHash32.PRIME4;
            i2 += 4;
        }
        while (i2 < this.f2962rg) {
            rotateLeft = Integer.rotateLeft(rotateLeft + ((this.f2959ad[i2] & 255) * XXHash32.PRIME5), 11) * XXHash32.PRIME1;
            i2++;
        }
