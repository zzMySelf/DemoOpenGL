...
public class o {
    ...
    public static final class qw {
        ...
        public String f1409ad;
        @NonNull
        public File qw;

        public qw(@NonNull File file) {
            this.qw = file;
            this.f1409ad = file.getName();
        }
    }
    ...
    public static void qw(java.io.File r5, java.util.List<fe.fe.ddd.fe.qw.o.qw> r6) throws java.io.IOException {
        /*
        ...
        L_0x0014:
            ...
            r1 = 0
            byte[] r0 = new byte[r0]     // Catch:{ FileNotFoundException -> 0x0085, all -> 0x0080 }
            java.util.zip.ZipOutputStream r2 = new java.util.zip.ZipOutputStream     // Catch:{ FileNotFoundException -> 0x0085, all -> 0x0080 }
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ FileNotFoundException -> 0x0085, all -> 0x0080 }
            r3.<init>(r5)     // Catch:{ FileNotFoundException -> 0x0085, all -> 0x0080 }
            r2.<init>(r3)     // Catch:{ FileNotFoundException -> 0x0085, all -> 0x0080 }
        ...
        L_0x002e:
            ...
            fe.fe.ddd.fe.qw.o$qw r6 = (fe.fe.ddd.fe.qw.o.qw) r6     // Catch:{ FileNotFoundException -> 0x007e, all -> 0x007b }
            ...
            java.lang.String r6 = r6.f1409ad     // Catch:{ FileNotFoundException -> 0x0062, all -> 0x005f }
        ...
        L_0x0088:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fe.fe.ddd.fe.qw.o.qw(java.io.File, java.util.List):void");
    }
}
