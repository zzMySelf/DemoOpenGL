...
public class rg extends qw {
    ...
    public static final CameraLogger f9262rg = CameraLogger.qw(rg.class.getSimpleName());
    ...
    public void ad(@NonNull ActionHolder actionHolder, @NonNull CaptureRequest captureRequest, @NonNull TotalCaptureResult totalCaptureResult) {
        ...
        f9262rg.de("processCapture:", "awbState:", num);
    ...
    public boolean ggg(@NonNull ActionHolder actionHolder) {
        ...
        f9262rg.de("checkIsSupported:", Boolean.valueOf(z2));
        return z2;
    }
    ...
    public boolean vvv(@NonNull ActionHolder actionHolder) {
        ...
        if (totalCaptureResult != null) {
            ...
            f9262rg.de("checkShouldSkip:", Boolean.valueOf(z));
            return z;
        }
        f9262rg.de("checkShouldSkip: false - lastResult is null.");
        return false;
    }

    public void xxx(@NonNull ActionHolder actionHolder) {
        actionHolder.rg(this).set(CaptureRequest.CONTROL_AWB_LOCK, Boolean.TRUE);
