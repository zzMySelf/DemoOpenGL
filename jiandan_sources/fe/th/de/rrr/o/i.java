...
public class i {
    ...
    public byte[] de(byte[] bArr) {
        ...
        for (byte b2 : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                qwVar = qwVar.qw[(b >>> (i2 - 8)) & 255];
                if (qwVar.qw == null) {
                    byteArrayOutputStream.write(qwVar.f5341ad);
                    i2 -= qwVar.f5342de;
                    qwVar = this.qw;
                } else {
                    i2 -= 8;
        ...
        while (i2 > 0) {
            qw qwVar2 = qwVar.qw[(b << (8 - i2)) & 255];
            if (qwVar2.qw != null || qwVar2.f5342de > i2) {
                break;
            }
            byteArrayOutputStream.write(qwVar2.f5341ad);
            i2 -= qwVar2.f5342de;
            qwVar = this.qw;
        }
    ...
    public void fe(okio.ByteString r8, okio.BufferedSink r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fe.th.de.rrr.o.i.fe(okio.ByteString, okio.BufferedSink):void");
    }

    public final void qw(int i2, int i3, byte b) {
        qw qwVar = new qw(i2, b);
        qw qwVar2 = this.qw;
        while (b > 8) {
            b = (byte) (b - 8);
            int i4 = (i3 >>> b) & 255;
            qw[] qwVarArr = qwVar2.qw;
            if (qwVarArr != null) {
                if (qwVarArr[i4] == null) {
                    qwVarArr[i4] = new qw();
                }
    ...
    public int rg(ByteString byteString) {
        long j = 0;
        for (int i2 = 0; i2 < byteString.size(); i2++) {
            j += (long) f5339de[byteString.getByte(i2) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
    ...
    public static final class qw {
        ...
        /* renamed from: ad  reason: collision with root package name */
        public final int f5341ad;

        /* renamed from: de  reason: collision with root package name */
        public final int f5342de;
        public final qw[] qw;
