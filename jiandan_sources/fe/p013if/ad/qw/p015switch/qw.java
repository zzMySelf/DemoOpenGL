...
/* renamed from: fe.if.ad.qw.switch.qw  reason: invalid package */
public class qw {
    public static File ad(Context context, String str) throws IOException {
        File cacheDir = context.getCacheDir();
        File file = new File(cacheDir, str + "-pdfview.pdf");
        if (str.contains("/")) {
            file.getParentFile().mkdirs();
        }
        qw(context.getAssets().open(str), file);
        return file;
    }
    ...
    public static void qw(java.io.InputStream r3, java.io.File r4) throws java.io.IOException {
        /*
            r0 = 0
        ...
        L_0x003b:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: fe.p013if.ad.qw.p015switch.qw.qw(java.io.InputStream, java.io.File):void");
    }
}
