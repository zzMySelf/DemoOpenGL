...
public class Cif<Data> implements ModelLoader<String, Data> {
    ...
    /* renamed from: fe.rg.qw.o.rg.if$de */
    ...
    /* renamed from: fe.rg.qw.o.rg.if$qw */
    ...
    /* renamed from: de */
    public ModelLoader.qw<Data> ad(@NonNull String str, int i2, int i3, @NonNull fe.rg.qw.o.ad adVar) {
        Uri rg2 = rg(str);
