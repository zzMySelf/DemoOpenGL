...
public class o<Data> implements ModelLoader<Integer, Data> {
    ...
    public final Resources f4935ad;
    ...
    public o(Resources resources, ModelLoader<Uri, Data> modelLoader) {
        this.f4935ad = resources;
        this.qw = modelLoader;
    }

    /* renamed from: de */
    public ModelLoader.qw<Data> ad(@NonNull Integer num, int i2, int i3, @NonNull fe.rg.qw.o.ad adVar) {
        Uri fe2 = fe(num);
        if (fe2 == null) {
            return null;
        }
    ...
    public final Uri fe(Integer num) {
        try {
            return Uri.parse("android.resource://" + this.f4935ad.getResourcePackageName(num.intValue()) + '/' + this.f4935ad.getResourceTypeName(num.intValue()) + '/' + this.f4935ad.getResourceEntryName(num.intValue()));
