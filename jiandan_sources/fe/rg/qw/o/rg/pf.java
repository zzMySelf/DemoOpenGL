...
public class pf implements Encoder<InputStream> {
    ...
    public boolean qw(@androidx.annotation.NonNull java.io.InputStream r4, @androidx.annotation.NonNull java.io.File r5, @androidx.annotation.NonNull fe.rg.qw.o.ad r6) {
        /*
            r3 = this;
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r3.qw
        ...
        L_0x0039:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r4 = r3.qw
            r4.put(r6)
            return r0
        L_0x003f:
        ...
        L_0x0044:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r3.qw
            r5.put(r6)
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: fe.rg.qw.o.rg.pf.qw(java.io.InputStream, java.io.File, fe.rg.qw.o.ad):boolean");
    }
}
