...
public final class Transmitter {
    ...
    public java.io.IOException exchangeMessageDone(okhttp3.internal.connection.Exchange r3, boolean r4, boolean r5, java.io.IOException r6) {
        /*
            r2 = this;
    ...
    public Socket releaseConnectionNoEvents() {
        ...
        while (true) {
            if (i2 >= size) {
                i2 = -1;
                break;
            } else if (this.connection.transmitters.get(i2).get() == this) {
                break;
            } else {
                i2++;
            }
