...
public final class Http2Reader implements Closeable {
    ...
    private void readData(Handler handler, int i2, byte b, int i3) throws IOException {
        ...
        if (i3 != 0) {
            ...
            if (!z) {
                ...
                handler.data(z2, i3, this.source, lengthWithoutPadding(i2, b, s));
    ...
    private void readPushPromise(Handler handler, int i2, byte b, int i3) throws IOException {
        ...
        if (i3 != 0) {
            ...
            handler.pushPromise(i3, this.source.readInt() & Integer.MAX_VALUE, readHeaderBlock(lengthWithoutPadding(i2 - 4, b, s), s, b, i3));
            return;
        }
