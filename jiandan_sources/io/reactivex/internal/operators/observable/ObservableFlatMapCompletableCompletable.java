...
public final class ObservableFlatMapCompletableCompletable<T> extends qw implements FuseToObservable<T> {

    /* renamed from: ad  reason: collision with root package name */
    public final ObservableSource<T> f10097ad;

    /* renamed from: th  reason: collision with root package name */
    public final Function<? super T, ? extends CompletableSource> f10098th;

    /* renamed from: yj  reason: collision with root package name */
    public final boolean f10099yj;
    ...
    public ObservableFlatMapCompletableCompletable(ObservableSource<T> observableSource, Function<? super T, ? extends CompletableSource> function, boolean z) {
        this.f10097ad = observableSource;
        this.f10098th = function;
        this.f10099yj = z;
    }

    public rg<T> ad() {
        return th.de.ppp.qw.when(new ObservableFlatMapCompletable(this.f10097ad, this.f10098th, this.f10099yj));
    }

    public void de(CompletableObserver completableObserver) {
        this.f10097ad.subscribe(new FlatMapCompletableMainObserver(completableObserver, this.f10098th, this.f10099yj));
    }
}
