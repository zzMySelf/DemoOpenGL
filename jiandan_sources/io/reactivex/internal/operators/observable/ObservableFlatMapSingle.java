...
public final class ObservableFlatMapSingle<T, R> extends qw<T, R> {

    /* renamed from: th  reason: collision with root package name */
    public final Function<? super T, ? extends SingleSource<? extends R>> f10102th;

    /* renamed from: yj  reason: collision with root package name */
    public final boolean f10103yj;
    ...
    public ObservableFlatMapSingle(ObservableSource<T> observableSource, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        ...
        this.f10102th = function;
        this.f10103yj = z;
    }

    public void subscribeActual(Observer<? super R> observer) {
        this.f10756ad.subscribe(new FlatMapSingleObserver(observer, this.f10102th, this.f10103yj));
    }
}
