...
public final class ObservableMergeWithSingle<T> extends qw<T, T> {

    /* renamed from: th  reason: collision with root package name */
    public final SingleSource<? extends T> f10155th;
    ...
    public ObservableMergeWithSingle(rg<T> rgVar, SingleSource<? extends T> singleSource) {
        super(rgVar);
        this.f10155th = singleSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f10155th.qw(mergeWithObserver.otherObserver);
    }
}
