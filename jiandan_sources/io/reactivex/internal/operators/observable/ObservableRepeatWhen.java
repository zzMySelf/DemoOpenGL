...
public final class ObservableRepeatWhen<T> extends qw<T, T> {

    /* renamed from: th  reason: collision with root package name */
    public final Function<? super rg<Object>, ? extends ObservableSource<?>> f10184th;
    ...
    public static final class RepeatWhenObserver<T> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public final ad<Object> signaller;
        ...
        public RepeatWhenObserver(Observer<? super T> observer, ad<Object> adVar, ObservableSource<T> observableSource) {
    ...
    public ObservableRepeatWhen(ObservableSource<T> observableSource, Function<? super rg<Object>, ? extends ObservableSource<?>> function) {
        super(observableSource);
        this.f10184th = function;
    }

    public void subscribeActual(Observer<? super T> observer) {
        ad ad2 = PublishSubject.rg().ad();
        try {
            Object apply = this.f10184th.apply(ad2);
