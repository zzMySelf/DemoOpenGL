...
public enum SubscriptionHelper implements Subscription {
    ...
    public static void reportMoreProduced(long j) {
        th.de.ppp.qw.ddd(new ProtocolViolationException("More produced than requested: " + j));
    }

    public static void reportSubscriptionSet() {
        th.de.ppp.qw.ddd(new ProtocolViolationException("Subscription already set!"));
    }
    ...
    public static boolean validate(Subscription subscription, Subscription subscription2) {
        if (subscription2 == null) {
            th.de.ppp.qw.ddd(new NullPointerException("next is null"));
            return false;
    ...
    public static boolean validate(long j) {
        ...
        th.de.ppp.qw.ddd(new IllegalArgumentException("n > 0 required but it was " + j));
        return false;
    }
