...
public final class BehaviorProcessor<T> extends qw<T> {

    /* renamed from: th  reason: collision with root package name */
    public final Lock f10329th;

    /* renamed from: uk  reason: collision with root package name */
    public long f10330uk;

    /* renamed from: yj  reason: collision with root package name */
    public final AtomicReference<Object> f10331yj;
    ...
    public static final class BehaviorSubscription<T> extends AtomicLong implements Subscription, AppendOnlyLinkedArrayList.NonThrowingPredicate<Object> {
        ...
        public void emitFirst() {
            ...
            L_0x0012:
                ...
                java.util.concurrent.locks.Lock r1 = r0.f10329th     // Catch:{ all -> 0x003e }
                r1.lock()     // Catch:{ all -> 0x003e }
                long r2 = r0.f10330uk     // Catch:{ all -> 0x003e }
                r4.index = r2     // Catch:{ all -> 0x003e }
                java.util.concurrent.atomic.AtomicReference<java.lang.Object> r0 = r0.f10331yj     // Catch:{ all -> 0x003e }
    ...
    public abstract void uk(BehaviorSubscription<T> behaviorSubscription);
}
