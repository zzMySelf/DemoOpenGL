...
public class FlutterTextUtils {
    ...
    public boolean isEmoji(int i2) {
        return this.flutterJNI.nativeFlutterTextUtilsIsEmoji(i2);
    }

    public boolean isEmojiModifier(int i2) {
        return this.flutterJNI.nativeFlutterTextUtilsIsEmojiModifier(i2);
    }

    public boolean isEmojiModifierBase(int i2) {
        return this.flutterJNI.nativeFlutterTextUtilsIsEmojiModifierBase(i2);
    }
    ...
    public boolean isRegionalIndicatorSymbol(int i2) {
        return this.flutterJNI.nativeFlutterTextUtilsIsRegionalIndicator(i2);
    }
    ...
    public boolean isVariationSelector(int i2) {
        return this.flutterJNI.nativeFlutterTextUtilsIsVariationSelector(i2);
    }
}
