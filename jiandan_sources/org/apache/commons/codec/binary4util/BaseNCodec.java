...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    public String encodeAsString(byte[] bArr) {
        return CodecStringUtils.newStringUtf8(encode(bArr));
    }
    ...
    public byte[] ensureBufferSize(int i2, Context context) {
        byte[] bArr = context.buffer;
        if (bArr == null || bArr.length < context.pos + i2) {
    ...
    public long getEncodedLength(byte[] bArr) {
        ...
        long j = ((long) (((length + i2) - 1) / i2)) * ((long) this.encodedBlockSize);
        int i3 = this.lineLength;
        return i3 > 0 ? j + ((((((long) i3) + j) - 1) / ((long) i3)) * ((long) this.chunkSeparatorLength)) : j;
    }
    ...
    public boolean isInAlphabet(String str) {
        return isInAlphabet(CodecStringUtils.getBytesUtf8(str), true);
    }

    public byte[] decode(String str) {
        return decode(CodecStringUtils.getBytesUtf8(str));
    }
