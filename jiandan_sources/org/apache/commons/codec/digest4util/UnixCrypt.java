...
public class UnixCrypt {
    ...
    public static int[] body(int[] iArr, int i2, int i3) {
        ...
        int[] iArr2 = new int[2];
        permOp((i6 >>> 1) | (i6 << 31), (i5 >>> 1) | (i5 << 31), 1, MinMaxPriorityQueue.EVEN_POWERS_OF_TWO, iArr2);
    ...
    public static int[] desSetKey(byte[] bArr) {
        ...
        int i5 = iArr2[0];
        permOp(hPermOp(i5, -2, -859045888), hPermOp(iArr2[1], -2, -859045888), 1, MinMaxPriorityQueue.EVEN_POWERS_OF_TWO, iArr2);
        permOp(iArr2[1], iArr2[0], 8, 16711935, iArr2);
