...
public class DateUtils {
    ...
    public static Date ceiling(Date date, int i2) {
        if (date != null) {
            Calendar instance = Calendar.getInstance();
            instance.setTime(date);
            modify(instance, i2, ModifyType.CEILING);
            return instance.getTime();
        }
        throw new IllegalArgumentException("The date must not be null");
    }
    ...
    public static void modify(java.util.Calendar r16, int r17, org.apache.commons.lang3.time.DateUtils.ModifyType r18) {
        /*
            r0 = r16
            r1 = r17
            r2 = r18
    ...
    public static Date round(Date date, int i2) {
        if (date != null) {
            Calendar instance = Calendar.getInstance();
            instance.setTime(date);
            modify(instance, i2, ModifyType.ROUND);
            return instance.getTime();
        }
        throw new IllegalArgumentException("The date must not be null");
    }
    ...
    public static Date truncate(Date date, int i2) {
        if (date != null) {
            Calendar instance = Calendar.getInstance();
            instance.setTime(date);
            modify(instance, i2, ModifyType.TRUNCATE);
            return instance.getTime();
        }
        throw new IllegalArgumentException("The date must not be null");
    }
    ...
    public static long getFragment(Calendar calendar, int i2, TimeUnit timeUnit) {
        ...
        if (calendar != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    j = timeUnit.convert((long) (calendar.get(5) - i3), TimeUnit.DAYS);
                }
            ...
            j = timeUnit.convert((long) (calendar.get(6) - i3), TimeUnit.DAYS);
            j2 = 0 + j;
            if (i2 != 1) {
            }
            j2 += timeUnit.convert((long) calendar.get(11), TimeUnit.HOURS);
