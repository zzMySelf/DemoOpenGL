...
public class Conversion {
    ...
    public static byte binaryToByte(boolean[] zArr, int i2, byte b, int i3, int i4) {
        ...
        if ((i4 - 1) + i3 < 8) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = i5 + i3;
                b = (byte) ((b & (~(1 << i6))) | ((zArr[i5 + i2] ? 1 : 0) << i6));
            }
            return b;
        }
    ...
    public static long byteArrayToLong(byte[] bArr, int i2, long j, int i3, int i4) {
        ...
        if (((i4 - 1) * 8) + i3 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 8) + i3;
                j = (j & (~(255 << i6))) | ((((long) bArr[i5 + i2]) & 255) << i6);
            }
            return j;
        }
    ...
    public static boolean[] byteToBinary(byte b, int i2, boolean[] zArr, int i3, int i4) {
        if (i4 == 0) {
            return zArr;
        }
        if ((i4 - 1) + i2 < 8) {
    ...
    public static String byteToHex(byte b, int i2, String str, int i3, int i4) {
        if (i4 == 0) {
            return str;
        }
        if (((i4 - 1) * 4) + i2 < 8) {
    ...
    public static byte hexToByte(String str, int i2, byte b, int i3, int i4) {
        if (i4 == 0) {
            return b;
        }
        if (((i4 - 1) * 4) + i3 < 8) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 4) + i3;
                b = (byte) ((b & (~(15 << i6))) | ((hexDigitToInt(str.charAt(i5 + i2)) & 15) << i6));
            }
            return b;
        }
    ...
    public static long hexToLong(String str, int i2, long j, int i3, int i4) {
        ...
        if (((i4 - 1) * 4) + i3 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 4) + i3;
                j = (j & (~(15 << i6))) | ((((long) hexDigitToInt(str.charAt(i5 + i2))) & 15) << i6);
            }
            return j;
        }
    ...
    public static long intArrayToLong(int[] iArr, int i2, long j, int i3, int i4) {
        ...
        if (((i4 - 1) * 32) + i3 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 32) + i3;
                j = (j & (~(4294967295 << i6))) | ((((long) iArr[i5 + i2]) & 4294967295L) << i6);
            }
            return j;
        }
    ...
    public static byte[] longToByteArray(long j, int i2, byte[] bArr, int i3, int i4) {
        ...
        if (((i4 - 1) * 8) + i2 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                bArr[i3 + i5] = (byte) ((int) (255 & (j >> ((i5 * 8) + i2))));
            }
            return bArr;
        }
    ...
    public static short[] longToShortArray(long j, int i2, short[] sArr, int i3, int i4) {
        ...
        if (((i4 - 1) * 16) + i2 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                sArr[i3 + i5] = (short) ((int) (WebSocketProtocol.PAYLOAD_SHORT_MAX & (j >> ((i5 * 16) + i2))));
            }
            return sArr;
        }
    ...
    public static long shortArrayToLong(short[] sArr, int i2, long j, int i3, int i4) {
        ...
        if (((i4 - 1) * 16) + i3 < 64) {
            for (int i5 = 0; i5 < i4; i5++) {
                int i6 = (i5 * 16) + i3;
                j = (j & (~(WebSocketProtocol.PAYLOAD_SHORT_MAX << i6))) | ((((long) sArr[i5 + i2]) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << i6);
            }
            return j;
        }
