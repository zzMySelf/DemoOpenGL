        ...
        public class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r5, android.os.Bundle r6, android.os.ResultReceiver r7) {
                /*
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r5 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c3 }
                    java.lang.ref.WeakReference<android.support.v4.media.session.MediaSessionCompat$MediaSessionImpl> r5 = r5.mSessionImpl     // Catch:{ BadParcelableException -> 0x00c3 }
                    java.lang.Object r5 = r5.get()     // Catch:{ BadParcelableException -> 0x00c3 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r5 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r5     // Catch:{ BadParcelableException -> 0x00c3 }
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Token r5 = r5.getSessionToken()     // Catch:{ BadParcelableException -> 0x00c3 }
                    android.support.v4.media.session.IMediaSession r0 = r5.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00c3 }
                ...
                L_0x002b:
                    androidx.core.app.BundleCompat.putBinder(r6, r2, r1)     // Catch:{ BadParcelableException -> 0x00c3 }
                    android.os.Bundle r5 = r5.getSessionToken2Bundle()     // Catch:{ BadParcelableException -> 0x00c3 }
                ...
                L_0x003d:
                    ...
                    android.support.v4.media.MediaDescriptionCompat r6 = (android.support.v4.media.MediaDescriptionCompat) r6     // Catch:{ BadParcelableException -> 0x00c3 }
                    r5.onAddQueueItem(r6)     // Catch:{ BadParcelableException -> 0x00c3 }
                    goto L_0x00c3
                L_0x0054:
                    ...
                    android.support.v4.media.MediaDescriptionCompat r7 = (android.support.v4.media.MediaDescriptionCompat) r7     // Catch:{ BadParcelableException -> 0x00c3 }
                    int r6 = r6.getInt(r3)     // Catch:{ BadParcelableException -> 0x00c3 }
                    r5.onAddQueueItem(r7, r6)     // Catch:{ BadParcelableException -> 0x00c3 }
                    goto L_0x00c3
                L_0x006e:
                    ...
                    android.os.Parcelable r6 = r6.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c3 }
                    android.support.v4.media.MediaDescriptionCompat r6 = (android.support.v4.media.MediaDescriptionCompat) r6     // Catch:{ BadParcelableException -> 0x00c3 }
                    r5.onRemoveQueueItem(r6)     // Catch:{ BadParcelableException -> 0x00c3 }
                    goto L_0x00c3
                L_0x0082:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r5 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r5     // Catch:{ BadParcelableException -> 0x00c3 }
                    if (r5 == 0) goto L_0x00c3
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r7 = r5.mQueue     // Catch:{ BadParcelableException -> 0x00c3 }
                    ...
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r5 = r5.mQueue     // Catch:{ BadParcelableException -> 0x00c3 }
                    java.lang.Object r5 = r5.get(r6)     // Catch:{ BadParcelableException -> 0x00c3 }
                    r1 = r5
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00c3 }
                L_0x00b2:
                    if (r1 == 0) goto L_0x00c3
                    android.support.v4.media.session.MediaSessionCompat$Callback r5 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c3 }
                    android.support.v4.media.MediaDescriptionCompat r6 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00c3 }
                    r5.onRemoveQueueItem(r6)     // Catch:{ BadParcelableException -> 0x00c3 }
                    goto L_0x00c3
                L_0x00be:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c3 }
                    r0.onCommand(r5, r6, r7)     // Catch:{ BadParcelableException -> 0x00c3 }
                L_0x00c3:
                    return
                */
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i2) {
                postToHandler(26, (Object) mediaDescriptionCompat, i2);
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    if (i2 == 2) {
                        ...
                        i5 = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(i3);
                        i4 = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i3);
                        i6 = 2;
                    }
                }
                return new ParcelableVolumeInfo(i2, i3, i6, i5, i4);
            }
            ...
            public void postToHandler(int i2) {
                MediaSessionImplBase.this.postToHandler(i2, 0, 0, (Object) null, (Bundle) null);
            }
            ...
            public void postToHandler(int i2, int i3) {
                MediaSessionImplBase.this.postToHandler(i2, i3, 0, (Object) null, (Bundle) null);
            }

            public void postToHandler(int i2, Object obj) {
                MediaSessionImplBase.this.postToHandler(i2, 0, 0, obj, (Bundle) null);
            }

            public void postToHandler(int i2, Object obj, int i3) {
                MediaSessionImplBase.this.postToHandler(i2, i3, 0, obj, (Bundle) null);
            }
