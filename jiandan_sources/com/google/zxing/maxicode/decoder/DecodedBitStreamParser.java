...
public final class DecodedBitStreamParser {
    ...
    public static int getCountry(byte[] bArr) {
        return getInt(bArr, new byte[]{53, 54, 43, 44, 45, 46, ExifInterface.WEBP_VP8L_SIGNATURE, 48, 37, 38});
    }
    ...
    public static java.lang.String getMessage(byte[] r12, int r13, int r14) {
        /*
    ...
    public static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{PublicSuffixDatabase.EXCEPTION_MARKER, 34, 35, 36, Ascii.EM, Ascii.SUB, Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14, Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    public static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, ExifInterface.START_CODE, Ascii.US, 32});
    }

    public static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, ExifInterface.START_CODE, Ascii.US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{PublicSuffixDatabase.EXCEPTION_MARKER, 34, 35, 36, Ascii.EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
