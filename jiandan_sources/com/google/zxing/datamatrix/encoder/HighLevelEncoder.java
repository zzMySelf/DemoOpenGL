...
public final class HighLevelEncoder {
    ...
    public static final char MACRO_05 = 'ì';
    public static final String MACRO_05_HEADER = "[)>\u001e05\u001d";
    public static final char MACRO_06 = 'í';
    ...
    public static char randomize253State(char c, int i2) {
        int i3 = c + ((i2 * 149) % InternetDomainName.MAX_LENGTH) + 1;
        if (i3 > 254) {
            i3 -= 254;
        }
        return (char) i3;
