...
public class FinderPatternFinder {
    ...
    private float crossCheckHorizontal(int i2, int i3, int i4, int i5) {
        ...
        while (i6 >= 0 && !bitMatrix.get(i6, i3) && crossCheckStateCount2[1] <= i4) {
            crossCheckStateCount2[1] = crossCheckStateCount2[1] + 1;
            i6--;
        }
        if (i6 >= 0 && crossCheckStateCount2[1] <= i4) {
            while (i6 >= 0 && bitMatrix.get(i6, i3) && crossCheckStateCount2[0] <= i4) {
                crossCheckStateCount2[0] = crossCheckStateCount2[0] + 1;
                i6--;
            }
            if (crossCheckStateCount2[0] > i4) {
                return Float.NaN;
            }
            int i7 = i2 + 1;
            ...
            while (i7 < width && !bitMatrix.get(i7, i3) && crossCheckStateCount2[3] < i4) {
                crossCheckStateCount2[3] = crossCheckStateCount2[3] + 1;
                i7++;
            }
            if (i7 != width && crossCheckStateCount2[3] < i4) {
                while (i7 < width && bitMatrix.get(i7, i3) && crossCheckStateCount2[4] < i4) {
                    crossCheckStateCount2[4] = crossCheckStateCount2[4] + 1;
                    i7++;
                }
                if (crossCheckStateCount2[4] < i4 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i5) * 5 < i5 && foundPatternCross(crossCheckStateCount2)) {
                    return centerFromEnd(crossCheckStateCount2, i7);
                }
            }
        }
        return Float.NaN;
    ...
    private float crossCheckVertical(int i2, int i3, int i4, int i5) {
        ...
        while (i6 >= 0 && !bitMatrix.get(i3, i6) && crossCheckStateCount2[1] <= i4) {
            crossCheckStateCount2[1] = crossCheckStateCount2[1] + 1;
            i6--;
        }
        if (i6 >= 0 && crossCheckStateCount2[1] <= i4) {
            while (i6 >= 0 && bitMatrix.get(i3, i6) && crossCheckStateCount2[0] <= i4) {
                crossCheckStateCount2[0] = crossCheckStateCount2[0] + 1;
                i6--;
            }
            if (crossCheckStateCount2[0] > i4) {
            ...
            while (i7 < height && !bitMatrix.get(i3, i7) && crossCheckStateCount2[3] < i4) {
                crossCheckStateCount2[3] = crossCheckStateCount2[3] + 1;
                i7++;
            }
            if (i7 != height && crossCheckStateCount2[3] < i4) {
                while (i7 < height && bitMatrix.get(i3, i7) && crossCheckStateCount2[4] < i4) {
                    crossCheckStateCount2[4] = crossCheckStateCount2[4] + 1;
                    i7++;
                }
                if (crossCheckStateCount2[4] < i4 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i5) * 5 < i5 * 2 && foundPatternCross(crossCheckStateCount2)) {
                    return centerFromEnd(crossCheckStateCount2, i7);
                }
            }
        }
