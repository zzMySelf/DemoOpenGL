...
public final class PDF417 {
    ...
    private int[] determineDimensions(int i2, int i3) throws WriterException {
        ...
        float f = 0.0f;
        int[] iArr = null;
        while (i5 <= this.maxCols && (calculateNumberOfRows = calculateNumberOfRows(i2, i3, i5)) >= this.minRows) {
            if (calculateNumberOfRows <= this.maxRows) {
                float f2 = (((float) ((i5 * 17) + 69)) * 0.357f) / (((float) calculateNumberOfRows) * 2.0f);
        ...
        if (iArr == null && calculateNumberOfRows(i2, i3, this.minCols) < (i4 = this.minRows)) {
    ...
    private void encodeLowLevel(CharSequence charSequence, int i2, int i3, int i4, BarcodeMatrix barcodeMatrix2) {
        int i5;
        int i6;
        int i7;
        int i8 = 0;
        for (int i9 = 0; i9 < i3; i9++) {
            ...
            if (this.compact) {
                ...
                encodeChar(CODEWORD_TABLE[i10][i13], 17, barcodeMatrix2.getCurrentRow());
