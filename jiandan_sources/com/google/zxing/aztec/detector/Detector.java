...
public final class Detector {
    ...
    public static final class Point {
        ...
        public String toString() {
            return "<" + this.x + Ascii.CASE_MASK + this.y + Typography.greater;
        }
    }
    ...
    public static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, int i2, int i3) {
        float f = ((float) i3) / (((float) i2) * 2.0f);
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        float f2 = f - ((float) i4);
        float f3 = f + ((float) i4);
        return instance.sampleGrid(bitMatrix, i3, i2, f2, f2, f3, f2, f3, f3, f2, f3, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
