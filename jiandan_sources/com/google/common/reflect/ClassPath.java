...
public final class ClassPath {
    ...
    public static final Predicate<ClassInfo> IS_TOP_LEVEL = new Predicate<ClassInfo>() {
    ...
    public static abstract class Scanner {
        public final Set<File> scannedUris = Sets.newHashSet();
    ...
    public static final class DefaultScanner extends Scanner {
        public final SetMultimap<ClassLoader, String> resources = MultimapBuilder.hashKeys().linkedHashSetValues().build();
