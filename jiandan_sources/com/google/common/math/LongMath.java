...
public final class LongMath {
    ...
    public static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, BindVerifyActivity.z, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    public static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, ScriptIntrinsicBLAS.RsBlas_cher2k, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    @VisibleForTesting
    public static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.SI, Ascii.SI, Ascii.SI, Ascii.SI, 14, 14, 14, 13, 13, 13, 12, 12, 12, 12, 11, 11, 11, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    @GwtIncompatible
    @VisibleForTesting
    public static final long[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000L, 100000000000L, BasicLabelFormatter.TRILLION, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(x.a, j);
    ...
    public static long checkedMultiply(long j, long j2) {
        ...
        MathPreconditions.checkNoOverflow((i2 >= 0) | (j4 != Long.MIN_VALUE), "checkedMultiply", j, j2);
        long j5 = j3 * j4;
        MathPreconditions.checkNoOverflow(i2 == 0 || j5 / j3 == j4, "checkedMultiply", j, j2);
        return j5;
    }

    @GwtIncompatible
    public static long checkedPow(long j, int i2) {
        long j2 = j;
        int i3 = i2;
        ...
        if ((j2 >= -2) && (j2 <= 2)) {
            ...
            if (i4 == -2) {
                ...
                MathPreconditions.checkNoOverflow(z, "checkedPow", j, (long) i3);
            ...
            while (i3 != 0) {
                ...
                int i5 = i3 >> 1;
                if (i5 > 0) {
                    MathPreconditions.checkNoOverflow(-3037000499L <= j5 && j5 <= FLOOR_SQRT_MAX_LONG, "checkedPow", j5, (long) i5);
                    j5 *= j5;
                }
                j4 = j6;
                i3 = i5;
            ...
            for (long[] jArr : millerRabinBaseSets) {
                if (j <= jArr[0]) {
                    for (int i3 = 1; i3 < jArr.length; i3++) {
                        if (!MillerRabinTester.test(jArr[i3], j)) {
                            return false;
                        }
                    }
                    return true;
    ...
    @GwtIncompatible
    public static int mod(long j, int i2) {
        return (int) mod(j, (long) i2);
    }
    ...
    @Beta
    public static long saturatedPow(long j, int i2) {
        MathPreconditions.checkNonNegative("exponent", i2);
        long j2 = 1;
        if ((j >= -2) && (j <= 2)) {
            int i3 = (int) j;
            ...
            long j3 = ((j >>> 63) & ((long) (i2 & 1))) + Long.MAX_VALUE;
            while (i2 != 0) {
                if (i2 == 1) {
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(x.a, j);
        if (fitsInInt(j)) {
