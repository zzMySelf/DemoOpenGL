...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public Iterator<Multiset.Entry<E>> descendingEntryIterator() {
        return new Iterator<Multiset.Entry<E>>() {
            public AvlNode<E> current = TreeMultiset.this.lastNode();
    ...
    public Iterator<Multiset.Entry<E>> entryIterator() {
        return new Iterator<Multiset.Entry<E>>() {
            public AvlNode<E> current = TreeMultiset.this.firstNode();
            @NullableDecl
    ...
    public static final class AvlNode<E> {
        ...
        public AvlNode(@NullableDecl E e, int i2) {
        ...
        private AvlNode<E> addLeftChild(E e, int i2) {
        ...
        private AvlNode<E> addRightChild(E e, int i2) {
            AvlNode<E> avlNode = new AvlNode<>(e, i2);
            this.right = avlNode;
        ...
        private AvlNode<E> deleteMe() {
            ...
            if (avlNode.height >= avlNode2.height) {
                ...
                avlNode3.totalCount = this.totalCount - ((long) i2);
            ...
            avlNode4.totalCount = this.totalCount - ((long) i2);
        ...
        public AvlNode<E> add(Comparator<? super E> comparator, @NullableDecl E e, int i2, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            boolean z = true;
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                ...
                this.left = avlNode.add(comparator, e, i2, iArr);
                if (iArr[0] == 0) {
                    this.distinctElements++;
                }
                this.totalCount += (long) i2;
                return this.left.height == i3 ? this : rebalance();
            } else if (compare > 0) {
                AvlNode<E> avlNode2 = this.right;
                if (avlNode2 == null) {
                    iArr[0] = 0;
                ...
                this.right = avlNode2.add(comparator, e, i2, iArr);
                if (iArr[0] == 0) {
                    this.distinctElements++;
                }
                this.totalCount += (long) i2;
        ...
        public AvlNode<E> remove(Comparator<? super E> comparator, @NullableDecl E e, int i2, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        public AvlNode<E> setCount(Comparator<? super E> comparator, @NullableDecl E e, int i2, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        public AvlNode<E> setCount(Comparator<? super E> comparator, @NullableDecl E e, int i2, int i3, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
