...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
    ...
    public Iterator<Multiset.Entry<E>> entryIterator() {
        final AnonymousClass2 r0 = new AbstractIterator<Multiset.Entry<E>>() {
            public final Iterator<Map.Entry<E, AtomicInteger>> mapEntries = ConcurrentHashMultiset.this.countMap.entrySet().iterator();
    ...
    public boolean setCount(E e, int i2, int i3) {
        ...
        if (atomicInteger != null) {
            ...
            if (i3 == 0 || this.countMap.putIfAbsent(e, new AtomicInteger(i3)) == null) {
                return true;
            }
            return false;
        }
