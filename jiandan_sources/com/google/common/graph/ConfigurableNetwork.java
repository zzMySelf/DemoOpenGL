...
public class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    public final NetworkConnections<N, E> checkedConnections(N n) {
        ...
        throw new IllegalArgumentException(String.format(GraphConstants.NODE_NOT_IN_GRAPH, new Object[]{n}));
    }
    ...
    public final N checkedReferenceNode(E e) {
        ...
        throw new IllegalArgumentException(String.format(GraphConstants.EDGE_NOT_IN_GRAPH, new Object[]{e}));
    }
    ...
    public Set<E> edgesConnecting(N n, N n2) {
        ...
        Preconditions.checkArgument(containsNode(n2), GraphConstants.NODE_NOT_IN_GRAPH, (Object) n2);
