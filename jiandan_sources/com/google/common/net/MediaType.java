...
public final class MediaType {
    ...
    public static final MediaType APPLICATION_XML_UTF_8 = createConstantUtf8(APPLICATION_TYPE, ResUtils.j);
    ...
    public static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(Ascii.CASE_MASK)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));
    public static final MediaType TSV_UTF_8 = createConstantUtf8("text", "tab-separated-values");
    public static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    public static final MediaType XML_UTF_8 = createConstantUtf8("text", ResUtils.j);
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                tokenizer.consumeCharacter((char) a.h);
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException("Multiple charset values defined: " + str + StringUtil.ARRAY_ELEMENT_SEPARATOR + str2);
                }
            }
