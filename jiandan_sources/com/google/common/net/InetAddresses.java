...
public final class InetAddresses {
    ...
    public static final Splitter IPV4_SPLITTER = Splitter.on('.').limit(4);
    public static final int IPV6_PART_COUNT = 8;
    public static final Splitter IPV6_SPLITTER = Splitter.on(':').limit(10);
    ...
    public static short parseHextet(String str) {
    ...
    public static byte parseOctet(String str) {
    ...
    public static byte[] textToNumericFormatV6(String str) {
        ...
        while (i7 < i2) {
            try {
                allocate.putShort(parseHextet(splitToList.get(i7)));
                i7++;
            } catch (NumberFormatException unused) {
                return null;
            }
