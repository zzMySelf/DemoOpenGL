...
public abstract class AbstractService implements Service {
    public static final ListenerCallQueue.Event<Service.Listener> RUNNING_EVENT = new ListenerCallQueue.Event<Service.Listener>() {
    ...
    public static final ListenerCallQueue.Event<Service.Listener> STARTING_EVENT = new ListenerCallQueue.Event<Service.Listener>() {
        public String toString() {
            return "starting()";
        }
    ...
    public static final class StateSnapshot {
        ...
        public StateSnapshot(Service.State state2, boolean z, @NullableDecl Throwable th2) {
            boolean z2 = false;
            ...
            Preconditions.checkArgument(!((state2 == Service.State.FAILED ? true : z2) ^ (th2 != null)), "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", (Object) state2, (Object) th2);
            this.state = state2;
