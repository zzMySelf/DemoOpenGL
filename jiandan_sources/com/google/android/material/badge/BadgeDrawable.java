...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    public BadgeDrawable(@NonNull Context context) {
        ...
        setTextAppearanceResource(2131952091);
    }
    ...
    public static BadgeDrawable create(@NonNull Context context) {
        return createFromAttributes(context, (AttributeSet) null, badgeStyle, Widget_MaterialComponents_Badge);
    }
    ...
    public static BadgeDrawable createFromResource(@NonNull Context context, @XmlRes int i2) {
        ...
        return createFromAttributes(context, parseDrawableXml, badgeStyle, styleAttribute);
    }
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(@NonNull Context context) {
            this.badgeTextColor = new TextAppearance(context, 2131952091).textColor.getDefaultColor();
