    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i2, int i3) {
                int i4;
                if (i2 < 0) {
                    i4 = MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition();
                } else {
                    i4 = MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                }
                Month unused = MaterialCalendar.this.current = monthsPagerAdapter.getPageMonth(i4);
                materialButton.setText(monthsPagerAdapter.getPageTitle(i4));
            }
        });
                        ...
                        if (!(f == null || next.second == null)) {
                            ...
                            while (i3 <= spanCount2) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect((float) left, (float) top, (float) i2, (float) bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                                i3++;
                            }
                        }
