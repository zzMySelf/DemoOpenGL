...
public class MotionSpec {
    ...
    public static MotionSpec createFromResource(@NonNull Context context, @AnimatorRes int i2) {
        try {
            ...
            "Can't load animation resource ID #0x" + Integer.toHexString(i2);
            return null;
        }
    }
    ...
    public String toString() {
        return 10 + MotionSpec.class.getName() + ExtendedMessageFormat.START_FE + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.timings + "}\n";
    }
}
