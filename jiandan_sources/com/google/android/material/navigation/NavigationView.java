...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R$styleable.NavigationView, i2, Widget_Design_NavigationView, new int[0]);
        ...
        if (getBackground() == null || (getBackground() instanceof ColorDrawable)) {
            ShapeAppearanceModel build = ShapeAppearanceModel.builder(context2, attributeSet, i2, Widget_Design_NavigationView).build();
