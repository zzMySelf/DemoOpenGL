...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.MaterialRadioButton, i2, Widget_MaterialComponents_CompoundButton_RadioButton, new int[0]);
