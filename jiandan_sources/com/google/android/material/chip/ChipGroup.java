...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.checkedId = -1;
        this.protectFromCheckedChange = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R$styleable.ChipGroup, i2, Widget_MaterialComponents_ChipGroup, new int[0]);
