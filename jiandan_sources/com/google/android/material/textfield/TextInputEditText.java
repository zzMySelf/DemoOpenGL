...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        if (!TextUtils.isEmpty(charSequence)) {
            str = StringUtil.ARRAY_ELEMENT_SEPARATOR + charSequence;
        }
        sb.append(str);
        return sb.toString();
    }
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R$styleable.TextInputEditText, i2, 2131952345, new int[0]);
