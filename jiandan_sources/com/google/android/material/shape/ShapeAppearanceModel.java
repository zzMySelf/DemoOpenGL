...
public class ShapeAppearanceModel {
    ...
    public static Builder builder(Context context, @StyleRes int i2, @StyleRes int i3, @NonNull CornerSize cornerSize) {
        ...
        try {
            ...
            return new Builder().setTopLeftCorner(i5, cornerSize3).setTopRightCorner(i6, cornerSize4).setBottomRightCorner(i7, cornerSize5).setBottomLeftCorner(i8, getCornerSize(obtainStyledAttributes, 6, cornerSize2));
        } finally {
            obtainStyledAttributes.recycle();
        }
    }
