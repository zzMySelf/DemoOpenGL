...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    public static final int DEF_STYLE_ATTR = 2130968652;
    @StyleRes
    ...
    /* renamed from: MATERIAL_ALERT_DIALOG_THEME_OVERLAY */
    ...
    public static Context createMaterialAlertDialogThemedContext(@NonNull Context context) {
        ...
        Context wrap = MaterialThemeOverlay.wrap(context, (AttributeSet) null, DEF_STYLE_ATTR, MaterialAlertDialog_MaterialComponents);
    ...
    public static int getMaterialAlertDialogThemeOverlay(@NonNull Context context) {
        TypedValue resolve = MaterialAttributes.resolve(context, materialAlertDialogTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i2) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context2, (AttributeSet) null, DEF_STYLE_ATTR, MaterialAlertDialog_MaterialComponents);
