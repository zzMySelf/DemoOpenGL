...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public LinearLayout textInputView;
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, R.attr.materialTimePickerStyle, 2131952449);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, R$styleable.MaterialTimePicker, R.attr.materialTimePickerStyle, 2131952449);
