...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R$styleable.MaterialCardView, i2, Widget_MaterialComponents_CardView, new int[0]);
