...
public class CollapsingToolbarLayout extends FrameLayout {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (i4 == 1) {
                    ...
                    viewOffsetHelper.setTopAndBottomOffset(Math.round(((float) (-i2)) * layoutParams.parallaxMult));
                }
            }
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        int i6 = this.tmpRect.left + (z ? i3 : i5);
        ...
        collapsingTextHelper2.setCollapsedBounds(i6, i7, i8 - i5, (this.tmpRect.bottom + maxOffsetForPinChild) - i4);
    }
    ...
    public CollapsingToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.CollapsingToolbarLayout, i2, Widget_Design_CollapsingToolbar, new int[0]);
        ...
        this.collapsingTextHelper.setExpandedTextAppearance(2131952080);
        this.collapsingTextHelper.setCollapsedTextAppearance(2131952054);
