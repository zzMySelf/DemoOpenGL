...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
        ...
        private int interpolateOffset(@NonNull T t, int i2) {
            ...
            while (true) {
                ...
                if (abs < childAt.getTop() || abs > childAt.getBottom()) {
                    ...
                    if (i3 > 0) {
                        float f = (float) i3;
                        return Integer.signum(i2) * (childAt.getTop() + Math.round(f * scrollInterpolator.getInterpolation(((float) (abs - childAt.getTop())) / f)));
                    }
                }
            }
            return i2;
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        iArr[0] = this.liftable ? R.attr.state_liftable : -2130969800;
        iArr[1] = (!this.liftable || !this.lifted) ? -2130969801 : R.attr.state_lifted;
        iArr[2] = this.liftable ? R.attr.state_collapsible : -2130969798;
        iArr[3] = (!this.liftable || !this.lifted) ? -2130969797 : R.attr.state_collapsed;
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.AppBarLayout, i2, Widget_Design_AppBarLayout, new int[0]);
