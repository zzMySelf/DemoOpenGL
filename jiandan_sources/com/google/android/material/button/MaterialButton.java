...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (Build.VERSION.SDK_INT == 21 && (materialButtonHelper2 = this.materialButtonHelper) != null) {
            materialButtonHelper2.updateMaskBounds(i5 - i3, i4 - i2);
        }
    }
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.MaterialButton, i2, Widget_MaterialComponents_Button, new int[0]);
        ...
        MaterialButtonHelper materialButtonHelper2 = new MaterialButtonHelper(this, ShapeAppearanceModel.builder(context2, attributeSet, i2, Widget_MaterialComponents_Button).build());
