...
public class TabLayout extends HorizontalScrollView {
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (badgeDrawable2 != null && badgeDrawable2.isVisible()) {
                ...
                accessibilityNodeInfo.setContentDescription(contentDescription + StringUtil.ARRAY_ELEMENT_SEPARATOR + this.badgeDrawable.getContentDescription());
            }
    ...
    private void applyModeAndGravity() {
        ...
        ViewCompat.setPaddingRelative(this.slidingTabIndicator, i2, 0, 0, 0);
        int i4 = this.mode;
        if (i4 == 0) {
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.TabLayout, i2, Widget_Design_TabLayout, 23);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(23, 2131952090);
