...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    /* renamed from: DEFAULT_THEME_ATTR */
    ...
    public final float tooltipPivotX = 0.5f;
    public float tooltipPivotY = 0.5f;
    public float tooltipScaleX = 1.0f;
    public float tooltipScaleY = 1.0f;

    public TooltipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
    ...
    public static TooltipDrawable create(@NonNull Context context2) {
        return createFromAttributes(context2, (AttributeSet) null, tooltipStyle, Widget_MaterialComponents_Tooltip);
    }
    ...
    public static TooltipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet) {
        return createFromAttributes(context2, attributeSet, tooltipStyle, Widget_MaterialComponents_Tooltip);
    }
}
