...
public class SwitchMaterial extends SwitchCompat {
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R$styleable.SwitchMaterial, i2, Widget_MaterialComponents_CompoundButton_Switch, new int[0]);
