...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            fabTransformationSpec.timings.getTiming(ResUtils.f).apply(objectAnimator);
            list.add(objectAnimator);
        }
    }
    ...
    private void createPostFillRadialExpansion(View view, long j, long j2, long j3, int i2, int i3, float f, @NonNull List<Animator> list) {
    ...
    private void createPreFillRadialExpansion(View view, long j, int i2, int i3, float f, @NonNull List<Animator> list) {
