...
public class Logger {
    ...
    @KeepForSdk
    public void wtf(String str, Throwable th2, @Nullable Object... objArr) {
        Log.wtf(this.mTag, format(str, objArr), th2);
    }

    @KeepForSdk
    public void e(String str, Throwable th2, @Nullable Object... objArr) {
        format(str, objArr);
    }

    @KeepForSdk
    public void wtf(Throwable th2) {
        Log.wtf(this.mTag, th2);
    }

    @KeepForSdk
    public void d(String str, Throwable th2, @Nullable Object... objArr) {
        if (isLoggable(3)) {
            format(str, objArr);
        }
    }
    ...
    @KeepForSdk
    public void v(String str, Throwable th2, @Nullable Object... objArr) {
        if (isLoggable(2)) {
            format(str, objArr);
        }
    }
