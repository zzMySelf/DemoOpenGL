...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(EnterDxmPayServiceAction.SERVICE_STATUS_CODE, zza(this.zzr)).add("resolution", this.zzs).add("message", this.zzt).toString();
    }
    ...
    public ConnectionResult(int i2, @Nullable PendingIntent pendingIntent, String str) {
