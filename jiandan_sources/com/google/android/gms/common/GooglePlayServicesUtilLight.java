    ...
    public static int isGooglePlayServicesAvailable(Context context, int i2) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzaz.get()) {
            ...
            if (zzd == 0) {
                ...
                StringBuilder sb = new StringBuilder(MediaSessionCompat.MAX_BITMAP_SIZE_IN_DP);
        ...
        return zza(context, !DeviceProperties.isWearableWithoutPlayStore(context) && !DeviceProperties.zzg(context), i2);
    }
}
