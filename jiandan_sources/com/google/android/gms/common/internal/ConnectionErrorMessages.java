...
public final class ConnectionErrorMessages {
    public static final SimpleArrayMap<String, String> zaor = new SimpleArrayMap<>();
    ...
    public static String getErrorNotificationMessage(Context context, int i2) {
        ...
        return getErrorMessage(context, i2);
    }
    ...
    public static java.lang.String zaa(android.content.Context r4, java.lang.String r5) {
        /*
            androidx.collection.SimpleArrayMap<java.lang.String, java.lang.String> r0 = zaor
            monitor-enter(r0)
            androidx.collection.SimpleArrayMap<java.lang.String, java.lang.String> r1 = zaor     // Catch:{ all -> 0x0061 }
