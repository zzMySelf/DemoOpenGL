...
public final class Int64Value extends GeneratedMessageV3 implements Int64ValueOrBuilder {
    ...
    public Int64Value(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = -1;
    }
    ...
    public Int64Value(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        this();
