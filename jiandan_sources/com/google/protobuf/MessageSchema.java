...
public final class MessageSchema<T> implements Schema<T> {
    ...
    public MessageSchema(int[] iArr, Object[] objArr, int i2, int i3, MessageLite messageLite, boolean z, boolean z2, int[] iArr2, int i4, int i5, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        this.buffer = iArr;
        this.objects = objArr;
    ...
    private final <UT, UB> UB filterMapUnknownEnumValues(Object obj, int i2, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema2) {
        ...
        return filterUnknownEnumMap(i2, numberAt, this.mapFieldSchema.forMutableMapData(object), enumFieldVerifier, ub, unknownFieldSchema2);
    }

    private final <K, V, UT, UB> UB filterUnknownEnumMap(int i2, int i3, Map<K, V> map, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema2) {
    ...
    public static boolean isEnforceUtf8(int i2) {
        return (i2 & 536870912) != 0;
    }

    private boolean isFieldPresent(T t, int i2, int i3, int i4) {
        if (this.proto3) {
            return isFieldPresent(t, i2);
        }
        return (i3 & i4) != 0;
    }
    ...
    private boolean isMapInitialized(T t, int i2, int i3) {
        Map<?, ?> forMapData = this.mapFieldSchema.forMapData(UnsafeUtil.getObject((Object) t, offset(i2)));
    ...
    private boolean isOneofCaseEqual(T t, T t2, int i2) {
        long presenceMaskAndOffsetAt = (long) (presenceMaskAndOffsetAt(i2) & OFFSET_MASK);
    ...
    private boolean isOneofPresent(T t, int i2, int i3) {
        return UnsafeUtil.getInt((Object) t, (long) (presenceMaskAndOffsetAt(i3) & OFFSET_MASK)) == i2;
    }

    public static boolean isRequired(int i2) {
    ...
    public static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        while (i7 < fields.length) {
            ...
            storeFieldData(fieldInfo2, iArr, i8, z, objArr);
            ...
            if (fieldInfo2.getType() == FieldType.MAP) {
                ...
                i4 = i8;
                iArr2[i11] = (int) UnsafeUtil.objectFieldOffset(fieldInfo2.getField());
                i11++;
                i7++;
                i8 = i4 + 3;
            }
        ...
        return new MessageSchema(iArr, objArr, i3, i2, structuralMessageInfo.getDefaultInstance(), z, true, iArr4, checkInitialized.length, checkInitialized.length + iArr3.length, newInstanceSchema2, listFieldSchema2, unknownFieldSchema2, extensionSchema2, mapFieldSchema2);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T> com.google.protobuf.MessageSchema<T> newSchemaForRawMessageInfo(com.google.protobuf.RawMessageInfo r36, com.google.protobuf.NewInstanceSchema r37, com.google.protobuf.ListFieldSchema r38, com.google.protobuf.UnknownFieldSchema<?, ?> r39, com.google.protobuf.ExtensionSchema<?> r40, com.google.protobuf.MapFieldSchema r41) {
        /*
    ...
    private int parseOneofField(T t, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, int i9, ArrayDecoders.Registers registers) throws IOException {
        ...
        Unsafe unsafe = UNSAFE;
        long j3 = (long) (this.buffer[i14 + 2] & OFFSET_MASK);
        switch (i8) {
            case 51:
                if (i13 == 1) {
            ...
            case 59:
                if (i13 == 2) {
                    ...
                    } else if ((i7 & 536870912) == 0 || Utf8.isValidUtf8(bArr2, decodeVarint322, decodeVarint322 + i19)) {
                        unsafe.putObject(t2, j2, new String(bArr2, decodeVarint322, i19, Internal.UTF_8));
                        decodeVarint322 += i19;
                    } else {
            ...
            case 60:
                if (i13 == 2) {
                    int decodeMessageField = ArrayDecoders.decodeMessageField(getMessageFieldSchema(i14), bArr2, i10, i3, registers2);
            ...
            case 63:
                if (i13 == 0) {
                    ...
                    if (enumFieldVerifier == null || enumFieldVerifier.isInRange(i20)) {
                        unsafe.putObject(t2, j2, Integer.valueOf(i20));
                        unsafe.putInt(t2, j3, i12);
                    } else {
                        getMutableUnknownFields(t).storeField(i11, Long.valueOf((long) i20));
                    }
            ...
            case 68:
                if (i13 == 3) {
                    int decodeGroupField = ArrayDecoders.decodeGroupField(getMessageFieldSchema(i14), bArr, i2, i3, (i11 & -8) | 4, registers);
    ...
    private int parseProto3Message(T r28, byte[] r29, int r30, int r31, com.google.protobuf.ArrayDecoders.Registers r32) throws java.io.IOException {
        ...
        L_0x00f2:
            r0 = 0
        L_0x00f3:
            com.google.protobuf.UnsafeUtil.putBoolean((java.lang.Object) r14, (long) r2, (boolean) r0)
            r0 = r1
            goto L_0x0105
        L_0x00f8:
            r2 = r1
        ...
        L_0x0139:
            ...
            com.google.protobuf.UnsafeUtil.putFloat((java.lang.Object) r14, (long) r2, (float) r0)
            int r0 = r8 + 4
            goto L_0x0155
        L_0x0148:
            r2 = r1
            ...
            com.google.protobuf.UnsafeUtil.putDouble((java.lang.Object) r14, (long) r2, (double) r0)
        L_0x0153:
            int r0 = r8 + 8
        L_0x0155:
            r1 = r7
    ...
    private int parseRepeatedField(T t, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, long j, int i8, long j2, ArrayDecoders.Registers registers) throws IOException {
        ...
        switch (i8) {
            ...
            case 35:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedDoubleList(bArr, i2, protobufList, registers2);
                }
                if (i11 == 1) {
            ...
            case 36:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFloatList(bArr, i2, protobufList, registers2);
                }
                if (i11 == 5) {
            ...
            case 38:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedVarint64List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 43:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedVarint32List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 46:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFixed64List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 1) {
            ...
            case 45:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedFixed32List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 5) {
            ...
            case 42:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedBoolList(bArr, i2, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 44:
                if (i11 == 2) {
                    i9 = ArrayDecoders.decodePackedVarint32List(bArr, i2, protobufList, registers2);
                } else if (i11 == 0) {
                ...
                UnknownFieldSetLite unknownFieldSetLite2 = (UnknownFieldSetLite) SchemaUtil.filterUnknownEnumList(i5, (List<Integer>) protobufList, getEnumFieldVerifier(i12), unknownFieldSetLite, this.unknownFieldSchema);
            ...
            case 47:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedSInt32List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 0) {
            ...
            case 48:
                if (i11 == 2) {
                    return ArrayDecoders.decodePackedSInt64List(bArr, i2, protobufList, registers2);
                }
                if (i11 == 0) {
    ...
    private void setOneofPresent(T t, int i2, int i3) {
        UnsafeUtil.putInt((Object) t, (long) (presenceMaskAndOffsetAt(i3) & OFFSET_MASK), i2);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void storeFieldData(com.google.protobuf.FieldInfo r8, int[] r9, int r10, boolean r11, java.lang.Object[] r12) {
        /*
    ...
    public final boolean isInitialized(T t) {
        ...
        for (int i5 = 0; i5 < this.checkInitializedCount; i5++) {
            ...
            if (isRequired(typeAndOffsetAt) && !isFieldPresent(t, i6, i4, i2)) {
                return false;
            }
            ...
            } else if (isFieldPresent(t, i6, i4, i2) && !isInitialized(t, typeAndOffsetAt, getMessageFieldSchema(i6))) {
                return false;
            }
        }
    ...
    public int parseProto2Message(T r30, byte[] r31, int r32, int r33, int r34, com.google.protobuf.ArrayDecoders.Registers r35) throws java.io.IOException {
        ...
        L_0x0117:
            ...
            goto L_0x0143
        L_0x0135:
            com.google.protobuf.UnknownFieldSetLite r2 = getMutableUnknownFields(r30)
            long r3 = (long) r1
        ...
        L_0x01de:
            r1 = 0
        L_0x01df:
            com.google.protobuf.UnsafeUtil.putBoolean((java.lang.Object) r14, (long) r2, (boolean) r1)
            goto L_0x01fb
        L_0x01e3:
            r8 = r17
            r13 = r18
    ...
    public void mergeFrom(T t, byte[] bArr, int i2, int i3, ArrayDecoders.Registers registers) throws IOException {
        if (this.proto3) {
            parseProto3Message(t, bArr, i2, i3, registers);
        } else {
            parseProto2Message(t, bArr, i2, i3, 0, registers);
        }
    }
    ...
    private boolean equals(T t, T t2, int i2) {
        ...
        switch (type(typeAndOffsetAt)) {
            case 0:
                if (!arePresentForEquals(t, t2, i2) || Double.doubleToLongBits(UnsafeUtil.getDouble((Object) t, offset)) != Double.doubleToLongBits(UnsafeUtil.getDouble((Object) t2, offset))) {
                    return false;
                }
                return true;
            case 1:
                if (!arePresentForEquals(t, t2, i2) || Float.floatToIntBits(UnsafeUtil.getFloat((Object) t, offset)) != Float.floatToIntBits(UnsafeUtil.getFloat((Object) t2, offset))) {
                    return false;
                }
                return true;
            case 2:
                if (!arePresentForEquals(t, t2, i2) || UnsafeUtil.getLong((Object) t, offset) != UnsafeUtil.getLong((Object) t2, offset)) {
                    return false;
                }
                return true;
            case 3:
                ...
                return true;
            case 4:
                if (!arePresentForEquals(t, t2, i2) || UnsafeUtil.getInt((Object) t, offset) != UnsafeUtil.getInt((Object) t2, offset)) {
                    return false;
                }
                return true;
            case 5:
            ...
            case 6:
                ...
                return true;
            case 7:
                if (!arePresentForEquals(t, t2, i2) || UnsafeUtil.getBoolean((Object) t, offset) != UnsafeUtil.getBoolean((Object) t2, offset)) {
                    return false;
                }
                return true;
            case 8:
                if (!arePresentForEquals(t, t2, i2) || !SchemaUtil.safeEquals(UnsafeUtil.getObject((Object) t, offset), UnsafeUtil.getObject((Object) t2, offset))) {
                    return false;
                }
                return true;
            case 9:
            ...
            case 67:
            case 68:
                if (!isOneofCaseEqual(t, t2, i2) || !SchemaUtil.safeEquals(UnsafeUtil.getObject((Object) t, offset), UnsafeUtil.getObject((Object) t2, offset))) {
                    return false;
                }
                return true;
            default:
    ...
    public static boolean isInitialized(Object obj, int i2, Schema schema) {
