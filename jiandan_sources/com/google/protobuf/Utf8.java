...
public final class Utf8 {
    ...
    public static final Processor processor = ((!UnsafeProcessor.isAvailable() || Android.isOnAndroidDevice()) ? new SafeProcessor() : new UnsafeProcessor());

    public static class DecodeUtil {
        public static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i2) throws InvalidProtocolBufferException {
        ...
        public static void handleThreeBytes(byte b, byte b2, byte b3, char[] cArr, int i2) throws InvalidProtocolBufferException {
            if (isNotTrailingByte(b2) || ((b == -32 && b2 < -96) || ((b == -19 && b2 >= -96) || isNotTrailingByte(b3)))) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
            cArr[i2] = (char) (((b & Ascii.SI) << 12) | (trailingByteValue(b2) << 6) | trailingByteValue(b3));
        }

        public static void handleTwoBytes(byte b, byte b2, char[] cArr, int i2) throws InvalidProtocolBufferException {
            if (b < -62 || isNotTrailingByte(b2)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
            cArr[i2] = (char) (((b & Ascii.US) << 6) | trailingByteValue(b2));
        }
    ...
    public static abstract class Processor {
            ...
            if ((i2 | i3 | ((byteBuffer.limit() - i2) - i3)) >= 0) {
                ...
                while (r13 < i4) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        if (i7 < i4 - 1) {
                            int i9 = i7 + 1;
                            DecodeUtil.handleThreeBytes(b2, byteBuffer.get(i7), byteBuffer.get(i9), cArr, i6);
                            r13 = i9 + 1;
                            i6++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        ...
                        int i11 = i10 + 1;
                        DecodeUtil.handleFourBytes(b2, b4, byteBuffer.get(i10), byteBuffer.get(i11), cArr, i6);
                        r13 = i11 + 1;
                        i6 = i6 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    if (i4 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                int i5 = position + 1;
                                try {
                                    byteBuffer.put(position, (byte) ((codePoint >>> 18) | AuthorityState.STATE_ERROR_NETWORK));
                                    position = i5 + 1;
        ...
        public static int partialIsValidUtf8(ByteBuffer byteBuffer, int i2, int i3) {
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public static int unsafeEstimateConsecutiveAscii(byte[] bArr, long j, int i2) {
            int i3 = 0;
            if (i2 < 16) {
                return 0;
            }
        ...
        public static int unsafeIncompleteStateFor(byte[] bArr, int i2, long j, int i3) {
            if (i3 == 0) {
            ...
            if (i3 == 2) {
                return Utf8.incompleteStateFor(i2, (int) UnsafeUtil.getByte(bArr, j), (int) UnsafeUtil.getByte(bArr, j + 1));
            }
                ...
                while (r13 < i4) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        if (i7 < i4 - 1) {
                            int i10 = i7 + 1;
                            int i11 = i10 + 1;
                            DecodeUtil.handleThreeBytes(b2, UnsafeUtil.getByte(bArr, (long) i7), UnsafeUtil.getByte(bArr, (long) i10), cArr, i6);
                            r13 = i11;
                            i6++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        ...
                        int i13 = i12 + 1;
                        DecodeUtil.handleFourBytes(b2, b4, UnsafeUtil.getByte(bArr, (long) i12), UnsafeUtil.getByte(bArr, (long) i13), cArr, i6);
                        r13 = i13 + 1;
                        i6 = i6 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                ...
                while (true) {
                    ...
                    while (j < j2) {
                        ...
                        if (DecodeUtil.isOneByte(b2)) {
                            ...
                            if (j3 < j2 - 1) {
                                long j4 = j3 + 1;
                                DecodeUtil.handleThreeBytes(b2, UnsafeUtil.getByte(j3), UnsafeUtil.getByte(j4), cArr, i7);
                                i7++;
                                j = j4 + 1;
                            } else {
                                throw InvalidProtocolBufferException.invalidUtf8();
                            ...
                            addressOffset = j6 + 1;
                            DecodeUtil.handleFourBytes(b2, b4, b5, UnsafeUtil.getByte(j6), cArr, i7);
                            i6 = i7 + 1 + 1;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        }
        ...
        public static int unsafeEstimateConsecutiveAscii(long j, int i2) {
            if (i2 < 16) {
                return 0;
            }
            int i3 = 8 - (((int) j) & 7);
        ...
        public static int unsafeIncompleteStateFor(long j, int i2, int i3) {
            if (i3 == 0) {
                return Utf8.incompleteStateFor(i2);
            }
            if (i3 == 1) {
            ...
            if (i3 == 2) {
                return Utf8.incompleteStateFor(i2, (int) UnsafeUtil.getByte(j), (int) UnsafeUtil.getByte(j + 1));
            }
            throw new AssertionError();
        }
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static int partialIsValidUtf8(byte[] r8, long r9, int r11) {
            /*
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static int partialIsValidUtf8(long r8, int r10) {
            /*
    ...
    public static int incompleteStateFor(byte[] bArr, int i2, int i3) {
        ...
        if (i4 == 2) {
            return incompleteStateFor((int) b, (int) bArr[i2], (int) bArr[i2 + 1]);
        }
        throw new AssertionError();
    }
            ...
            if ((i2 | i3 | ((bArr.length - i2) - i3)) >= 0) {
                ...
                while (r13 < i4) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        if (i7 < i4 - 1) {
                            int i9 = i7 + 1;
                            DecodeUtil.handleThreeBytes(b2, bArr[i7], bArr[i9], cArr, i6);
                            r13 = i9 + 1;
                            i6++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        ...
                        byte b4 = bArr[i7];
                        int i11 = i10 + 1;
                        DecodeUtil.handleFourBytes(b2, b4, bArr[i10], bArr[i11], cArr, i6);
                        r13 = i11 + 1;
                        i6 = i6 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                ...
                if (charAt2 < 128 && i9 < i7) {
                    ...
                    if (i13 != charSequence.length()) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            int codePoint = Character.toCodePoint(charAt2, charAt3);
                            int i14 = i9 + 1;
                            bArr[i9] = (byte) ((codePoint >>> 18) | AuthorityState.STATE_ERROR_NETWORK);
                            int i15 = i14 + 1;
