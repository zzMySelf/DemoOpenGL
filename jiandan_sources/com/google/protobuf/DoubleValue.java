...
public final class DoubleValue extends GeneratedMessageV3 implements DoubleValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        if (d != 0.0d) {
            i3 = 0 + CodedOutputStream.computeDoubleSize(1, d);
        }
    ...
    public DoubleValue(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = -1;
    }
    ...
    public DoubleValue(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        this();
