...
public class WebMessagePort {
    ...
    public void close(final ValueCallback<Void> valueCallback) {
        ...
        if (!this.isTransferred) {
            ...
            if (inAppWebViewInterface != null) {
                inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.name + ".close();  }})();", (ContentWorld) null, new ValueCallback<String>() {
    ...
    public void postMessage(WebMessage webMessage, final ValueCallback<Void> valueCallback) {
        ...
        if (inAppWebViewInterface != null) {
            ...
            if (list != null) {
                ...
                for (WebMessagePort next : list) {
                    if (next == this) {
                        ...
                        arrayList.add("window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.id + "']." + next.name);
                    }
                }
                str = "[" + TextUtils.join(StringUtil.ARRAY_ELEMENT_SEPARATOR, arrayList) + "]";
            } else {
                str = str2;
            }
            ...
            inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.name + ".postMessage('" + str2 + "', " + str + ");  }})();", (ContentWorld) null, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
                    valueCallback.onReceiveValue((Object) null);
                }
            });
