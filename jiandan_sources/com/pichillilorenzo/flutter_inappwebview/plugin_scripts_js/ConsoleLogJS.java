...
public class ConsoleLogJS {
    public static final PluginScript CONSOLE_LOG_JS_PLUGIN_SCRIPT = new PluginScript(CONSOLE_LOG_JS_PLUGIN_SCRIPT_GROUP_NAME, CONSOLE_LOG_JS_SOURCE, UserScriptInjectionTime.AT_DOCUMENT_START, (ContentWorld) null, true);
