...
public class OnLoadResourceJS {
    ...
    public static final PluginScript ON_LOAD_RESOURCE_JS_PLUGIN_SCRIPT = new PluginScript(ON_LOAD_RESOURCE_JS_PLUGIN_SCRIPT_GROUP_NAME, ON_LOAD_RESOURCE_JS_SOURCE, UserScriptInjectionTime.AT_DOCUMENT_START, (ContentWorld) null, false);
