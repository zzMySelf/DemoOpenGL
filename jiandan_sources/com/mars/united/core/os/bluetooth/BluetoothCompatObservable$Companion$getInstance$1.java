...
public final class BluetoothCompatObservable$Companion$getInstance$1 extends Lambda implements Function1<BluetoothInfo, String> {
    public static final BluetoothCompatObservable$Companion$getInstance$1 INSTANCE = new BluetoothCompatObservable$Companion$getInstance$1();

    public BluetoothCompatObservable$Companion$getInstance$1() {
        super(1);
    }
