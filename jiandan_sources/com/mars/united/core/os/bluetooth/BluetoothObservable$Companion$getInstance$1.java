...
public final class BluetoothObservable$Companion$getInstance$1 extends Lambda implements Function1<BluetoothInfo, String> {
    public static final BluetoothObservable$Companion$getInstance$1 INSTANCE = new BluetoothObservable$Companion$getInstance$1();

    public BluetoothObservable$Companion$getInstance$1() {
        super(1);
    }
