...
public final class _DataListKt$map$1$contains$1 extends Lambda implements Function2<Integer, T, U> {
    public final /* synthetic */ Function1<T, U> $transform;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public _DataListKt$map$1$contains$1(Function1<? super T, ? extends U> function1) {
        super(2);
