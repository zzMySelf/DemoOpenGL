...
public final class ScreenDirectionDetector$magneticFieldHandleEvent$1 extends Lambda implements Function1<SensorEvent, Unit> {
    public final /* synthetic */ ScreenDirectionDetector this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ScreenDirectionDetector$magneticFieldHandleEvent$1(ScreenDirectionDetector screenDirectionDetector) {
        super(1);
    ...
    public final void invoke(@NotNull SensorEvent sensorEvent) {
        ...
        System.arraycopy(sensorEvent.values, 0, this.this$0.f6636i, 0, this.this$0.f6636i.length);
        this.this$0.ad();
    }
}
