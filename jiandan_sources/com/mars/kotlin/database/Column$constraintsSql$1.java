...
public final class Column$constraintsSql$1 extends Lambda implements Function1<Constraint, CharSequence> {
    public static final Column$constraintsSql$1 INSTANCE = new Column$constraintsSql$1();

    public Column$constraintsSql$1() {
        super(1);
    }
