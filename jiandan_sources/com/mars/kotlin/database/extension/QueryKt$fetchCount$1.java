...
public final class QueryKt$fetchCount$1 extends Lambda implements Function1<Cursor, Integer> {
    public static final QueryKt$fetchCount$1 INSTANCE = new QueryKt$fetchCount$1();

    public QueryKt$fetchCount$1() {
        super(1);
    }
