...
public final class UriKt$fetchCount$1 extends Lambda implements Function1<Cursor, Integer> {
    public static final UriKt$fetchCount$1 INSTANCE = new UriKt$fetchCount$1();

    public UriKt$fetchCount$1() {
        super(1);
    }
