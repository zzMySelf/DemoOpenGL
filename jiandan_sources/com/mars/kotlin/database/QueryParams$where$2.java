...
public final class QueryParams$where$2 extends Lambda implements Function1<Column, CharSequence> {
    public static final QueryParams$where$2 INSTANCE = new QueryParams$where$2();

    public QueryParams$where$2() {
        super(1);
    }
