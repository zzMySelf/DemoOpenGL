...
public class UIGridLayout extends GridLayout implements UIHelper<ad<UIGridLayout>> {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public UIGridLayout(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    @JvmOverloads
    public UIGridLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        Intrinsics.checkNotNullParameter(context, "context");
        this._$_findViewCache = new LinkedHashMap();
        ad<UIGridLayout> adVar = new ad<>(context, this);
        this.uiBaseHelper = adVar;
        adVar.pf(context, attributeSet, i2);
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.UIGridLayout, i2, 0);
    ...
    public void refreshDrawableState() {
        ...
        ad<UIGridLayout> adVar = this.uiBaseHelper;
        if (adVar != null) {
            adVar.rrr();
        }
    }
    ...
    @NotNull
    public ad<UIGridLayout> getHelper() {
        return this.uiBaseHelper;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ UIGridLayout(Context context, AttributeSet attributeSet, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
