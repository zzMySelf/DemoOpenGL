...
public final class PdfSplitViewModel$tempDir$2 extends Lambda implements Function0<File> {
    public final /* synthetic */ PdfSplitViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PdfSplitViewModel$tempDir$2(PdfSplitViewModel pdfSplitViewModel) {
        super(0);
