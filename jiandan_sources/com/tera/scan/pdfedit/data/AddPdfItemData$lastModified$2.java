...
public final class AddPdfItemData$lastModified$2 extends Lambda implements Function0<Long> {
    public final /* synthetic */ AddPdfItemData this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddPdfItemData$lastModified$2(AddPdfItemData addPdfItemData) {
        super(0);
    ...
    public final Long invoke() {
        ...
        try {
            ...
            obj = Result.m1155constructorimpl(Long.valueOf(new File(localPath).lastModified()));
        } catch (Throwable th2) {
