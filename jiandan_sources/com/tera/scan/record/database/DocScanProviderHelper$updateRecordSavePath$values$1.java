...
public final class DocScanProviderHelper$updateRecordSavePath$values$1 extends Lambda implements Function1<ContentValuesScope, Unit> {
    public final /* synthetic */ String $savePath;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DocScanProviderHelper$updateRecordSavePath$values$1(String str) {
        super(1);
        this.$savePath = str;
    }
