...
public final class DocScanProviderHelper$updateScanRecordName$values$1 extends Lambda implements Function1<ContentValuesScope, Unit> {
    public final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DocScanProviderHelper$updateScanRecordName$values$1(String str) {
        super(1);
        this.$name = str;
    }
    ...
    public final void invoke(@NotNull ContentValuesScope contentValuesScope) {
        ...
        contentValuesScope.minus("name", this.$name);
    }
}
