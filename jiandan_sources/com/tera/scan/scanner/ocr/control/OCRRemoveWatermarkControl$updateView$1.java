...
public final class OCRRemoveWatermarkControl$updateView$1 extends Lambda implements Function0<Unit> {
    ...
    public OCRRemoveWatermarkControl$updateView$1(OCRRemoveWatermarkControl oCRRemoveWatermarkControl, Object obj, ImageView imageView) {
        super(0);
    ...
    public final void invoke() {
        if (this.this$0.f7195i != null && !this.this$0.f7195i.isFinishing() && !this.this$0.f7195i.isDestroyed()) {
            ImageView e = this.this$0.eee;
            if (e != null) {
                e.setVisibility(8);
            }
            ImageView e2 = this.this$0.eee;
            if (e2 != null) {
