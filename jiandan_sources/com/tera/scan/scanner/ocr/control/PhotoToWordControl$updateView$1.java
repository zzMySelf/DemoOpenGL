...
public final class PhotoToWordControl$updateView$1 extends Lambda implements Function0<Unit> {
    ...
    public PhotoToWordControl$updateView$1(PhotoToWordControl photoToWordControl, Object obj, Ref.ObjectRef<ImageView> objectRef) {
        super(0);
    ...
    public final void invoke() {
        if (this.this$0.f7230i != null && !this.this$0.f7230i.isFinishing() && !this.this$0.f7230i.isDestroyed()) {
            ImageView e = this.this$0.nn;
            if (e != null) {
                e.setVisibility(8);
            }
            ImageView e2 = this.this$0.nn;
            if (e2 != null) {
