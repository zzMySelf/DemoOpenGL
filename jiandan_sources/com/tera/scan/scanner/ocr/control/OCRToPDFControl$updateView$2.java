...
public final class OCRToPDFControl$updateView$2 extends Lambda implements Function0<Unit> {
    ...
    public OCRToPDFControl$updateView$2(OCRToPDFControl oCRToPDFControl, Object obj, ImageView imageView) {
        super(0);
    ...
    public final void invoke() {
        if (this.this$0.k() != null && !this.this$0.k().isFinishing() && !this.this$0.k().isDestroyed()) {
            ...
            ImageView m2 = this.this$0.m();
            if (m2 != null) {
                m2.setImageDrawable((Drawable) null);
            }
