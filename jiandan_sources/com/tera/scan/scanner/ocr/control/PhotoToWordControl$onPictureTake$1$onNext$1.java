...
public final class PhotoToWordControl$onPictureTake$1$onNext$1 extends Lambda implements Function2<String, HashMap<String, Object>, Unit> {
    public final /* synthetic */ String $destPathStr;
    public final /* synthetic */ PhotoToWordControl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PhotoToWordControl$onPictureTake$1$onNext$1(PhotoToWordControl photoToWordControl, String str) {
        super(2);
    ...
    public final void invoke(@Nullable String str, @NotNull final HashMap<String, Object> hashMap) {
        ...
        if (!this.this$0.xxx().isAutoScanSwitchOpen()) {
            this.this$0.z(new File(this.$destPathStr), hashMap);
        } else if (this.this$0.xxx().isSingleMode()) {
            this.this$0.z(new File(this.$destPathStr), hashMap);
        } else {
            final PhotoToWordControl photoToWordControl = this.this$0;
            final String str2 = this.$destPathStr;
            photoToWordControl.A(str, str2, new Function0<Unit>() {
                public final void invoke() {
                    photoToWordControl.z(new File(str2), hashMap);
                }
            });
        }
    }
