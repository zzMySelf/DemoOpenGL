...
public final class OCRToPDFControl$onPictureTake$1$onNext$1 extends Lambda implements Function2<String, HashMap<String, Object>, Unit> {
    public final /* synthetic */ String $destPathStr;
    public final /* synthetic */ OCRToPDFControl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OCRToPDFControl$onPictureTake$1$onNext$1(OCRToPDFControl oCRToPDFControl, String str) {
        super(2);
    ...
    public final void invoke(@Nullable String str, @NotNull final HashMap<String, Object> hashMap) {
        ...
        if (!this.this$0.xxx().isAutoScanSwitchOpen()) {
            ...
            final OCRToPDFControl oCRToPDFControl = this.this$0;
            final String str2 = this.$destPathStr;
            oCRToPDFControl.G(str, str2, new Function0<Unit>() {
                public final void invoke() {
                    oCRToPDFControl.B(new File(str2), hashMap);
                }
            });
        }
    }
