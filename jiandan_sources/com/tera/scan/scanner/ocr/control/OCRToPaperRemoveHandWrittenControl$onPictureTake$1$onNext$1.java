...
public final class OCRToPaperRemoveHandWrittenControl$onPictureTake$1$onNext$1 extends Lambda implements Function2<String, HashMap<String, Object>, Unit> {
    public final /* synthetic */ String $destPathStr;
    public final /* synthetic */ OCRToPaperRemoveHandWrittenControl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OCRToPaperRemoveHandWrittenControl$onPictureTake$1$onNext$1(OCRToPaperRemoveHandWrittenControl oCRToPaperRemoveHandWrittenControl, String str) {
        super(2);
    ...
    public final void invoke(@Nullable String str, @NotNull final HashMap<String, Object> hashMap) {
        ...
        if (!this.this$0.xxx().isAutoScanSwitchOpen()) {
            this.this$0.x(new File(this.$destPathStr), hashMap);
        } else if (this.this$0.xxx().isSingleMode()) {
            this.this$0.x(new File(this.$destPathStr), hashMap);
        } else {
            final OCRToPaperRemoveHandWrittenControl oCRToPaperRemoveHandWrittenControl = this.this$0;
            final String str2 = this.$destPathStr;
            oCRToPaperRemoveHandWrittenControl.B(str, str2, new Function0<Unit>() {
                public final void invoke() {
                    oCRToPaperRemoveHandWrittenControl.x(new File(str2), hashMap);
                }
            });
        }
    }
