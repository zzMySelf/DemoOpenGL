...
public final class OCRTakePhotoActivity$takePhotoViewModel$2 extends Lambda implements Function0<OCRTakePhotoViewModel> {
    public final /* synthetic */ OCRTakePhotoActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OCRTakePhotoActivity$takePhotoViewModel$2(OCRTakePhotoActivity oCRTakePhotoActivity) {
        super(0);
    ...
    public final OCRTakePhotoViewModel invoke() {
        return (OCRTakePhotoViewModel) new ViewModelProvider(this.this$0).get(OCRTakePhotoViewModel.class);
    }
}
