...
public class VodClient extends AbstractBceClient {
    ...
    private String getFileExtension(String str) {
        if (!(str == null || str.lastIndexOf(IStringUtil.CURRENT_PATH) == -1)) {
            String substring = str.substring(str.lastIndexOf(IStringUtil.CURRENT_PATH) + 1);
    ...
    public GenerateMediaIdResponse applyMedia() {
        ...
        createRequest.addParameter(PARA_APPLY, (String) null);
    ...
    public ProcessMediaResponse processMedia(ProcessMediaRequest processMediaRequest) {
        ...
        createRequest.addParameter(PARA_PROCESS, (String) null);
    ...
    public GetMediaResourceResponse getMediaResource(GetMediaResourceRequest getMediaResourceRequest) {
        CheckUtils.checkArgument(getMediaResourceRequest.getMediaId() != null && !getMediaResourceRequest.getMediaId().equals(""), "Media ID should not be null or empty!");
