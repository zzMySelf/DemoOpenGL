...
import fe.uk.qw.pf.de.Cswitch;
import fe.uk.qw.pf.de.yj;
...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    ...
    public static final Set<String> f3880ad = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{"file", "android.resource", "content"})));
    ...
    public static class de implements ModelLoaderFactory<Uri, InputStream>, LocalUriFetcherFactory<InputStream> {
        ...
        public DataFetcher<InputStream> qw(Uri uri) {
            return new Cswitch(this.qw, uri);
        }
    }
    ...
    public static final class qw implements ModelLoaderFactory<Uri, AssetFileDescriptor>, LocalUriFetcherFactory<AssetFileDescriptor> {
        ...
        public DataFetcher<AssetFileDescriptor> qw(Uri uri) {
            return new fe.uk.qw.pf.de.qw(this.qw, uri);
        }
    }
    ...
    public ModelLoader.qw<Data> ad(@NonNull Uri uri, int i2, int i3, @NonNull fe.uk.qw.pf.ad adVar) {
        return new ModelLoader.qw<>(new fe.uk.qw.ggg.ad(uri), this.qw.qw(uri));
    }

    /* renamed from: fe */
    public boolean qw(@NonNull Uri uri) {
        return f3880ad.contains(uri.getScheme());
    }
}
