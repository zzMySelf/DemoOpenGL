...
public class WXMusicVideoObject implements WXMediaMessage.IMediaObject {
    public static final int HD_ALBUM_FILE_LENGTH = 10485760;
    public static final int LYRIC_LENGTH_LIMIT = 32768;
    public static final int STRING_LIMIT = 1024;
    public static final String TAG = "MicroMsg.SDK.WXMusicVideoObject";
