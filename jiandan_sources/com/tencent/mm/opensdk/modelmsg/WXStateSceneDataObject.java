...
public class WXStateSceneDataObject implements SendMessageToWX.IWXSceneDataObject {
    ...
    public static final String TAG = "MicroMsg.SDK.WXStateSceneDataObject";
    public static final String WX_STATE_JUMP_INFO_KEY_IDENTIFIER = "_wxapi_scene_data_state_jump_info_identifier";
