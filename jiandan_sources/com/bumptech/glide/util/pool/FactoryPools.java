...
public final class FactoryPools {
    ...
    public static <T extends Poolable> Pools.Pool<T> fe(int i2, @NonNull Factory<T> factory) {
        return qw(new Pools.SimplePool(i2), factory);
    }
    ...
    @NonNull
    public static <T extends Poolable> Pools.Pool<T> rg(int i2, @NonNull Factory<T> factory) {
        return qw(new Pools.SynchronizedPool(i2), factory);
    }

    @NonNull
    public static <T> Pools.Pool<List<T>> th() {
        return yj(20);
    }

    @NonNull
    public static <T> Pools.Pool<List<T>> yj(int i2) {
