...
public abstract class BeanConstants {
    ...
    public static final String DXM_CERTIFICATE_DES = "certificateDes";
    public static final String DXM_CERTIFICATE_TRUE_NAME = "trueName";
    public static final String DXM_CERTIFICATE_TYPE = "certificateType";
    public static final String DXM_NEED_JUMP_OPEN_SUCCESS_PAGE = "needJumpOpenSuccessPage";
    ...
    public static final String ENCODE_GB_18030 = "GB18030";
    ...
    public static final int NEED_JUMP_OPEN_SUCCESS_PAGE = 1;
    ...
    public static final String SDK_DOLEAD_FILE_DXM_MODULE_NAME = "safeliveness";
    public static final String SDK_DOLEAD_FILE_FAEC_MODULE_NAME = "pay_face";
    public static final String SDK_DOWNLOAD_FILE_LITE_LIVENESS_MODULE_NAME = "dxm_lite_liveness_face";
    ...
    public static final String SDK_DOWNLOAD_FILE_SIMPLIFY_FACE_MODULE_NAME = "dxm_simplify_face";
