...
public abstract class StatusCode {
    ...
    public static final int ERROR_ANALYSIS = 7006;
    public static final int ERROR_ANALYSIS_PICTURE = 7002;
    ...
    public static final int ERROR_CERTIFICATE_ATYPISM = 55001;
    public static final int ERROR_CODE_LOCAL = -57353;
    public static final int ERROR_CODE_VERIFY_SMS = -12;
    public static final int ERROR_DECRYPR = 2302;
    public static final int ERROR_ENCRYPT = 2301;
    public static final int ERROR_ENCRYPT_OR_DECRYPR = 2300;
    public static final int ERROR_HTTP_CLIENT = -2;
    public static final int ERROR_HTTP_SERVER = -3;
    public static final int ERROR_INSIDE = 10003;
    ...
    public static final int ERROR_METHOD_BLACK_LIST = 10012;
    public static final int ERROR_NEED_CERTIFICATE = 55000;
    ...
    public static final int ERROR_READ_PERMISSION = 7005;
    ...
    public static final int ERROR_WRITE_PERMISSION = 7004;
    public static final int FINGERPRINT_AUTH_ERROR = 65312;
    public static final int FINGERPRINT_NOT_QUERY_ERROR = 65301;
    ...
    public static final int REQUEST_LOCAL_UNKNOWN_ERROR = 7007;
