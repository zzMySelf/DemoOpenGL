...
public class SafeKeyBoardEditText extends PluginEditText implements View.OnTouchListener {
    ...
    public class qw implements View.OnLongClickListener {
        public qw() {
        }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        super.setShowSystemMethodFlag(this.f4172o);
        super.onTouch(view, motionEvent);
        int action = motionEvent.getAction();
        Layout layout = getLayout();
        if (layout != null && action == 0) {
            requestFocus();
    ...
    public SafeKeyBoardEditText(Context context, AttributeSet attributeSet) {
        ...
        this.p = false;
        this.b = context;
        setOnLongClickListener(new qw());
        setOnTouchListener(this);
        setOnFocusChangeListener(new ad());
    }
}
