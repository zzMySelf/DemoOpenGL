...
public final class StatServiceEvent {
    ...
    public static final String ANALYTIC_INTERFACE = "analyticInterface";
    public static final String APPLY_CAMERA_PERMISSION = "applyDXMPayCameraPermission";
    public static final String APPLY_READ_PERMISSION = "apply_read_permission";
    ...
    public static final String CLICK_NETWORK_ERR_CONTINUE_LOAD = "click_network_err_continue_load";
    public static final String CLICK_NETWORK_ERR_RELOAD = "click_network_err_reload";
    ...
    public static final String CONTINUE_READ_PERMISSION = "continue_read_permission";
    ...
    public static final String DXMPAY_BIOMETRIC_ENTER = "dxmPayBiometricPoint";
    public static final String DXMPAY_BIOMETRIC_STATUS = "payBiometricStatusPoint";
    public static final String DXMPAY_WEBVIEW_ERROR = "dxmpay_webview_error";
    public static final String DXMPAY_WEBVIEW_FINISH_LISTENER = "dxmpayWebviewFinishListener";
    public static final String DXM_CLICK_CLOSE_DIALOG = "click_close_dialog";
    ...
    public static final String EVENT_65301_ON_FP_SMSACT = "fp_sys_65301_on_smsact";
    ...
    public static final String GET_TOKEN_ERROR = "getTokenError";
    public static final String H5_CASHIER_SSL_ERROR = "#h5_cashier_ssl_error";
    public static final String HIT_METHOD_BLACK_LIST = "hit_method_black_list";
    ...
    public static final String NET_TYPE_ERROR = "net_type_error";
    ...
    public static final String NO_CAMERA_PERMISSION_DEVICE = "noCameraPermissionDevice";
    ...
    public static final String OBTAINED_READ_PERMISSION = "obtained_read_permission";
    ...
    public static final String OCR_IDCARD_LOAD_SO_AGAIN_FAIL = "ocrIdcardLoadSoAgainFail";
    ...
    public static final String PERCASHIER_PAY_FINISH = "percashier_pay_finish";
    ...
    public static final String PUT_FUNCTION_NAME_ERROR = "put_function_name_error";
    ...
    public static final String REFUSE_READ_PERMISSION = "refuse_read_permission";
    ...
    public static final String SET_DXM_OAID = "set_dxm_oaid";
    public static final String SHOW_LOADING_ACT = "DXMLoadingShow";
    public static final String SHOW_NETWORK_ERR_VIEW = "show_network_err_view";
    public static final String SMS_LENTH = "smsLength";
    public static final String SMS_PROTOCOL_CLICK = "smsProtocolClick";
