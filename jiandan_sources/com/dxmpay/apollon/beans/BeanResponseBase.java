...
public class BeanResponseBase implements NoProguard, Serializable {
    public static final String CONTENT = "content";
    public static final String DATA = "data";
    public static final String STATUS_SYS_ERR = "系统开小差，等一会儿再试吧";
    ...
    public String getRealResponseMsg() {
        ...
        return !TextUtils.isEmpty(this.result_string) ? this.result_string : "系统开小差，等一会儿再试吧";
    }
    ...
    public boolean needVerifySignature() {
        return !TextUtils.isEmpty(this.signature) && !TextUtils.isEmpty(this.mdAlgorithm);
    }
}
