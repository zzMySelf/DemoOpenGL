...
public final class e extends b {
    ...
    public final byte[] a() {
        try {
            ...
            arrayList.add(new BasicNameValuePair("requestData", this.b == null ? HttpUrl.PATH_SEGMENT_ENCODE_SET_URI : f.a(this.b)));
            return URLEncodedUtils.format(arrayList, a.h).getBytes();
        } catch (Exception e) {
