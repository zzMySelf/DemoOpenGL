...
public final class b implements HttpClient {
    ...
    public static java.io.InputStream a(org.apache.http.HttpEntity r2) {
        ...
        L_0x0023:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.android.phone.mrpc.core.b.a(org.apache.http.HttpEntity):java.io.InputStream");
    }
    ...
    public static boolean b(HttpUriRequest httpUriRequest) {
        ...
        Header[] headers2 = httpUriRequest.getHeaders(e.f);
        if (headers2 != null) {
