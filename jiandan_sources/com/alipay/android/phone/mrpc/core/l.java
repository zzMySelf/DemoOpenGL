...
public final class l implements ab {
    ...
    public static final ThreadFactory f650i = new n();
    public Context a;
    public ThreadPoolExecutor c;
    public b d = b.a(SapiDeviceInfo.OS_TYPE);
    public long e;
    public long f;
    public long g;
    public int h;
    ...
    public l(Context context) {
        this.a = context;
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(10, 11, 3, TimeUnit.SECONDS, new ArrayBlockingQueue(20), f650i, new ThreadPoolExecutor.CallerRunsPolicy());
