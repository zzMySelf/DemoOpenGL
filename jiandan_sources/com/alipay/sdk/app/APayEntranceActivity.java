...
public class APayEntranceActivity extends Activity {
    ...
    public void finish() {
        ...
        try {
            ...
            com.alipay.sdk.m.k.a.a(this.c, "wr", "APStartFinish", th2);
        }
    }
    ...
    public void onActivityResult(int i2, int i3, Intent intent) {
        ...
        com.alipay.sdk.m.s.a aVar = this.c;
        com.alipay.sdk.m.k.a.a(aVar, b.l, "BSAOnAR", this.b + "|" + i2 + "," + i3);
        if (i2 == 1000) {
            if (intent != null) {
                try {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            String string3 = extras.getString(g, StringUtil.EMPTY_ARRAY);
            if (!TextUtils.isEmpty(this.b)) {
                com.alipay.sdk.m.s.a a2 = a.C0016a.a(this.b);
                this.c = a2;
            ...
            try {
                ...
                com.alipay.sdk.m.k.a.a(this.c, "wr", "APStartEx", th2);
                finish();
            }
            if (this.c != null) {
