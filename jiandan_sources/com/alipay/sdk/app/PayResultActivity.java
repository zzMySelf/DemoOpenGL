...
public final class PayResultActivity extends Activity {
    ...
    public static final String f654i = "phonecashier.pay.resultOrderHash";
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(intent.getStringExtra(f))) {
                ...
                com.alipay.sdk.m.s.a a2 = a.C0016a.a(intent);
                this.a = a2;
                if (a2 == null) {
                    finish();
                }
            ...
            int intExtra = intent.getIntExtra(f654i, 0);
            if (intExtra != 0) {
                if (TextUtils.equals(b.a, String.valueOf(intExtra))) {
    ...
    public static void a(Activity activity, int i2) {
        new Handler().postDelayed(new a(activity), (long) i2);
    }
