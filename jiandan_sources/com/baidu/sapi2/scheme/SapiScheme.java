...
public class SapiScheme {
    ...
    private String buildResult(int i2, String str) {
        SchemeResult schemeResult2 = new SchemeResult();
        this.schemeResult = schemeResult2;
        schemeResult2.setResultCode(i2);
    ...
    public void invokeScApp(Activity activity, String str, String str2, List<PassNameValuePair> list, SapiWebView.InvokeScAppCallback.InvokeScAppResult invokeScAppResult2) {
        this.invokeScAppResult = invokeScAppResult2;
