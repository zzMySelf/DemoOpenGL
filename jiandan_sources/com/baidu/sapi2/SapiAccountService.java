...
public final class SapiAccountService implements ISAccountService {
        ...
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                for (String next : SapiUtils.getAuthorizedDomains()) {
                    if (!str.equals(SapiUtils.getCookie(SapiUtils.COOKIE_URL_PREFIX + next, "BDUSS"))) {
                        arrayList.add(new PassNameValuePair(SapiUtils.COOKIE_URL_PREFIX + next, SapiUtils.buildBDUSSBFESSCookie(next, str)));
                        arrayList.add(new PassNameValuePair(SapiUtils.COOKIE_URL_PREFIX + next, SapiUtils.buildBDUSSCookie(next, str)));
                    }
                }
                if (!TextUtils.isEmpty(str2)) {
                    for (String next2 : SapiUtils.getAuthorizedDomainsForPtoken()) {
                        if (!str2.equals(SapiUtils.getCookie("https://" + next2, "PTOKEN"))) {
                            arrayList.add(new PassNameValuePair("https://" + next2, SapiUtils.buildPtokenCookie(next2, str2)));
                        }
                    }
                }
        ...
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    for (String next : SapiUtils.getAuthorizedDomainsForPtoken()) {
                        if (!str.equals(SapiUtils.getCookie("https://" + next, "STOKEN"))) {
                            arrayList.add(new PassNameValuePair("https://" + next, SapiUtils.buildStokenCookie(next, str)));
                        }
                    }
                }
                SapiUtils.syncCookies(context, arrayList);
    ...
    public void checkUserFaceId(SapiCallback<CheckUserFaceIdResult> sapiCallback, String str) {
        this.sapiAccountRepository.checkUserFaceId(sapiCallback, str, (Map<String, String>) null);
    }
    ...
    public String getAccountCenterUrl(String str) {
        ...
        if (SapiWebView.ACCOUNT_CENTER_REAL_NAME.equals(str)) {
            str2 = this.sapiAccountRepository.getAccountRealNameUrl();
            ...
            str2 = this.sapiAccountRepository.getAccountCenterCheckUrl();
        } else {
            str2 = this.sapiAccountRepository.getAcccountCenterUrl();
        }
        return str2 + "?" + getRequestParams(false) + a.n + SapiUtils.createRequestParams(arrayList);
    }
    ...
    public String getAuthRequestParams(boolean z) {
        ...
        arrayList.add(new PassNameValuePair("client", SapiDeviceInfo.OS_TYPE));
        ...
        arrayList.add(new PassNameValuePair(t.a, String.valueOf(System.currentTimeMillis())));
    ...
    public int getBdussState() {
        return new OpenBdussService(this.configuration, "9.10.7.3").getBdussState();
    }
    ...
    public String getBindWidgetUrl(BindWidgetAction bindWidgetAction) {
        if (bindWidgetAction != null) {
            ArrayList arrayList = new ArrayList();
            arrayList.add(new PassNameValuePair("adapter", "3"));
            return this.sapiAccountRepository.getBindWidgetUrl(bindWidgetAction) + "?" + getRequestParams() + a.n + SapiUtils.createRequestParams(arrayList);
        }
    ...
    public String getCancelRealNameUrl() {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new PassNameValuePair("tpl", sapiConfiguration.tpl));
        arrayList.add(new PassNameValuePair("throughPage", "1"));
        arrayList.add(new PassNameValuePair("adapter", "3"));
        return this.sapiAccountRepository.getCancelRealName() + "?" + SapiUtils.createRequestParams(arrayList);
    }

    public void getCaptcha(SapiCallback<GetCaptchaResult> sapiCallback) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").getCaptcha(sapiCallback);
    }

    public String getCaptchaKey() {
        return EnhancedService.getInstance(this.configuration, "9.10.7.3").getCaptchaKey();
    }
    ...
    public void getContacts(GetContactsCallback getContactsCallback, GetContactsDTO getContactsDTO) {
        ...
        GetContactsService.getInstance(this.configuration, "9.10.7.3").getContacts(getContactsCallback, getContactsDTO);
    }
    ...
    public String getForgetPwdUrl() {
        ...
        arrayList.add(new PassNameValuePair(t.a, String.valueOf(System.currentTimeMillis())));
        return this.sapiAccountRepository.getWapForgetPwdUrl() + "?" + getRequestParams(false) + a.n + SapiUtils.createRequestParams(arrayList);
    }
    ...
    public void getHistoryPortraits(GetHistoryPortraitsCallback getHistoryPortraitsCallback, GetHistoryPortraitsDTO getHistoryPortraitsDTO) {
        new PortraitService(this.configuration, "9.10.7.3").getHistoryPortraits(getHistoryPortraitsCallback, getHistoryPortraitsDTO);
    }
    ...
    public String getLoginBackUrl() {
        return this.sapiAccountRepository.getWapLoginBackUrl() + "?" + getRequestParams();
    }
    ...
    public String getNormalizeGuestAccountUrl(SocialType socialType) {
        ...
        return this.sapiAccountRepository.getNormalizeGuestAccountUrl() + "?" + getRequestParams() + a.n + SapiUtils.createRequestParams(arrayList);
    }
    ...
    public void getOneKeyLoginIsAvailable(final GetOneKeyLoginStateDTO getOneKeyLoginStateDTO, final OneKeyLoginCallback oneKeyLoginCallback) {
        if (oneKeyLoginCallback == null) {
            ...
            OneKeyLoginSdkCall.getInstance().preGetPhoneFail(oneKeyLoginCallback, OneKeyLoginResult.ONE_KEY_LOGIN_CODE_ANDROID_VERSION_BELOW_KITKAT, (String) null);
        } else {
            ...
            if (preLoginOptResult == null || TextUtils.isEmpty(preLoginOptResult.getSecurityPhone())) {
                OneKeyLoginSdkCall.getInstance().preGetPhoneInfo(this.configuration.context, OneKeyLoginSdkCall.OKL_SCENE_SAPI, getOneKeyLoginStateDTO.connectTimeout, false, new OneKeyLoginOptCallback() {
                    public void onFinish(OneKeyLoginOptResult oneKeyLoginOptResult) {
                        if (oneKeyLoginOptResult == null) {
                            OneKeyLoginSdkCall.getInstance().preGetPhoneFail(oneKeyLoginCallback, -100, (String) null);
                        } else if (TextUtils.isEmpty(oneKeyLoginOptResult.getSecurityPhone())) {
                            OneKeyLoginSdkCall.getInstance().preGetPhoneFail(oneKeyLoginCallback, oneKeyLoginOptResult.getCode(), oneKeyLoginOptResult.getSubCode(), (String) null);
                        } else {
    ...
    public void getOpenBduss(GetOpenBdussDTO getOpenBdussDTO, GetOpenBdussCallback getOpenBdussCallback) {
        new OpenBdussService(this.configuration, "9.10.7.3").getOpenBduss(getOpenBdussDTO, getOpenBdussCallback);
    }

    public String getPersonalInfoUrl() {
        return this.sapiAccountRepository.getPersonalInfoUrl() + "?" + getRequestParams();
    }
    ...
    public void getPopularPortraitsInfo(GetPopularPortraitsCallback getPopularPortraitsCallback, String str, PortraitCategory portraitCategory) {
        new PortraitService(this.configuration, "9.10.7.3").getPopularPortraitsInfo(getPopularPortraitsCallback, str, portraitCategory);
    }

    public void getQrCodeImage(SapiCallback<GetQrCodeImageResult> sapiCallback, GetQrCodeImageDTO getQrCodeImageDTO) {
        QrCodeService.getInstance(this.configuration, "9.10.7.3").getQrCodeImage(sapiCallback, getQrCodeImageDTO);
    }
    ...
    public void getQrCodeLoginWithEncuidImage(SapiCallback<GetQrCodeImageResult> sapiCallback, GetQrCodeImageDTO getQrCodeImageDTO, String str, String str2) {
        QrCodeService.getInstance(this.configuration, "9.10.7.3").getQrCodeLoginWithEnuidImage(sapiCallback, getQrCodeImageDTO, str, str2);
    }
    ...
    public String getRealnameAuthenticateUrl() {
        ...
        return str + "?" + getRequestParams() + a.n + SapiUtils.createRequestParams(arrayList);
    }
    ...
    public String getUniteVerifyUrl() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new PassNameValuePair("adapter", "3"));
        return this.sapiAccountRepository.getUniteVerifyUrl() + "?" + getRequestParams() + a.n + SapiUtils.createRequestParams(arrayList);
    }
    ...
    public void handleOneKeyLoginResult(OneKeyLoginCallback oneKeyLoginCallback, String str) {
        ...
        new OneKeyLoginSdkCall().loadOneKeyLoginFail(oneKeyLoginCallback, -103, (String) null);
    }
    ...
    public void oauth(SapiCallback<OAuthResult> sapiCallback, String str) {
        this.sapiAccountRepository.oauth(sapiCallback, str, (String) null, (String) null);
    }
    ...
    public void oauthAccessToken(SapiCallback<OAuthResult> sapiCallback, String str, String str2, boolean z) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && sapiCallback != null) {
            if (z) {
                this.sapiAccountRepository.oauth(sapiCallback, str, str2, (String) null);
            } else {
    ...
    public void qrAppLogin(SapiCallback<QrAppLoginResult> sapiCallback, String str, String str2) {
        QrCodeService.getInstance(this.configuration, "9.10.7.3").qrAppLogin(sapiCallback, str, str2);
    }
    ...
    public void qrJoinLoginStatusCheck(QrLoginStatusCheckCallback qrLoginStatusCheckCallback, QrLoginStstusCheckDTO qrLoginStstusCheckDTO) {
        ...
        QrCodeService.getInstance(this.configuration, "9.10.7.3").qrLoginStatusCheck(qrLoginStatusCheckCallback, qrLoginStstusCheckDTO, true);
    }
    ...
    public boolean refreshLocalAccessToken(String str, String str2, String str3, String str4) {
        return this.sapiAccountRepository.refreshLocalAccessToken(str, str2, str3, str4);
    }

    public void relaseContactsSource() {
        GetContactsService.getInstance(this.configuration, "9.10.7.3").relaseContactsSource();
    }

    public void sendContactsSms(SendSmsDTO sendSmsDTO) {
        GetContactsService.getInstance(this.configuration, "9.10.7.3").sendSMS(sendSmsDTO);
    }
    ...
    public void setPopularPortrait(SetPopularPortraitCallback setPopularPortraitCallback, SetPopularPortraitDTO setPopularPortraitDTO) {
        new PortraitService(this.configuration, "9.10.7.3").setPopularPortrait(setPopularPortraitCallback, setPopularPortraitDTO);
    }
    ...
    public void startLooper(String str, DynamicPwdWithAuthCallback dynamicPwdWithAuthCallback) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").startLooper(str, dynamicPwdWithAuthCallback);
    }

    public void stopLooperLoginCheck() {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").stopLooperLoginCheck();
    }

    public void stopQrLoginStatusCheck() {
        QrCodeService.getInstance(this.configuration, "9.10.7.3").stopLoginStatusCheck();
    }

    public LocalRefreshTokenResult syncGetLocalRefreshToken(String str, String str2) {
        return this.sapiAccountRepository.syncGetLocalRefreshToken(str, str2);
    }

    public void userLogout(int i2, UserLogoutCallback userLogoutCallback) {
        this.sapiAccountRepository.userLogout(i2, userLogoutCallback);
    }

    public void validateOnlyHaoKan(String str, ValidateWithHaoKanCallback validateWithHaoKanCallback) {
        this.sapiAccountRepository.validateOnlyHaoKan(str, validateWithHaoKanCallback);
    }
    ...
    public void dynamicPwdLogin(SapiCallback<DynamicPwdLoginResult> sapiCallback, String str, String str2) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").dynamicPwdLogin(sapiCallback, str, str2, (Map<String, String>) null);
    }
    ...
    public void getDynamicPwd(SapiCallback<GetDynamicPwdResult> sapiCallback, String str) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").getDynamicPwd(sapiCallback, str);
    }

    public void getPopularPortraitsInfo(GetPopularPortraitsCallback getPopularPortraitsCallback, String str) {
        new PortraitService(this.configuration, "9.10.7.3").getPopularPortraitsInfo(getPopularPortraitsCallback, str, PortraitCategory.NORMAL);
    }
    ...
    public void preGetPhoneInfo(Context context, String str, int i2, boolean z, OneKeyLoginOptCallback oneKeyLoginOptCallback) {
        OneKeyLoginSdkCall.getInstance().preGetPhoneInfo(context, str, i2, z, oneKeyLoginOptCallback);
    }
    ...
    public boolean webLogin(final Context context, String str) {
        ...
        return asyncBduss2Web(context, str, (String) null);
    }
    ...
    public void getDynamicPwd(GetDynamicPwdCallback getDynamicPwdCallback, String str, String str2) {
        getDynamicPwd(getDynamicPwdCallback, str, str2, (Map<String, String>) null);
    }
    ...
    public void dynamicPwdLogin(DynamicPwdLoginCallback dynamicPwdLoginCallback, String str, String str2, Map<String, String> map) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").dynamicPwdLogin((SapiCallback<DynamicPwdLoginResult>) dynamicPwdLoginCallback, str, str2, map);
    }

    public void getDynamicPwd(GetDynamicPwdCallback getDynamicPwdCallback, String str, String str2, Map<String, String> map) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").getDynamicPwd(getDynamicPwdCallback, str, str2, map);
    }

    public void setPortrait(SetPortraitDTO setPortraitDTO, SetPortraitCallback setPortraitCallback) {
        new PortraitService(this.configuration, "9.10.7.3").setPortrait(setPortraitDTO, setPortraitCallback);
    }

    public void dynamicPwdLogin(DynamicPwdWithAuthCallback dynamicPwdWithAuthCallback, String str, String str2, boolean z) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").dynamicPwdLogin(dynamicPwdWithAuthCallback, str, str2, z);
    }

    public void getDynamicPwd(DynamicPwdWithAuthCallback dynamicPwdWithAuthCallback, String str, boolean z) {
        EnhancedService.getInstance(this.configuration, "9.10.7.3").getDynamicPwd(dynamicPwdWithAuthCallback, str, z);
    }
