...
public class PassSdkModel {
    ...
    public static volatile PassSdkModel instance;
    ...
    public boolean checkPassSdkInit() {
        SapiAccountManager instance2 = SapiAccountManager.getInstance();
        if (instance2.getConfignation() == null) {
            SapiAccountManager.getGlobalCallback().onNeedInitPassSdk();
        }
        return instance2.getConfignation() != null;
    }
