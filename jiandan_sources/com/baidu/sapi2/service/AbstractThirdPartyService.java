...
public interface AbstractThirdPartyService {
    ...
    void handleDingdingLoginResp(Activity activity, String str, String str2, String str3);

    void handleWXLoginResp(Activity activity, String str, String str2, int i2);

    void loadCFOSSOLogin(Context context, int i2);

    void loadDingdingSSOLogin(Context context, int i2);

    void loadQQLogin(Context context, int i2);

    void loadThirdPartyLogin(Context context, WebSocialLoginDTO webSocialLoginDTO, int i2, ThirdLoginCallback thirdLoginCallback);
    ...
    void loadThirdPartyLogin(Context context, SocialType socialType, int i2, String str, boolean z, boolean z2, WebSocialLoginDTO webSocialLoginDTO);
