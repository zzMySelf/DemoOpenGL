...
public final class SapiOptions implements NoProguard {
    ...
    public static final String DEFAULT_JOIN_QR_LOGIN_PROMPT = "登录后%s将获得百度账号的公开信息（用户名、头像）";
    ...
    public static final String KEY_PTOKEN_AUTHORIZE_PKG = "ptoken_authorize_pkg";
    public static final String KEY_RESET_FILE_EXEC_PER = "reset_file_exec_per";
    public static final String KEY_SDK_COMMON_CONFIG = "sdk_common_config";
    ...
    public static final String KEY_VALIDATE_BDUSS_PKG = "validate_bduss_pkg";
    ...
    public String joinQrLoginPrompt = DEFAULT_JOIN_QR_LOGIN_PROMPT;
    ...
    public static class Cache {
        ...
        public static class Module {
            ...
            public static Module fromJSON(JSONObject jSONObject) {
                ...
                module.downloadUrl = jSONObject.optString(SapiOptions.KEY_CACHE_MODULE_DOWNLOAD_URL);
            ...
            public JSONObject toJSON() {
                ...
                try {
                    ...
                    jSONObject.put(SapiOptions.KEY_CACHE_MODULE_DOWNLOAD_URL, this.downloadUrl);
    ...
    public static class Gray implements NoProguard {
        ...
        public static final String KEY_GRAY_ANDROID_METHOD_V2 = "android_method_v2";
        public static String KEY_GRAY_EX = "ex";
        public static final String KEY_GRAY_FACE_REQUEST_PERMISSION = "request_permission";
        ...
        public static class GrayModule implements NoProguard {
            ...
            public static GrayModule fromJSON(String str, JSONObject jSONObject) {
                ...
                long j = SapiContext.getInstance().getLong(str, -1);
                if (j == -1) {
                    Random random = new Random();
                    random.setSeed(System.currentTimeMillis());
                    j = (long) random.nextInt(1000000);
        ...
        public JSONObject toJSON() {
            JSONObject jSONObject = new JSONObject();
            for (String next : this.grayModuleMap.keySet()) {
                try {
                    jSONObject.put(next, this.grayModuleMap.get(next).toJSON());
    ...
    public static class PkgSigns {
        ...
        public static final String KEY_FORBID_CONTACT_PACKAGES = "forbid_contact_packages";
        ...
        public Map<String, String> forbidContactPackages = new HashMap();
        public List<String> mAuthorizedPackagesForPtoken = new ArrayList();
        public List<String> mAuthorizedPackagesForValidateBduss = new ArrayList();
        ...
        public static PkgSigns fromJSON(JSONObject jSONObject) {
            ...
            SapiOptions.setJsonToMap(jSONObject.optJSONObject(KEY_FORBID_CONTACT_PACKAGES), pkgSigns.forbidContactPackages);
            SapiOptions.setJsonToMap(jSONObject.optJSONObject(KEY_SC_AUTHORIZED_PACKAGES), pkgSigns.scAuthorizedPackages);
            JSONObject optJSONObject = jSONObject.optJSONObject(SapiOptions.KEY_SDK_COMMON_CONFIG);
            if (optJSONObject != null) {
                JSONArray optJSONArray = optJSONObject.optJSONArray(SapiOptions.KEY_PTOKEN_AUTHORIZE_PKG);
                if (optJSONArray != null && optJSONArray.length() > 0) {
                    SapiOptions.setJsonArrayToList(optJSONArray, pkgSigns.mAuthorizedPackagesForPtoken);
                }
                JSONArray optJSONArray2 = optJSONObject.optJSONArray(SapiOptions.KEY_VALIDATE_BDUSS_PKG);
                if (optJSONArray2 != null && optJSONArray2.length() > 0) {
                    SapiOptions.setJsonArrayToList(optJSONArray2, pkgSigns.mAuthorizedPackagesForValidateBduss);
                }
            }
            return pkgSigns;
        }
        ...
        public Map<String, String> getForbidContactPackages() {
            if (this.forbidContactPackages.isEmpty()) {
                return getInitialForbidContactPackages();
            }
            Log.d("Contact", "forbidContactPackages: " + this.forbidContactPackages);
            return this.forbidContactPackages;
        }
        ...
        public Map<String, String> getInitialAuthorizedPackages() {
            ...
            hashMap.put("com.baidu.browser.apps", "c2b0b497d0389e6de1505e7fd8f4d539");
        ...
        public Map<String, String> getInitialForbidContactPackages() {
            HashMap hashMap = new HashMap();
            hashMap.put("com.baidu.sapi2.demo.standard", "de308d7973b5171883333a97253327e4");
            Log.d("Contact", "initialAuthorizedPackages: " + hashMap);
            return hashMap;
        }

        public List<String> getInitialPtokenAuthorizedPackages() {
        ...
        public List<String> getInitialValidateBdussAuthorizedPackages() {
            ArrayList arrayList = new ArrayList();
        ...
        public List<String> getPtokenAuthorizedPackages() {
            if (!this.mAuthorizedPackagesForPtoken.isEmpty()) {
                return this.mAuthorizedPackagesForPtoken;
            }
            return getInitialPtokenAuthorizedPackages();
        }
        ...
        public List<String> getValidateBdussAuthorizedPackages() {
            if (!this.mAuthorizedPackagesForValidateBduss.isEmpty()) {
                return this.mAuthorizedPackagesForValidateBduss;
            }
            return getInitialValidateBdussAuthorizedPackages();
        }
        ...
        public String toJSON() {
            ...
            try {
                ...
                SapiOptions.setMapToJson(jSONObject, KEY_FORBID_CONTACT_PACKAGES, this.forbidContactPackages);
                SapiOptions.setMapToJson(jSONObject, KEY_SC_AUTHORIZED_PACKAGES, this.scAuthorizedPackages);
                JSONObject jSONObject2 = new JSONObject();
                SapiOptions.setListToJsonArray(jSONObject2, SapiOptions.KEY_PTOKEN_AUTHORIZE_PKG, this.mAuthorizedPackagesForPtoken);
                SapiOptions.setListToJsonArray(jSONObject2, SapiOptions.KEY_VALIDATE_BDUSS_PKG, this.mAuthorizedPackagesForValidateBduss);
                jSONObject.put(SapiOptions.KEY_SDK_COMMON_CONFIG, jSONObject2);
            } catch (JSONException e) {
                Log.e(e);
            }
    ...
    public static void cacheGrayTest(JSONObject jSONObject, SapiOptions sapiOptions) {
        ...
        int i2 = instance.getInt(KEY_CACHE_GRAY, -1);
        if (i2 == -1) {
            i2 = new Random().nextInt(100);
            instance.put(KEY_CACHE_GRAY, i2);
        }
        ...
        if (!TextUtils.isEmpty(percent)) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                if (i2 <= i3) {
                    ...
                    sapiOptions.cache.modules.add((Cache.Module) fromJSON.modules.get(i4));
                    return;
                }
            }
        }
    ...
    public static SapiOptions fromJSON(JSONObject jSONObject) {
        ...
        sapiOptions.joinQrLoginPrompt = jSONObject.optString(KEY_JOIN_QR_LOGIN_PROMPT, DEFAULT_JOIN_QR_LOGIN_PROMPT);
        ...
        if (optJSONObject2 != null) {
            ...
            if (optJSONArray2 != null) {
                for (int i3 = 0; i3 < optJSONArray2.length(); i3++) {
                    sapiOptions.dialogSelectAgreementTpls.add((String) optJSONArray2.opt(i3));
                }
            }
    ...
    public static List<String> getInitialCuidAuthorizedDomains() {
        ...
        arrayList.add(SapiUtils.DOMAIN_PASSPORT);
        arrayList.add(SapiUtils.DOMAIN_WAPPASS);
        return arrayList;
    }
    ...
    public static void setJsonToMap(JSONObject jSONObject, Map<String, String> map) {
        if (jSONObject != null) {
            Log.d("TAG", "setJsonToMap: " + jSONObject.toString());
    ...
    public String toJSON() {
        ...
        try {
            ...
            JSONObject jSONObject2 = new JSONObject();
            for (Map.Entry next : this.specificShareStrategy.entrySet()) {
                jSONObject2.put((String) next.getKey(), ((LoginShareStrategy) next.getValue()).getStrValue());
            }
            ...
            JSONArray jSONArray = new JSONArray();
            for (Integer put : this.diExceptIndex) {
                jSONArray.put(put);
            }
            ...
            if (this.dialogSelectAgreementTpls != null) {
                ...
                for (String put2 : this.dialogSelectAgreementTpls) {
                    jSONArray2.put(put2);
                }
            ...
            if (this.loginTplsPriority != null) {
                ...
                for (Map.Entry next2 : this.loginTplsPriority.entrySet()) {
                    String str = (String) next2.getKey();
                    JSONArray jSONArray3 = (JSONArray) next2.getValue();
                    if (str != null) {
                        if (jSONArray3 != null) {
