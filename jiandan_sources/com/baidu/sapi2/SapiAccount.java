...
public class SapiAccount implements Parcelable, Cloneable {
    public static final Parcelable.Creator<SapiAccount> CREATOR = new Parcelable.Creator<SapiAccount>() {
    ...
    public static final class ExtraProperty implements NoProguard {
        ...
        public static final String EXTRA_SOCIAL_OPENID = "social_openid";
        ...
        public String extraSocialOpenId;
        ...
        public static ExtraProperty fromJSONObject(JSONObject jSONObject) {
            ...
            extraProperty.extraSocialOpenId = jSONObject.optString(EXTRA_SOCIAL_OPENID);
            ...
            extraProperty.extraPkg = jSONObject.optString(EXTRA_PKG);
        ...
        public JSONObject toJSONObject() {
            ...
            try {
                ...
                jSONObject.put(EXTRA_SOCIAL_OPENID, this.extraSocialOpenId);
                ...
                jSONObject.put(EXTRA_PKG, this.extraPkg);
    ...
    public static boolean isValidAccount(SapiAccount sapiAccount) {
        return sapiAccount != null && !TextUtils.isEmpty(sapiAccount.bduss) && !TextUtils.isEmpty(sapiAccount.ptoken) && !TextUtils.isEmpty(sapiAccount.uid) && !TextUtils.isEmpty(sapiAccount.displayname);
    }

    private boolean isValidPackage() {
        Context context = ServiceManager.getInstance().getIsAccountManager().getConfignation().context;
        for (String matches : SapiContext.getInstance().getPtokenAuthorizedPackages()) {
    ...
    public void addSocialInfo(SocialType socialType, String str, String str2, String str3) {
        ...
        putExtra(ExtraProperty.EXTRA_SOCIAL_OPENID, str3);
    ...
    public String getShareAccountPkg() {
        return getStringExtra(ExtraProperty.EXTRA_PKG, (String) null);
    }
    ...
    public String getSocialNickname() {
        return getStringExtra(ExtraProperty.EXTRA_SOCIAL_NICKNAME, (String) null);
    }

    public String getSocialOpenId() {
        return getStringExtra(ExtraProperty.EXTRA_SOCIAL_OPENID, (String) null);
    }

    public String getSocialPortrait() {
        return getStringExtra(ExtraProperty.EXTRA_SOCIAL_PORTRAIT, (String) null);
    }

    public SocialType getSocialType() {
        return SocialType.getSocialType(getIntExtra(ExtraProperty.EXTRA_SOCIAL_TYPE, SocialType.UNKNOWN.getType()));
    }
    ...
    public void setAccountPkg(String str) {
        putExtra(ExtraProperty.EXTRA_PKG, str);
    }
    ...
    public void updatePtoken() {
        if (TextUtils.isEmpty(this.bduss) || TextUtils.isEmpty(this.ptoken)) {
            ...
            if (accountFromBduss == null || TextUtils.isEmpty(accountFromBduss.ptoken)) {
                ...
                if (str != null && str.equals(cookieBduss) && !TextUtils.isEmpty(cookiePtoken)) {
