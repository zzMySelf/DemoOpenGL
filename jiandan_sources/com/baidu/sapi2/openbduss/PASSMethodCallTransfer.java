...
public class PASSMethodCallTransfer implements NoProguard {
    ...
    private Object[] buildParams(Object[] objArr, SapiAccount sapiAccount) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ParamsWap paramsWap = objArr[i2];
            if (!(paramsWap instanceof ParamsWap)) {
                objArr2[i2] = paramsWap;
            } else {
                ParamsWap paramsWap2 = paramsWap;
                Map<String, String> map = paramsWap2.attributes;
                if (map == null) {
                    objArr2[i2] = paramsWap2.param;
                } else {
                    for (String next : map.keySet()) {
                        Object obj = null;
                        if (ParamsWap.UID.equals(next)) {
                            obj = setObjectValue(paramsWap2.param, paramsWap2.attributes.get(next), sapiAccount.uid);
                        } else if (ParamsWap.BDUSS.equals(next)) {
                            obj = setObjectValue(paramsWap2.param, paramsWap2.attributes.get(next), sapiAccount.bduss);
                        }
                        objArr2[i2] = obj;
                    }
                }
    ...
    public Object dynamicCallMethod(Object obj, Object[] objArr, String str, DynamicCallbak dynamicCallbak, Class<?>... clsArr) {
        ...
        if (currentAccount == null) {
            ...
            try {
                ...
                Log.e(e);
                dynamicCallbak.onFailure(-1002, "未找到反射方法");
                return null;
            }
        }
    }
