...
public class GetUserAttrInfoResult extends SapiResult implements NoProguard {
    ...
    public boolean isAvailable(long j) {
        return this.mCacheTime + j > System.currentTimeMillis() / 1000 && this.resultCode == 0;
    }
    ...
    public String toString() {
        return "GetUserAttrInfoResult{resultCode=" + this.resultCode + ", resultMsg='" + this.resultMsg + ExtendedMessageFormat.QUOTE + ", mFields=" + this.mFields + ", mExtFields=" + this.mExtFields + ", mCacheTime=" + this.mCacheTime + ", mIsLocalData=" + this.mIsLocalData + ExtendedMessageFormat.END_FE;
    }
}
