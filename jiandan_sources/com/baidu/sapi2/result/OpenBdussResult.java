...
public class OpenBdussResult extends SapiResult implements NoProguard {
    ...
    public static OpenBdussResult fromJson(String str) {
        ...
        try {
            ...
            openBdussResult.flag = jSONObject.optString(PARAMS_FLAG);
            ...
            openBdussResult.openBduss = jSONObject.optString("openbduss");
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(PARAMS_FLAG, this.flag);
            jSONObject.put("uid", this.uid);
            jSONObject.put("bduss", this.bduss);
            jSONObject.put("unionid", this.unionid);
            jSONObject.put("displayname", this.displayname);
            jSONObject.put("openbduss", this.openBduss);
            if (this.tplStokenMap != null && this.tplStokenMap.size() > 0) {
                JSONObject jSONObject2 = new JSONObject();
                for (Map.Entry next : this.tplStokenMap.entrySet()) {
