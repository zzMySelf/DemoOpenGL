...
public class SapiResult {
    ...
    public static final int ERROR_CODE_JSON_PARSING_EXCEPTION = -501;
    ...
    public static final int ERROR_CODE_SEND_REQUEST_ERROR = -502;
    ...
    public static final String ERROR_MSG_JSON_PARSING_EXCEPTION = "数据JSON解析异常";
    ...
    public static final String ERROR_MSG_SEND_REQUEST_ERROR = "发送数据异常";
    ...
    public SapiResult() {
        ...
        this.msgMap.put(-501, ERROR_MSG_JSON_PARSING_EXCEPTION);
