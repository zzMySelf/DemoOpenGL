...
public class OneKeyLoginOptResult implements NoProguard {
    ...
    public static boolean isValid(OneKeyLoginOptResult oneKeyLoginOptResult) {
        return oneKeyLoginOptResult != null && oneKeyLoginOptResult.code == 0 && oneKeyLoginOptResult.subCode == 0 && !TextUtils.isEmpty(oneKeyLoginOptResult.operateType) && !TextUtils.isEmpty(oneKeyLoginOptResult.extraStr);
    }
