...
public class OneKeyLoginResult extends SapiResult {
    ...
    public OneKeyLoginResult() {
        ...
        this.msgMap.put(ONE_KEY_LOGIN_CODE_IS_LOGIN_WHEN_SECOND_PRE_PHONE, ONE_KEY_LOGIN_MSG_IS_LOGIN_WHEN_SECOND_PRE_PHONE);
        this.msgMap.put(ONE_KEY_LOGIN_CODE_HIT_RISK_MANAGEMENT, ONE_KEY_LOGIN_MSG_HIT_RISK_MANAGEMENT);
