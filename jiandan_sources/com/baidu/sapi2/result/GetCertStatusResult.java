...
public class GetCertStatusResult extends SapiResult {
    ...
    public static GetCertStatusResult parseFromJSONObject(JSONObject jSONObject) {
        ...
        if (optJSONObject != null) {
            GuarderInfo guarderInfo2 = new GuarderInfo();
            guarderInfo2.status = optJSONObject.optInt("status");
            guarderInfo2.trueName = optJSONObject.optString("true_name");
            guarderInfo2.certCode = optJSONObject.optString(KEY_CERT_CODE);
            guarderInfo2.certType = optJSONObject.optString(KEY_CERT_TYPE);
            getCertStatusResult.guarderInfo = guarderInfo2;
        }
