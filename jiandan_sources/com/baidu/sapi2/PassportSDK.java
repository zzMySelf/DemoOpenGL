...
public final class PassportSDK {
    public static final String TAG = "PassportSDK";
    ...
    public void cancelRealName(Context context, ExtendSysWebViewMethodCallback extendSysWebViewMethodCallback) {
        CoreViewRouter.getInstance().cancelRealName(context, extendSysWebViewMethodCallback);
    }
    ...
    public boolean isDeviceOpenNFC(Activity activity) {
        return CoreViewRouter.getInstance().isDeviceOpenNFC(activity);
    }

    public boolean isDeviceSupportNFC(Activity activity) {
        return CoreViewRouter.getInstance().isDeviceSupportNFC(activity);
    }
    ...
    public void loadQrCodePage(Context context, String str, LoadQrUrlCallback loadQrUrlCallback) {
        ...
        } else if (!str.contains(SapiUtils.DOMAIN_WAPPASS) && !str.contains(SapiUtils.DOMAIN_PASSPORT)) {
            Log.e("url 不合法", new Object[0]);
        } else if (!str.contains("wappass.baidu.com/v3/getpass/artificialappeal")) {
            Log.e("url 不合法", new Object[0]);
        } else {
            try {
    ...
    public void startNFCReadCard(Activity activity, NFCReadCardCallback nFCReadCardCallback) {
        CoreViewRouter.getInstance().startNFCReadCard(activity, nFCReadCardCallback);
    }
    ...
    public int stopNFCReadCard(Activity activity) {
        return CoreViewRouter.getInstance().stopNFCReadCard(activity);
    }
