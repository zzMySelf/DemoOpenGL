...
public class a {
    ...
    public class C0038a extends HttpHandlerWrap {
        public final /* synthetic */ ThirdLoginCallback a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public C0038a(Looper looper, ThirdLoginCallback thirdLoginCallback) {
            super(looper);
    ...
    public void a(String str, ThirdLoginCallback thirdLoginCallback) {
        ...
        new HttpClientWrap().get(addExtras, ReqPriority.IMMEDIATE, ParamsUtil.buildNaCookie(addExtras, SapiAccountManager.getInstance().getConfignation()), new C0038a(Looper.getMainLooper(), thirdLoginCallback));
    }
}
