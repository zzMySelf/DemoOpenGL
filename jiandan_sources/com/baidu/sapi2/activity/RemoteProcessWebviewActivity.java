...
public class RemoteProcessWebviewActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                WebView.setDataDirectorySuffix("RemoteProcessWebviewActivity");
    ...
    private void a() {
        ...
        this.e.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView webView, int i2) {
                ProgressBar progressBar = RemoteProcessWebviewActivity.this.progressBar;
                if (progressBar != null) {
                    if (i2 == 100) {
            ...
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                ...
                if (!SapiUtils.hasActiveNetwork(RemoteProcessWebviewActivity.this)) {
                    ...
                    if (remoteProcessWebviewActivity.noNetworkView == null) {
                        remoteProcessWebviewActivity.noNetworkView = c.a((Context) remoteProcessWebviewActivity, remoteProcessWebviewActivity.e);
