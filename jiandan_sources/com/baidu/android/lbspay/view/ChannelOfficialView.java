...
public class ChannelOfficialView extends ChannelViewBase {
    ...
    private void initView() {
        View inflate = LayoutInflater.from(getContext()).inflate(ResUtils.layout(getContext(), "wallet_juhe_customview_official_channel"), this, true);
        ...
        ImageView imageView2 = (ImageView) inflate.findViewById(ResUtils.id(getContext(), "official_paysdk_id_cb"));
