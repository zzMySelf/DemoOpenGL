...
public class ChannelView extends ChannelViewBase {
    ...
    private void initView() {
        View inflate = LayoutInflater.from(getContext()).inflate(ResUtils.layout(getContext(), "wallet_juhe_customview_channel"), this, true);
        ...
        ImageView imageView2 = (ImageView) inflate.findViewById(ResUtils.id(getContext(), "paysdk_id_cb"));
    ...
    public void setEnabled(boolean z, NewCashierContent.IBaseChannel iBaseChannel) {
        ...
        if (!z) {
            ...
            } else if (iBaseChannel.getIsRed() || iBaseChannel.getChanelId() == 126 || iBaseChannel.getChanelId() == -2) {
