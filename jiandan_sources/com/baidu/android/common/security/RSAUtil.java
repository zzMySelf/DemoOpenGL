...
public final class RSAUtil {
    ...
    public static byte[] decryptLongByPrivateKey(byte[] bArr, String str, int i2) throws Exception {
        ...
        while (i4 < length) {
            ...
            i4 += i5;
            sb.append(new String(instance.doFinal(bArr2)));
        }
    ...
    public static byte[] encryptLongByPublicKey(byte[] bArr, String str, int i2) throws Exception {
        ...
        while (i5 < length) {
            ...
            i5 += i7;
            System.arraycopy(instance.doFinal(bArr3), 0, bArr2, i6, i3);
            i6 += i3;
        }
        return bArr2;
    }
    ...
    public static String getPrivateKey(Map<String, Object> map) throws Exception {
        return Base64.encode(((Key) map.get(PRIVATE_KEY)).getEncoded(), a.h);
    }

    public static String getPublicKey(Map<String, Object> map) throws UnsupportedEncodingException {
        return Base64.encode(((Key) map.get(PUBLIC_KEY)).getEncoded(), a.h);
    }
}
