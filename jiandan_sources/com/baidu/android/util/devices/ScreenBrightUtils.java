...
public class ScreenBrightUtils {
    ...
    public static float getWinBrightness(Activity activity) {
        if (activity != null) {
            return (float) ((int) (activity.getWindow().getAttributes().screenBrightness * 255.0f));
        }
        return -1.0f;
    }
    ...
    public static void setBrightness(Activity activity, int i2) {
        if (activity != null) {
            ...
            attributes.screenBrightness = Float.valueOf((float) limitRange).floatValue() * 0.003921569f;
