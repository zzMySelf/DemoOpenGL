...
public class ActionJsonData {
    ...
    public static ActionJsonData fromJson(JSONObject jSONObject) {
        ...
        try {
            JSONObject jSONObject2 = new JSONObject(jSONObject.optString(TAG_LINK));
            String optString = jSONObject2.optString(TAG_NOTIFICATION);
            if (optString != null) {
                JSONObject jSONObject3 = new JSONObject(optString);
                Notification notification = new Notification();
                notification.mText = jSONObject3.optString("text");
                notification.mCommand = jSONObject3.optString(TAG_COMMAND);
                SignIn signIn = new SignIn();
                signIn.mCommand = new JSONObject(jSONObject2.optString(TAG_SIGN_IN)).optString(TAG_COMMAND);
                Link link = new Link();
