...
public final class DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$3 extends Lambda implements Function3<Context, String, String, DeviceIdBag> {
    public static final DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$3 INSTANCE = new DeviceInfoManager$DEVICE_READ_FUNC_MAP$1$3();
    ...
    public final DeviceIdBag invoke(@NotNull Context context, @NotNull String str, @NotNull String str2) {
        ...
        return DeviceInfoManager.qw.h(context, str, str2);
    }
}
