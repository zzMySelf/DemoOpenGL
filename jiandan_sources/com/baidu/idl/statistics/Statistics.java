...
public class Statistics {
    ...
    private boolean initFile() {
        File file = new File(this.app.getFilesDir(), AS_FILE_NAME);
        this.asFile = file;
        if (FileUtil.createFile(file) && FileUtil.loadPropertiesFile(this.asFile, this.as)) {
            return true;
        }
        return false;
    }
    ...
    public synchronized void merge(Properties properties) {
        for (Map.Entry entry : properties.entrySet()) {
            ...
            if (!this.as.containsKey(obj)) {
                ...
                this.as.setProperty(obj, String.format(Locale.getDefault(), "%s-%s", new Object[]{obj2, this.as.getProperty(obj)}));
            }
        }
        syncFile(true);
    }
    ...
    private void syncFile(boolean z) {
        ...
        this.workerHandler.sendEmptyMessageDelayed(2, 3000);
    }
                    ...
                    NetUtil.uploadData(new NetUtil.RequestAdapter<StatisticsResult>() {
                        public String getRequestString() {
                            ...
                            for (Map.Entry entry : properties.entrySet()) {
                                ...
                                for (String append : ((String) entry.getValue()).split("-")) {
