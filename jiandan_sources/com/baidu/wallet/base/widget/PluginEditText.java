...
public class PluginEditText extends EditText implements View.OnTouchListener {
    public String a;
    public boolean b;
    public List<IEditTextPasteFilter> c;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            int offsetForHorizontal = layout.getOffsetForHorizontal(layout.getLineForVertical(getScrollY() + ((int) motionEvent.getY())), (float) ((int) motionEvent.getX()));
            ...
            int offsetForHorizontal2 = layout.getOffsetForHorizontal(layout.getLineForVertical(getScrollY() + ((int) motionEvent.getY())), (float) ((int) motionEvent.getX()));
            int i2 = this.off;
