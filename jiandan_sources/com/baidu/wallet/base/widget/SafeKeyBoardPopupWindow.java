...
public class SafeKeyBoardPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            SafeKeyBoardPopupWindow safeKeyBoardPopupWindow = (SafeKeyBoardPopupWindow) this.a.get();
    ...
    public void initKeyNum(boolean z) {
        ...
        Button button10 = this.f1154i;
        button10.setText("" + a2[9]);
        this.f1154i.setTag(Integer.valueOf(a2[9]));
    ...
    private void b() {
        ...
        this.f1154i = (Button) this.contentView.findViewById(ResUtils.id(this.mContext, "btn9"));
