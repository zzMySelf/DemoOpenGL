...
public class CommonPromotionView extends FrameLayout {
    ...
    public void initViews() {
        View inflate = View.inflate(getContext(), ResUtils.layout(getContext(), getLayout()), (ViewGroup) null);
        this.mView = inflate;
    ...
    public CommonPromotionView setClickRightImgToClose() {
        setRightImgClickListener(new View.OnClickListener() {
    ...
    public CommonPromotionView setDefLeftDrawable(Drawable drawable, String str) {
        ...
        layoutParams.setMargins(DisplayUtils.dip2px(this.mView.getContext(), (float) getMarginLeft()), 0, layoutParams.rightMargin, 0);
    ...
    public CommonPromotionView setDefRightDrawable(Drawable drawable) {
        ...
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) this.promotionTxt.getLayoutParams();
        layoutParams.setMargins(layoutParams.leftMargin, 0, DisplayUtils.dip2px(this.mView.getContext(), (float) getMarginRight()), 0);
