...
public class BaseDialogBinding extends BaseBinding<BaseDialogModel> {
    ...
    public void executeBindings() {
        ...
        if (((BaseDialogModel) t5).positiveBtnTextSize != 0) {
            this.positiveButton.setTextSize((float) ((BaseDialogModel) t5).positiveBtnTextSize);
        }
        T t6 = this.viewModel;
        ...
        if (((BaseDialogModel) t8).negativeBtnTextSize != 0) {
            this.positiveButton.setTextSize((float) ((BaseDialogModel) t8).negativeBtnTextSize);
        }
