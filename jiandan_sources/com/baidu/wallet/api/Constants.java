...
public final class Constants {
    ...
    public static final double HALF_HIDE_ACTIONBAR = 1.0d;
    public static final String HALF_LIGHTBRIDGE_HEIGHT = "view_height";
    public static final String HALF_LIGHTBRIDGE_HIDE_ACTIONBAR = "isHideActionBar";
    public static final String HALF_LIGHTBRIDGE_TRANSLUCENCY_COLOR = "translucencyColor";
    ...
    public static final double NOT_HALF_LIGHT_BRIDGE = -0.0d;
