...
public class DxmLoginHelper extends LoginHelperProxy {
    ...
    public IWalletLoginListener c;
    public Context d;
    public IWalletListener e;

    public static class a {
        public static final DxmLoginHelper a = new DxmLoginHelper();
    }
    ...
    public void configPass(Context context) {
        ...
        DxmAccountManager.getInstance().dxmInitSdk(initialShareStrategy.smsLoginConfig(new SapiConfiguration.SmsLoginConfig(switchR, switchR, switchR)).configurableViewLayout(Switch.ON).setSupportFaceLogin(false).sofireSdkConfig("600000", "69a0826db896e8c99e5d7bf63a14de3d", 600000).debug(z).build(), new DxmSapiConiguration.Builder(context).setProductCode("100001").build(), WalletLoginHelper.getInstance().getTpl());
    }
        ...
        if (bdussState == 2 || bdussState == 4) {
            syncLoginStatus(context, "", new WalletApiExtListener.SyncLoginStatusCb() {
                public void onResult(WalletApiExtListener.SyncLoginStatusCb.SyncResult syncResult) {
                    String a2 = DxmLoginHelper.this.b;
    ...
    public DxmLoginHelper() {
        this.b = DxmLoginHelper.class.getSimpleName();
    }
