    ...
    public void e() {
        ...
        if (TextUtils.isEmpty(this.a.need_unlock_url)) {
            ...
            onClickListener = new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    if (!dVar.c) {
                        ...
                        try {
                            a aVar = new a(d.this.x.getContext());
            ...
            onClickListener = new View.OnClickListener() {
                public void onClick(View view) {
                    if (!d.this.c) {
                        SDKJumpManager.getInstance().doSDKJump(d.this.x.getContext(), "", "1", d.this.a.need_unlock_url, true, (SDKJumpManager.OnJumpListener) null);
                        d.this.a("");
                    }
                }
            };
