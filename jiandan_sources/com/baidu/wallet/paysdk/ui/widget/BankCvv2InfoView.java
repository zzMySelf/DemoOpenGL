...
public class BankCvv2InfoView extends LinearLayout {
    ...
    private void a() {
        ...
        this.b = (TextView) findViewById(ResUtils.id(getContext(), "ebpay_cvv2_tip"));
        ...
        this.c = (ImageView) findViewById(ResUtils.id(getContext(), "date_tip_img"));
        this.mCvvTip = (ImageView) findViewById(ResUtils.id(getContext(), "cvv_tip_img"));
        this.d = (BankCardErrorMsgView) findViewById(ResUtils.id(getContext(), "wallet_bindcard_credit_error_date"));
        this.e = (BankCardErrorMsgView) findViewById(ResUtils.id(getContext(), "wallet_bindcard_credit_error_cvv2"));
    ...
    public void hideErrorLayout() {
        BankCardErrorMsgView bankCardErrorMsgView = this.e;
        if (bankCardErrorMsgView != null) {
            bankCardErrorMsgView.showErrorLayout("", "");
            a.a(this.mCvv2, false, false);
        }
        BankCardErrorMsgView bankCardErrorMsgView2 = this.d;
    ...
    public void hideErrorLayoutWithTag(View view, boolean z) {
        ...
        if (view == this.mCvv2) {
            bankCardErrorMsgView = this.e;
        } else {
            bankCardErrorMsgView = view == this.mDate ? this.d : null;
        }
        if (bankCardErrorMsgView != null) {
            bankCardErrorMsgView.showErrorLayout("", "");
            a.a(view, false, z);
