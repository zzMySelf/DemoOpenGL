...
public abstract class HalfProtocolScreenBaseActivity extends PayBaseActivity {
    ...
    private void a() {
        int size;
        if (a > 1 && BaseActivity.mActivityStack.size() - 2 >= 0 && (BaseActivity.mActivityStack.get(size) instanceof HalfProtocolScreenBaseActivity)) {
    ...
    private void b() {
        ...
        if (a > 1) {
            ...
            i2 = ResUtils.drawable(this, "wallet_base_new_bind_card_halfscreen_actionbar_close");
