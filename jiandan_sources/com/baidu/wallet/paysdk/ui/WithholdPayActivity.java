...
public class WithholdPayActivity extends PayBaseActivity implements View.OnClickListener {
    ...
    private void d() {
        ...
        this.m.setCompoundDrawables(drawable, (Drawable) null, (Drawable) null, (Drawable) null);
    }
    ...
    public void onClick(View view) {
        ...
        if (id == ResUtils.id(this, "tv_sp_action")) {
            ...
            c();
        } else if (id == ResUtils.id(this, "rl_auth_pay_button") && (payRequest = (PayRequest) PayRequestCache.getInstance().getBeanRequestFromCache(DxmPayBeanConstants.REQUEST_ID_PAY)) != null) {
            String str = this.f3625i.isChecked() ? "1" : "0";
    ...
    public void refreshUI() {
        ...
        if (payRequest != null && payRequest.withholding != null) {
            ...
            if (!TextUtils.isEmpty(orderPrice)) {
                str = String.format(this.u, new Object[]{StringUtils.fen2Yuan(orderPrice)});
            } else {
                str = "";
            }
            ...
            if (!payRequest.showCouponListEntry() || !z2) {
                ...
                textView2.setText(discountMsg);
                TextView textView3 = this.d;
                if (!TextUtils.isEmpty(discountAmount)) {
                    str5 = String.format(this.v, new Object[]{StringUtils.fen2Yuan(discountAmount)});
                } else {
                    str5 = "";
                }
            ...
            if (!TextUtils.isEmpty(bigDecimal3)) {
                str2 = String.format(this.u, new Object[]{StringUtils.fen2Yuan(bigDecimal3)});
            } else {
                str2 = "";
            }
            if (str2.length() > 0) {
            ...
            if (!TextUtils.isEmpty(payRequest.withholding.sp_company)) {
                str3 = payRequest.withholding.sp_company;
            } else {
                str3 = "";
            }
            textView4.setText(str3);
            TextView textView5 = this.h;
            if (!TextUtils.isEmpty(payRequest.withholding.authorize_action_desc)) {
                str4 = payRequest.withholding.authorize_action_desc;
            } else {
                str4 = "";
            }
            ...
            if (agreementInfoArr != null && agreementInfoArr.length >= 1) {
                if (!TextUtils.isEmpty(agreementInfoArr[0].title)) {
                    String str6 = payRequest.withholding.agreement_info[0].title;
                    this.s = str6;
                    this.p.setText(str6);
                }
            ...
            if (TextUtils.isEmpty(payRequest.withholding.agreement_tag) || !"1".equals(payRequest.withholding.agreement_tag)) {
                z = false;
            }
            this.q = z;
            setProtocalCheck(z);
    ...
    public void setAuthSwitch(boolean z) {
        this.f3625i.setChecked(z);
        a(z, false);
    }

    public void setProtocalCheck(boolean z) {
        this.f3626o.setChecked(z);
        this.l.setEnabled(z);
    }
    ...
    private void a() {
        ...
        this.f3625i = (SwitchButton) findViewById(ResUtils.id(this, "sb_auth_switch"));
        ...
        this.f3626o = (CheckBox) findViewById(ResUtils.id(this, "cb_protocol"));
        ...
        this.f3625i.setOnCheckedListener(new SwitchButton.a() {
            public void a(boolean z) {
                WithholdPayActivity.this.a(z, true);
                WithholdPayActivity.this.f3625i.setChecked(z);
            }
        });
        this.f3626o.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
