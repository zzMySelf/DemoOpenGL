...
public class EnterWalletGetPayMethodAction implements RouterAction {
    public static final String TAG = "EnterWalletGetPayMethodAction";
    public long a;
    ...
    public void invoke(Context context, HashMap hashMap, RouterCallback routerCallback) {
        if (context != null && hashMap != null && hashMap.containsKey("options") && (hashMap.get("options") instanceof String)) {
            if (!a()) {
                NaMethodStatUtils.statEnter("getPayMethod", "");
            }
    ...
    private void a(Context context, String str, final RouterCallback routerCallback) {
        BaiduPayDelegate.getInstance().getPayMethod(context, str, (IPrecashierCallback) new IPrecashierCallback() {
            public void onResult(String str) {
                ...
                EnterWalletGetPayMethodAction.this.a(str);
            }
        });
    }
    ...
    public void a(String str) {
        try {
            ...
            if (optInt == 0) {
                NaMethodStatUtils.statResult("getPayMethod", optInt, "");
                return;
            }
            JSONObject jSONObject2 = new JSONObject(new String(Base64Utils.decode(jSONObject.optJSONObject("cnt").optString("data", ""))));
            NaMethodStatUtils.statResult("getPayMethod", jSONObject2.optString("errCode", ""), jSONObject2.optString("des", ""));
