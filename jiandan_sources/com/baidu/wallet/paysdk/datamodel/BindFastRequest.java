...
public class BindFastRequest extends BeanRequestBase implements Serializable {
    ...
    public String mIdCardEndDate;
    public String mIdCardSartDate;
    public DxmJob mJob;
    public String mName;
    ...
    public boolean checkRequestValidity() {
        /*
            r2 = this;
            java.lang.String r0 = r2.mBankCard
            boolean r0 = android.text.TextUtils.isEmpty(r0)
            if (r0 == 0) goto L_0x0017
            com.baidu.wallet.paysdk.datamodel.GetCardInfoResponse r0 = r2.mBankInfo
            if (r0 == 0) goto L_0x0015
            com.baidu.wallet.paysdk.datamodel.GetCardInfoResponse$CardInfo r1 = r0.card_info
            if (r1 == 0) goto L_0x0015
            com.baidu.wallet.paysdk.datamodel.GetCardInfoResponse$ChannelInfo r0 = r0.channel_info
            if (r0 == 0) goto L_0x0015
            goto L_0x0017
        L_0x0015:
            r0 = 0
        ...
        L_0x0018:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.wallet.paysdk.datamodel.BindFastRequest.checkRequestValidity():boolean");
    }

    public DxmAddress getAddress() {
    ...
    public java.lang.String getChannelNo() {
        /*
            r1 = this;
            java.lang.String r0 = r1.mChannelNo
            boolean r0 = android.text.TextUtils.isEmpty(r0)
            if (r0 != 0) goto L_0x000b
            java.lang.String r0 = r1.mChannelNo
            return r0
        L_0x000b:
            com.baidu.wallet.paysdk.datamodel.GetCardInfoResponse r0 = r1.mBankInfo
            if (r0 == 0) goto L_0x0016
            com.baidu.wallet.paysdk.datamodel.GetCardInfoResponse$ChannelInfo r0 = r0.channel_info
            if (r0 == 0) goto L_0x0016
            java.lang.String r0 = r0.channel_no
            return r0
        L_0x0016:
            java.lang.String r0 = ""
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.wallet.paysdk.datamodel.BindFastRequest.getChannelNo():java.lang.String");
    }
    ...
    public String getIdCardEndDate() {
        return this.mIdCardEndDate;
    }

    public String getIdCardSartDate() {
        return this.mIdCardSartDate;
    }

    public DxmJob getJob() {
        return this.mJob;
    }
    ...
    public String getSendSmsTips() {
        return this.mSendSmsTips;
    }

    public String getSendSmsphone() {
        if (TextUtils.isEmpty(this.send_sms_phone)) {
            return "";
        }
        return this.send_sms_phone;
    }
    ...
    public void setAddress(DxmAddress dxmAddress) {
        this.mAddress = dxmAddress;
    }
    ...
    public void setIdCardEndDate(String str) {
        this.mIdCardEndDate = str;
    }

    public void setIdCardSartDate(String str) {
        this.mIdCardSartDate = str;
    }

    public void setJob(DxmJob dxmJob) {
        this.mJob = dxmJob;
    }
    ...
    public void setSendSmsTips(String str) {
        this.mSendSmsTips = str;
    }
    ...
    public static String getCardRequestType(int i2) {
        ...
        if (i2 == 3 || i2 == 4) {
            return PayRequestCache.getInstance().isPaying() ? BannerBaseItemInfo.TYPE_LOGIN : "4";
        }
        if (i2 == 5) {
