...
public abstract class DxmPayBeanConstants {
    ...
    public static final String API_AUTHORIZE_ORDER = "/cashdesk/authorize/wireless/cashier";
    public static final String API_AUTH_SIGN_URL = (DomainConfig.getInstance().getAppPayHost() + "/cashdesk/authorize/wap/cashier/?is_from_sdk=1");
    public static final String API_BANKSING_BIND_CARD = "/cashdesk/wireless/banksign/bindcard";
    public static final String API_BANKSING_GET_JUMP_URL = "/cashdesk/wireless/banksign/getjumpurl";
    public static final String API_BANKSING_POLLING = "/cashdesk/wireless/banksign/polling";
    public static final String API_BANKSING_QUERY = "/cashdesk/wireless/banksign/query";
    public static final String API_BANK_CARD_LIST_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/list/#/index?is_from_sdk=1");
    public static final String API_BIND_CARD = "/_u/wireless/card_bind";
    public static final String API_BIND_CARD_COLLECT_USER_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/bindcard-plus/#/info");
    public static final String API_BIND_CARD_PROTOCOL = "/usercenter/protocol/protocol_preview";
    public static final String API_BIND_CARD_REVIEWING_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/under-review/?is_from_sdk=1");
    public static final String API_BIND_CARD_SAFE_TIP_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/bindcard-plus/#/privacy-security?is_from_sdk=1");
    public static final String API_BIND_CASHIER_PROTOCOL = "/cashdesk/wireless/protocol/preview";
    public static final String API_CALC_PAYMENT = "/cashdesk/wireless/calmktpay";
    ...
    public static final String API_CHECK_MOBILE_PWD = "/usercenter/pwd/check_for_modify";
    ...
    public static final String API_DO_PAY = "/cashdesk/wireless/pay";
    ...
    public static final String API_FIND_PAY_PWD_URL = (DomainConfig.getInstance().getAppPayHost() + "/static/wap/findpass/?is_from_sdk=1#/home");
    public static final String API_GET_AB_TEST = "/mobile_abtest";
    public static final String API_GET_ADDRESS_INFO = "/usercenter/compliance/get_address_info";
    public static final String API_GET_CARD_INFO = "/_u/wireless/card_info";
    public static final String API_GET_JOB_INFO = "/usercenter/compliance/get_job_list";
    public static final String API_GET_PAY_ORDER = "/cashdesk/wireless/cashier/direct";
    public static final String API_GET_PAY_ORDER_CHARGE = "/cashdesk/wireless/cashier/reservable";
    public static final String API_GET_PAY_ORDER_PREPAY = "/cashdesk/wireless/cashier/cashdeskcode";
    ...
    public static final String API_H5_BIND_CARD_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/bindcard-plus/?service_type=");
    ...
    public static final String API_LICAI_BALANCE_PAY = "/cashdesk/wireless/fund/combine/pay";
    public static final String API_MODIFY_MOBILE_PWD = "/usercenter/pwd/modify";
    public static final String API_PAY_AUTH_SIGN_URL = (DomainConfig.getInstance().getAppPayHost() + "/payfe/cashdesk-wap/entry/auth/?is_from_sdk=1");
    public static final String API_PAY_H5_CASHIER_URL = (DomainConfig.getInstance().getAppPayHost() + "/api/0/pay/0/wapdirect?is_from_sdk=1");
    public static final String API_PAY_H5_CHARGE_URL = (DomainConfig.getInstance().getAppPayHost() + "/api/0/pay/0/wapreservable/0/?is_from_sdk=1");
    public static final String API_PAY_PWD_SETTING_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/station/entry/safe/#/pwd?is_from_sdk=1");
    public static final String API_PAY_SECURITY_CENTER_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/station/entry/safe/#/paysafe?is_from_sdk=1");
    public static final String API_PAY_SETTING_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/station/entry/safe/#/payset?is_from_sdk=1");
    ...
    public static final String API_PRECASHIER_LICAI_FUND_DISPLAY = "/cashdesk/wireless/fund/display";
    ...
    public static final String API_QUERY_OFFLINE_PAY = "/cashdesk/wireless/transstate";
    public static final String API_QUERY_TRANS_EASY = "/cashdesk/wireless/transstate";
    public static final String API_QUICK_BIND_CARD_URL = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/h5-wallet-card/entry/bindcard-plus/#/fast?");
    ...
    public static final String API_SECUITY_CENTER = "/usercenter/securitycenter/main";
    public static final String API_SIGN_CALC_PAYMENT = "/cashdesk/authorize/wireless/calmktpay";
    public static final String API_SIGN_CARD_CHECK = "/cashdesk/authorize/wireless/cardcheck";
    public static final String API_SIGN_CARD_INFO = "/cashdesk/authorize/wireless/cardinfo";
    public static final String API_SIGN_CHANNEL_QUERY = "/wireless/0/pay_bank_query/0";
    public static final String API_SIGN_CONTRACT_PAY = "/cashdesk/authorize/wireless/pay";
    public static final String API_SIGN_CONTRACT_VERIFY_SMS = "/cashdesk/authorize/wireless/verifysms";
    ...
    public static final String API_WALLET_BALANCE_HOME_PATH = (DomainConfig.getInstance().getAppPayHost() + "/usercenter/static/station/entry/life/");
    public static final String API_WALLET_SCANCODE = (DomainConfig.getInstance().getAppPayHost() + "/payfe/o2o/entry/b2c/?is_from_sdk=1");
    ...
    public static final String EV_H5_BIND_CARD_DATA_SUBMIT = "ev_h5_bind_card_data_submit";
    ...
    public static final String TRANSACTION_RECORDS_URL = (DomainConfig.getInstance().getAppPayHost() + "/static/webapp/transaction/index.html");
    public static final String UNABLE_RECEIVE_SMSTIP = "unable_receive_smstip";
    public static final String UPDATE_COMPLIANCE_TIP = "update_compliance_tip";
    public static final String UPDATE_MOBILE_DESC = "update_mobile_desc";
    public static String VERSION_NO = "11.3.5.106";
