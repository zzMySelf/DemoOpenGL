...
public class LightappConstants implements NoProguard {
    ...
    public static final String ERRCODE_FILE_SIZE_TOO_LARGE = "10011";
    ...
    public static final String ERRCODE_PERMISSION_REFUSE_AND_NO_REMINDER = "10015";
    ...
    public static final String LIGHT_APP_NATIVE_INVOKER_EXTRA_PARAM = "extraParam";
    ...
    public static final String LIGHT_APP_NATIVE_INVOKER_PASSWORD = "password";
    public static final String LIGHT_APP_NATIVE_INVOKER_SERVICE_NAME = "serviceName";
    public static final String LIGHT_APP_NATIVE_INVOKER_USER_NAME = "user_name";
    public static final String METHOD_INVOKE_BD_WALLET_NATIVE = "invokeBdWalletNative";
    public static final double MIN_HALF_LIGHT_BRIDGE_HEIGHT_RATIO = 0.9d;
    public static final String[] NATIVE_METHOD_LIST = {"selectPhonefromAdressBook", LightappBusinessClient.METHOD_GET_USER_AGENT, LightappJsNativeClient.METHOD_GET_DEVIDE_INFO, LightappJsNativeClient.METHOD_CLOSE_WINDOW, LightappJsNativeClient.METHOD_GET_CURRENT_POSITION, LightappJsNativeClient.METHOD_CALL_SHARE};
