...
public final class LightAppStatEvent {
    ...
    public static final String LIGHT_APP_ACCEPT_MESSAGE_FROM_LANG = "#acceptMessageFromLangBridge";
    ...
    public static final String LIGHT_APP_ENTER_BACKGROUND = "LightAppEnterBackground";
    ...
    public static final String LIGHT_APP_FETCH_FILE_SIZE = "FetchFileSize";
    public static final String LIGHT_APP_FILE_CHOOSER_INTENT_FAIL = "#file_chooser_intent_invalid";
    public static final String LIGHT_APP_HOST_IS_IP_ADDRESS = "#hostIsIpAddress";
    ...
    public static final String LIGHT_APP_NA_ACCEPT_MESSAGE_FROM_LANG = "#NAacceptMessageFromLangBridge";
    ...
    public static final String LIGHT_APP_REPETITION_LOAD_URL = "#repetitionLoadURL";
    ...
    public static final String LIGHT_INVOKE_BDWALLET_DIFFERENT_FROM_URL = "#DifferentFromURL";
    ...
    public static final String MTD_CALL_BD_WALLET_PAGE_BACK = "#onBDWalletPageBack";
    public static final String MTD_CALL_BD_WALLET_PAGE_CLOSE = "#onBDWalletPageClose";
