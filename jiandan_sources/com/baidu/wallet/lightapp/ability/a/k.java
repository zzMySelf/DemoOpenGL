...
public class k extends b {
    ...
    public void a(Activity activity, String str, final ILightappInvokerCallback iLightappInvokerCallback, final String str2) {
        if (iLightappInvokerCallback != null) {
            LocalRouter.getInstance(DxmApplicationContextImpl.getApplicationContext(activity)).route(activity, new RouterRequest().provider("dxmPay").action("enterPreOrderPay").data("options", str), new RouterCallback() {
                public void onResult(int i2, HashMap hashMap) {
                    if (i2 != 0) {
                        ...
                        kVar.a(iLightappInvokerCallback, str2, num, str, "##preOrderPayFail");
