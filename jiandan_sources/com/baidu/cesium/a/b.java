...
public class b implements Serializable, Cloneable {
    ...
    public transient boolean f728i = false;
    ...
    public void d(b bVar) {
        ...
        int i5 = bVar.h;
        if (min < i5) {
            System.arraycopy(bVar.g, min, this.g, min, i5 - min);
        }
        i();
        h();
    }
