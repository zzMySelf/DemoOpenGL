...
public class d {
    ...
    public static Object ad(Class<?> cls, Object[] objArr) {
        return (objArr == null || objArr.length <= 0) ? cls.newInstance() : rg(cls, objArr);
    }
    ...
    public static Method fe(Class<?> cls, String str, Class<?>[] clsArr) {
        Method declaredMethod = cls.getDeclaredMethod(str, clsArr);
        declaredMethod.setAccessible(true);
        return declaredMethod;
    }

    public static Class<?> qw(Class<?> cls) {
    ...
    public static Object rg(Class<?> cls, Object[] objArr) {
