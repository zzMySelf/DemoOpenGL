...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        public void dump(androidx.constraintlayout.motion.widget.MotionScene r10, java.lang.StringBuilder r11) {
            /*
                r9 = this;
                java.lang.Class<androidx.constraintlayout.widget.ConstraintSet$Layout> r0 = androidx.constraintlayout.widget.ConstraintSet.Layout.class
            ...
            L_0x000c:
                ...
                goto L_0x007b
            L_0x0020:
                java.lang.Object r4 = r2.get(r9)     // Catch:{ IllegalAccessException -> 0x0077 }
                java.lang.Class r2 = r2.getType()     // Catch:{ IllegalAccessException -> 0x0077 }
                java.lang.Class r5 = java.lang.Integer.TYPE     // Catch:{ IllegalAccessException -> 0x0077 }
                java.lang.String r6 = "\"\n"
                java.lang.String r7 = " = \""
                java.lang.String r8 = "    "
                if (r2 != r5) goto L_0x0057
                java.lang.Integer r4 = (java.lang.Integer) r4     // Catch:{ IllegalAccessException -> 0x0077 }
                int r2 = r4.intValue()     // Catch:{ IllegalAccessException -> 0x0077 }
                r5 = -1
                if (r2 == r5) goto L_0x007b
                int r2 = r4.intValue()     // Catch:{ IllegalAccessException -> 0x0077 }
                java.lang.String r2 = r10.lookUpConstraintName(r2)     // Catch:{ IllegalAccessException -> 0x0077 }
                r11.append(r8)     // Catch:{ IllegalAccessException -> 0x0077 }
                r11.append(r3)     // Catch:{ IllegalAccessException -> 0x0077 }
                r11.append(r7)     // Catch:{ IllegalAccessException -> 0x0077 }
                if (r2 != 0) goto L_0x004f
                goto L_0x0050
            L_0x004f:
                r4 = r2
            L_0x0050:
                r11.append(r4)     // Catch:{ IllegalAccessException -> 0x0077 }
                r11.append(r6)     // Catch:{ IllegalAccessException -> 0x0077 }
                goto L_0x007b
            L_0x0057:
                java.lang.Class r5 = java.lang.Float.TYPE     // Catch:{ IllegalAccessException -> 0x0077 }
                if (r2 != r5) goto L_0x007b
                java.lang.Float r4 = (java.lang.Float) r4     // Catch:{ IllegalAccessException -> 0x0077 }
                float r2 = r4.floatValue()     // Catch:{ IllegalAccessException -> 0x0077 }
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                "id unknown " + Debug.getName(childAt);
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                ...
                if (this.mConstraints.containsKey(Integer.valueOf(id))) {
                    ...
                    "WARNING NO CONSTRAINTS for view " + id;
                }
            }
        }
    ...
    public void center(int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f) {
        ...
        if (i5 < 0) {
            ...
            int i10 = i2;
            connect(i10, 1, i3, i4, i5);
            connect(i10, 2, i6, i7, i8);
            this.mConstraints.get(Integer.valueOf(i2)).layout.horizontalBias = f2;
        } else if (i9 == 6 || i9 == 7) {
            int i11 = i2;
            connect(i11, 6, i3, i4, i5);
            connect(i11, 7, i6, i7, i8);
            this.mConstraints.get(Integer.valueOf(i2)).layout.horizontalBias = f2;
        } else {
            int i12 = i2;
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i2 = 0; i2 < splitString.length; i2++) {
            ...
            " Unable to parse " + splitString[i2];
