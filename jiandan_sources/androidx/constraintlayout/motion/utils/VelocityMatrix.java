...
public class VelocityMatrix {
    ...
    public void applyTransform(float f, float f2, int i2, int i3, float[] fArr) {
        ...
        double d = (double) (((float) i3) * f6);
        fArr[0] = f9 + (((float) ((((double) (((float) (-i4)) * f5)) * Math.sin(radians2)) - (Math.cos(radians2) * d))) * radians);
        fArr[1] = f10 + (radians * ((float) ((((double) (((float) i4) * f5)) * Math.cos(radians2)) - (d * Math.sin(radians2)))));
    }
