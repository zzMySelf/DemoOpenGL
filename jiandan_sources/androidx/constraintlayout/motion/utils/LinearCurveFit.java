    ...
    private double getLength2D(double d) {
        ...
        while (i3 < i2) {
            ...
            if (d < dArr3[i4]) {
                ...
                double d8 = 1.0d - d7;
                return d2 + Math.hypot(d6 - ((dArr4[i3][1] * d8) + (dArr4[i4][1] * d7)), d5 - ((dArr4[i3][0] * d8) + (dArr4[i4][0] * d7)));
            }
            i3 = i4;
            d3 = d5;
            d4 = d6;
    ...
    public void getPos(double d, double[] dArr) {
        ...
        while (i5 < i4) {
            ...
            if (d < dArr3[i7]) {
                ...
                while (i2 < length2) {
                    double[][] dArr4 = this.mY;
                    dArr[i2] = (dArr4[i5][i2] * (1.0d - d2)) + (dArr4[i7][i2] * d2);
                    i2++;
                }
                return;
            }
    ...
    public void getPos(double d, float[] fArr) {
        ...
        while (i5 < i4) {
            ...
            if (d < dArr2[i7]) {
                ...
                while (i2 < length2) {
                    double[][] dArr3 = this.mY;
                    fArr[i2] = (float) ((dArr3[i5][i2] * (1.0d - d2)) + (dArr3[i7][i2] * d2));
                    i2++;
                }
                return;
            }
    ...
    public double getPos(double d, int i2) {
        ...
        while (i3 < i4) {
            ...
            if (d < dArr2[i5]) {
                ...
                double[][] dArr3 = this.mY;
                return (dArr3[i3][i2] * (1.0d - d2)) + (dArr3[i5][i2] * d2);
            }
            i3 = i5;
        }
        return 0.0d;
