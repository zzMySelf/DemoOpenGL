...
public class MotionScene {
    ...
    private void load(android.content.Context r9, int r10) {
        ...
        L_0x0017:
            ...
            boolean r5 = r8.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
        ...
        L_0x0087:
            goto L_0x0128
        L_0x0089:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            java.util.ArrayList r3 = r1.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x0097:
            r8.parseConstraintSet(r9, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x009c:
            androidx.constraintlayout.widget.StateSet r2 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r8.mStateSet = r2     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x00a5:
            r1.addOnClick(r9, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x00aa:
        ...
        L_0x00d5:
            androidx.constraintlayout.motion.widget.TouchResponse r2 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            androidx.constraintlayout.motion.widget.MotionLayout r3 = r8.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r2.<init>(r9, r3, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r1.mTouchResponse = r2     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x00e0:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r2 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            ...
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r1 != 0) goto L_0x0109
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r1 != 0) goto L_0x0109
            r8.mCurrentTransition = r2     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r2 == 0) goto L_0x0109
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r2.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r1 == 0) goto L_0x0109
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            boolean r3 = r8.mRtl     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r1.setRTL(r3)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
        L_0x0109:
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r1 == 0) goto L_0x0122
            int r1 = r2.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            if (r1 != r6) goto L_0x0118
            r8.mDefaultTransition = r2     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x011d
        L_0x0118:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
        L_0x011d:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
        ...
        L_0x0122:
            ...
            goto L_0x013c
        L_0x0124:
            r8.parseMotionSceneTags(r9, r0)     // Catch:{ XmlPullParserException -> 0x0147, IOException -> 0x0142 }
            goto L_0x013c
        L_0x0128:
    ...
    private void readConstraintChain(int i2) {
        ...
        if (i3 > 0) {
            ...
            if (constraintSet2 == null) {
                "ERROR! invalid deriveConstraintsFrom: @id/" + Debug.getName(this.mMotionLayout.getContext(), i3);
                return;
            }
    ...
    public ConstraintSet getConstraintSet(int i2, int i3, int i4) {
        ...
        "Warning could not find ConstraintSet id/" + Debug.getName(this.mMotionLayout.getContext(), i2) + " In MotionScene";
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i2, Transition transition) {
                ...
                if (view == null) {
                    "OnClick could not find id " + this.mTargetId;
                    return;
                }
                ...
                boolean z = true;
                boolean z2 = ((this.mMode & 1) != 0 && i2 == access$100) | ((this.mMode & 1) != 0 && i2 == access$100) | ((this.mMode & 256) != 0 && i2 == access$100) | ((this.mMode & 16) != 0 && i2 == access$000);
                if ((this.mMode & 4096) == 0 || i2 != access$000) {
                    z = false;
                }
                if (z2 || z) {
                    view.setOnClickListener(this);
            ...
            public boolean isTransitionViable(Transition transition, MotionLayout motionLayout) {
                ...
                if (access$100 != -1) {
                    ...
                    if (i2 == access$100 || i2 == access$000) {
                        return true;
                    }
                    return false;
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                if (i2 != -1) {
                    ...
                    if (findViewById == null) {
                        " (*)  could not find id " + this.mTargetId;
                        return;
                    }
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (ResUtils.c.equals(context.getResources().getResourceTypeName(this.mConstraintSetEnd))) {
                    ...
                    if (ResUtils.c.equals(context.getResources().getResourceTypeName(this.mConstraintSetStart))) {
