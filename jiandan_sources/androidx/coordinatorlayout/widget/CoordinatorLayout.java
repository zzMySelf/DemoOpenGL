...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private int getKeyline(int i2) {
        ...
        if (iArr == null) {
            "No keylines defined for " + this + " - attempted index lookup " + i2;
            return 0;
        } else if (i2 >= 0 && i2 < iArr.length) {
            return iArr[i2];
        } else {
            "Keyline index " + i2 + " out of range for " + this;
            return 0;
        }
    }
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i6) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    i9 = i7;
                    if (i5 > 0) {
                        i8 = Math.max(i10, this.mBehaviorConsumed[1]);
                    } else {
                        i8 = Math.min(i10, this.mBehaviorConsumed[1]);
                    }
                    i10 = i8;
                    z = true;
                }
