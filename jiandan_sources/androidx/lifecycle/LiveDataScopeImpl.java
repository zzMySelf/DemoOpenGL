...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    public LiveDataScopeImpl(@NotNull CoroutineLiveData<T> coroutineLiveData, @NotNull CoroutineContext coroutineContext2) {
        ...
        this.coroutineContext = coroutineContext2.plus(u.de().xxx());
    }

    @Nullable
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
        return o.yj(this.coroutineContext, new LiveDataScopeImpl$emit$2(this, t, (Continuation) null), continuation);
    }

    @Nullable
    public Object emitSource(@NotNull LiveData<T> liveData, @NotNull Continuation<? super DisposableHandle> continuation) {
        return o.yj(this.coroutineContext, new LiveDataScopeImpl$emitSource$2(this, liveData, (Continuation) null), continuation);
    }
