...
public final class DispatchQueue {
    ...
    public final void runOrEnqueue(@NotNull Runnable runnable) {
        z0 xxx = u.de().xxx();
        if (xxx.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
            xxx.dispatch(EmptyCoroutineContext.INSTANCE, new DispatchQueue$runOrEnqueue$$inlined$with$lambda$1(this, runnable));
        } else {
            enqueue(runnable);
        }
    }
