...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public /* synthetic */ CoroutineLiveData(CoroutineContext coroutineContext, long j, Function2 function2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i2 & 2) != 0 ? CoroutineLiveDataKt.DEFAULT_TIMEOUT : j, function2);
    }
    ...
    public CoroutineLiveData(@NotNull CoroutineContext coroutineContext, long j, @NotNull Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        long j2 = j;
        this.blockRunner = new BlockRunner(this, function22, j2, j.qw(u.de().xxx().plus(coroutineContext).plus(j1.qw((Job) coroutineContext.get(Job.f6325fe)))), new Function0<Unit>(this) {
