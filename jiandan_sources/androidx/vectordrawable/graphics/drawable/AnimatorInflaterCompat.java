...
public class AnimatorInflaterCompat {
    ...
    public static void distributeKeyframes(Keyframe[] keyframeArr, float f, int i2, int i3) {
    ...
    public static int inferValueTypeFromValues(TypedArray typedArray, int i2, int i3) {
        ...
        if ((!z2 || !isColorType(i4)) && (!z || !isColorType(i5))) {
            return 0;
        }
        return 3;
    }
    ...
    public static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f, XmlPullParser xmlPullParser) {
