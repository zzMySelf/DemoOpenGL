...
public class AppCompatTextHelper {
                    ...
                    Typeface font = tintTypedArray.getFont(i2, this.mStyle, new ResourcesCompat.FontCallback() {
                        ...
                        public void onFontRetrieved(@NonNull Typeface typeface) {
                            ...
                            if (Build.VERSION.SDK_INT >= 28 && (i2 = i4) != -1) {
                                typeface = Typeface.create(typeface, i2, (i5 & 2) != 0);
                            }
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet2, R.styleable.AppCompatTextHelper, i4, 0);
        TextView textView = this.mView;
        ...
        TintTypedArray obtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(context, attributeSet2, R.styleable.TextAppearance, i4, 0);
        ...
        this.mAutoSizeTextHelper.loadFromAttributes(attributeSet2, i4);
