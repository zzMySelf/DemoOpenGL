...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int i2) {
        ...
        if (i2 != i3) {
            ...
            } else if (i3 == 2 && (view = this.mTabView) != null && view.getParent() == (toolbar2 = this.mToolbar)) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i2, long j) {
        return ViewCompat.animate(this.mToolbar).alpha(i2 == 0 ? 1.0f : 0.0f).setDuration(j).setListener(new ViewPropertyAnimatorListenerAdapter() {
