...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
        ...
        if (IS_PRE_LOLLIPOP && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                private boolean shouldWrapException(Throwable th2) {
                    ...
                    if (message.contains(ResUtils.e) || message.contains("Drawable")) {
                        return true;
                    }
                    return false;
                }
    ...
    private boolean onKeyUpPanel(int i2, KeyEvent keyEvent) {
        ...
        if (i2 == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
            ...
            z2 = z3;
            if (z2 && (audioManager = (AudioManager) this.mContext.getApplicationContext().getSystemService(MediaType.AUDIO_TYPE)) != null) {
                audioManager.playSoundEffect(0);
            }
            return z2;
    ...
    public boolean hasWindowFeature(int i2) {
        ...
        if (z || this.mWindow.hasFeature(i2)) {
            return true;
        }
        return false;
    }
