...
public class TableInfo {
    ...
    public static class Column {
        ...
        public boolean equals(Object obj) {
            ...
            if ((i2 == 0 || i2 != column.mCreatedFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : str.equals(column.defaultValue))) && this.affinity == column.affinity) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            return "Column{name='" + this.name + ExtendedMessageFormat.QUOTE + ", type='" + this.type + ExtendedMessageFormat.QUOTE + ", affinity='" + this.affinity + ExtendedMessageFormat.QUOTE + ", notNull=" + this.notNull + ", primaryKeyPosition=" + this.primaryKeyPosition + ", defaultValue='" + this.defaultValue + ExtendedMessageFormat.QUOTE + ExtendedMessageFormat.END_FE;
        }
    ...
    public static class Index {
        ...
        public int hashCode() {
            ...
            return (((i2 * 31) + (this.unique ? 1 : 0)) * 31) + this.columns.hashCode();
        }
