            ...
            if (i2 < 0 || i2 >= state.getItemCount()) {
                ...
                if (savedState != null && savedState.hasValidAnchor()) {
                    ...
                    if (findViewByPosition == null) {
                        ...
                        if (anchorInfo.mLayoutFromEnd) {
                            i3 = this.mOrientationHelper.getDecoratedEnd(findViewByPosition) + this.mOrientationHelper.getTotalSpaceChange();
                        } else {
                            i3 = this.mOrientationHelper.getDecoratedStart(findViewByPosition);
                        }
                        anchorInfo.mCoordinate = i3;
                    }
                    return true;
                } else {
