...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public boolean isPointInsideHorizontalThumb(float f, float f2) {
        if (f2 >= ((float) (this.mRecyclerViewHeight - this.mHorizontalThumbHeight))) {
            ...
            return f >= ((float) (i2 - (i3 / 2))) && f <= ((float) (i2 + (i3 / 2)));
        }
    }
    ...
    public void updateScrollPosition(int i2, int i3) {
        ...
        if (this.mNeedVerticalScrollbar || z) {
            if (this.mNeedVerticalScrollbar) {
                float f = (float) i4;
                this.mVerticalThumbCenterY = (int) ((f * (((float) i3) + (f / 2.0f))) / ((float) computeVerticalScrollRange));
                this.mVerticalThumbHeight = Math.min(i4, (i4 * i4) / computeVerticalScrollRange);
            }
            if (this.mNeedHorizontalScrollbar) {
                float f2 = (float) i5;
                this.mHorizontalThumbCenterX = (int) ((f2 * (((float) i2) + (f2 / 2.0f))) / ((float) computeHorizontalScrollRange));
