        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (!this.mResizeClip) {
                ...
                if (i2 == 2) {
                    ...
                    animator = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath((float) i8, (float) i10, (float) i9, (float) i11));
                } else {
                    animator = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath((float) i4, (float) i6, (float) i5, (float) i7));
                }
            } else {
                view = view3;
                ...
                if (i4 == i5 && i6 == i7) {
                    ...
                    objectAnimator = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i4, (float) i6, (float) i5, (float) i7));
                }
                if (rect7 == null) {
                    i3 = 0;
