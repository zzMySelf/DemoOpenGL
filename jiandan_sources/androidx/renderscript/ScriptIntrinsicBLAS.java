...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public static void validateGEMV(Element element, int i2, Allocation allocation, Allocation allocation2, int i3, Allocation allocation3, int i4) {
        ...
        if (!allocation.getType().getElement().isCompatible(element) || !allocation2.getType().getElement().isCompatible(element) || !allocation3.getType().getElement().isCompatible(element)) {
            ...
            if (allocation2.getType().getX() != i5 || allocation3.getType().getX() != i6) {
    ...
    public static void validateGER(Element element, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        if (!allocation3.getType().getElement().isCompatible(element) || !allocation.getType().getElement().isCompatible(element) || !allocation2.getType().getElement().isCompatible(element)) {
            ...
            if (x < 1 || y < 1) {
                ...
                if (allocation.getType().getX() == ((y - 1) * i2) + 1) {
                    if (allocation2.getType().getX() != ((x - 1) * i3) + 1) {
        ...
        if ((allocation != null && !allocation.getType().getElement().isCompatible(element)) || ((allocation2 != null && !allocation2.getType().getElement().isCompatible(element)) || (allocation3 != null && !allocation3.getType().getElement().isCompatible(element)))) {
            ...
            if (allocation == null || allocation2 == null || allocation3 == null) {
                if (allocation == null || allocation3 == null) {
                    if (allocation != null && allocation2 != null && i11 != i7) {
    ...
    public static void validateSYR2K(Element element, int i2, Allocation allocation, Allocation allocation2, Allocation allocation3) {
        ...
        if (allocation3.getType().getX() != i3 || allocation3.getType().getY() != i3) {
    ...
    public static void validateTRMV(Element element, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (allocation.getType().getX() != y) {
            ...
            if (allocation2.getType().getX() != ((y - 1) * i5) + 1) {
    ...
    public void BNNM(Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3, int i4, int i5) {
        ...
        if (i6 < 0 || i6 > 255) {
            ...
            renderScript.nScriptIntrinsicBLAS_BNNM(getID(renderScript), y, y2, x, j3, i2, j2, i3, j, i4, i5, isIncSupp);
        }
    }
    ...
    public void CGEMM(int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        validateTranspose(i3);
        int i7 = i2;
        validateL3(Element.F32_2(this.mRS), i7, i3, 0, allocation, allocation2, allocation3);
        if (i7 != 111) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 125, i2, i3, 0, 0, 0, i8, i10, i9, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float22.x, float22.y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float22.x, float22.y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHEMM(int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 137, 0, 0, i2, i3, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER(int i2, float f, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 100, 0, 0, 0, i2, 0, 0, validateSYR, 0, f, 0.0f, j2, 0, 0.0f, 0.0f, j, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i2, Float2 float2, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i5 = i2;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i5, 0, 0, validateSYR2, 0, float22.x, float22.y, id2, id3, 0.0f, 0.0f, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateHER2K(Element.F32_2(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 == 111) {
            i4 = allocation.getType().getX();
        } else {
            i4 = allocation.getType().getY();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cher2k, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, float22.x, float22.y, allocation4.getID(this.mRS), j2, f, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i2, int i3, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        Allocation allocation4 = allocation2;
        validateUplo(i2);
        validateHERK(Element.F32_2(this.mRS), i5, allocation3, allocation4);
        if (i5 == 113) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cherk, i3, 0, 0, i2, 0, 0, allocation2.getType().getX(), i6, f, 0.0f, j2, 0, f2, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPR(int i2, float f, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 101, 0, 0, 0, i2, 0, 0, validateSPR, 0, f, 0.0f, j2, 0, 0.0f, 0.0f, j, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i2, Float2 float2, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i5 = i2;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i5, 0, 0, validateSPR2, 0, float22.x, float22.y, id2, id3, 0.0f, 0.0f, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i4 = i2;
            int i5 = i3;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 126, 0, 0, i4, i5, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.x, float23.y, id, id2, float24.x, float24.y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CSYR2K(int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateSYR2K(Element.F32_2(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, float23.x, float23.y, j3, j2, float24.x, float24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYRK(int i2, int i3, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        validateUplo(i2);
        int i5 = i3;
        validateL3(Element.F32_2(this.mRS), i5, 0, 0, allocation, (Allocation) null, allocation2);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        int i7 = i3;
        int i8 = i2;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 127, i7, 0, 0, i8, 0, 0, allocation2.getType().getX(), i6, float23.x, float23.y, id, 0, float24.x, float24.y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i2, int i3, int i4, int i5, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrmm, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.x, float22.y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i2, int i3, int i4, int i5, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 130, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.x, float22.y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGEMM(int i2, int i3, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i2, i3, 0, 0, 0, i7, i9, i8, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGER(double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 90, 0, 0, 0, 0, 0, y, x, 0, d, id2, id3, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSPR(int i2, double d, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 92, 0, 0, 0, i2, 0, 0, validateSPR, 0, d, j2, j, 0.0d, 0, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSPR2(int i2, double d, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 94, 0, 0, 0, i2, 0, 0, validateSPR2, 0, d, id2, id3, 0.0d, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void DSYR(int i2, double d, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 91, 0, 0, 0, i2, 0, 0, validateSYR, 0, d, j2, j, 0.0d, 0, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2(int i2, double d, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 93, 0, 0, 0, i2, 0, 0, validateSYR2, 0, d, id2, id3, 0.0d, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2K(int i2, int i3, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateSYR2K(Element.F64(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 122, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYRK(int i2, int i3, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        validateUplo(i2);
        int i5 = i3;
        validateL3(Element.F64(this.mRS), i5, 0, 0, allocation, (Allocation) null, allocation2);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        int i7 = i3;
        int i8 = i2;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i7, 0, 0, i8, 0, 0, allocation2.getType().getX(), i6, d, id, 0, d2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTBMV(int i2, int i3, int i4, int i5, Allocation allocation, Allocation allocation2, int i6) {
        ...
        if (i5 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 58, i3, 0, 0, i2, i4, 0, y, i5, 0.0d, id, id2, 0.0d, 0, i6, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void DTBSV(int i2, int i3, int i4, int i5, Allocation allocation, Allocation allocation2, int i6) {
        ...
        if (i5 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 61, i3, 0, 0, i2, i4, 0, y, i5, 0.0d, id, id2, 0.0d, 0, i6, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void DTPMV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 59, i3, 0, 0, i2, i4, 0, validateTPMV, 0, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTPSV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 62, i3, 0, 0, i2, i4, 0, validateTPMV, 0, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i2, int i3, int i4, int i5, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 57, i3, 0, 0, i2, i4, 0, y, 0, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i2, int i3, int i4, int i5, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 60, i3, 0, 0, i2, i4, 0, y, 0, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGEMM(int i2, int i3, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i2, i3, 0, 0, 0, i7, i9, i8, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGER(float f, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 82, 0, 0, 0, 0, 0, y, x, 0, f, id2, id3, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSPR(int i2, float f, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 84, 0, 0, 0, i2, 0, 0, validateSPR, 0, f, j2, j, 0.0f, 0, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSPR2(int i2, float f, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 86, 0, 0, 0, i2, 0, 0, validateSPR2, 0, f, id2, id3, 0.0f, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void SSYR(int i2, float f, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 83, 0, 0, 0, i2, 0, 0, validateSYR, 0, f, j2, j, 0.0f, 0, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2(int i2, float f, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 85, 0, 0, 0, i2, 0, 0, validateSYR2, 0, f, id2, id3, 0.0f, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2K(int i2, int i3, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateSYR2K(Element.F32(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 116, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYRK(int i2, int i3, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        validateUplo(i2);
        int i5 = i3;
        validateL3(Element.F32(this.mRS), i5, 0, 0, allocation, (Allocation) null, allocation2);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        int i7 = i3;
        int i8 = i2;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i7, 0, 0, i8, 0, 0, allocation2.getType().getX(), i6, f, id, 0, f2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMM(int i2, int i3, int i4, int i5, float f, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 117, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, j, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSM(int i2, int i3, int i4, int i5, float f, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 118, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, j, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMM(int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        validateTranspose(i3);
        int i7 = i2;
        validateL3(Element.F64_2(this.mRS), i7, i3, 0, allocation, allocation2, allocation3);
        if (i7 != 111) {
            i5 = allocation.getType().getX();
            i4 = allocation.getType().getY();
        } else {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i2, i3, 0, 0, 0, i8, i10, i9, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double22.x, double22.y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double22.x, double22.y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMM(int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zhemm, 0, 0, i2, i3, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER(int i2, double d, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 109, 0, 0, 0, i2, 0, 0, validateSYR, 0, d, 0.0d, j2, 0, 0.0d, 0.0d, j, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i2, Double2 double2, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i5 = i2;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i5, 0, 0, validateSYR2, 0, double22.x, double22.y, id2, id3, 0.0d, 0.0d, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateHER2K(Element.F64_2(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 == 111) {
            i4 = allocation.getType().getX();
        } else {
            i4 = allocation.getType().getY();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, double22.x, double22.y, allocation4.getID(this.mRS), j2, d, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHERK(int i2, int i3, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        Allocation allocation4 = allocation2;
        validateUplo(i2);
        validateHERK(Element.F64_2(this.mRS), i5, allocation3, allocation4);
        if (i5 == 113) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 141, i3, 0, 0, i2, 0, 0, allocation2.getType().getX(), i6, d, 0.0d, j2, 0, d2, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR(int i2, double d, Allocation allocation, int i3, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 110, 0, 0, 0, i2, 0, 0, validateSPR, 0, d, 0.0d, j2, 0, 0.0d, 0.0d, j, i3, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i2, Double2 double2, Allocation allocation, int i3, Allocation allocation2, int i4, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i5 = i2;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i5, 0, 0, validateSPR2, 0, double22.x, double22.y, id2, id3, 0.0d, 0.0d, j, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void ZSYR2K(int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i2);
        validateSYR2K(Element.F64_2(this.mRS), i5, allocation4, allocation5, allocation6);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyr2k, i3, 0, 0, i2, 0, 0, allocation3.getType().getX(), i6, double23.x, double23.y, j3, j2, double24.x, double24.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i2, int i3, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        validateUplo(i2);
        int i5 = i3;
        validateL3(Element.F64_2(this.mRS), i5, 0, 0, allocation, (Allocation) null, allocation2);
        if (i5 != 111) {
            i4 = allocation.getType().getY();
        } else {
            i4 = allocation.getType().getX();
        ...
        int i7 = i3;
        int i8 = i2;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyrk, i7, 0, 0, i8, 0, 0, allocation2.getType().getX(), i6, double23.x, double23.y, id, 0, double24.x, double24.y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTBMV(int i2, int i3, int i4, int i5, Allocation allocation, Allocation allocation2, int i6) {
        ...
        if (i5 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 74, i3, 0, 0, i2, i4, 0, y, i5, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i6, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void ZTBSV(int i2, int i3, int i4, int i5, Allocation allocation, Allocation allocation2, int i6) {
        ...
        if (i5 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 77, i3, 0, 0, i2, i4, 0, y, i5, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i6, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void ZTPMV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 75, i3, 0, 0, i2, i4, 0, validateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTPSV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 78, i3, 0, 0, i2, i4, 0, validateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i2, int i3, int i4, int i5, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrmm, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.x, double22.y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 73, i3, 0, 0, i2, i4, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i2, int i3, int i4, int i5, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i8 = i3;
        int i9 = i5;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrsm, i6, 0, i7, i8, i9, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.x, double22.y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSV(int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 76, i3, 0, 0, i2, i4, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
    }
}
