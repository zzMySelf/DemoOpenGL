...
public class Script extends BaseObj {
    ...
    public final SparseArray<InvokeID> mIIDs = new SparseArray<>();
    ...
    public void forEach(int i2, Allocation allocation, Allocation allocation2, FieldPacker fieldPacker) {
        ...
        RenderScript renderScript2 = this.mRS;
        renderScript2.nScriptForEach(getID(renderScript2), i2, id, j2, bArr2, this.mUseIncSupp);
    }
    ...
    public void setVar(int i2, long j) {
        RenderScript renderScript = this.mRS;
        renderScript.nScriptSetVarJ(getID(renderScript), i2, j, this.mUseIncSupp);
    }
    ...
    public void setVar(int i2, BaseObj baseObj) {
        ...
        renderScript2.nScriptSetVarObj(id, i2, j, this.mUseIncSupp);
    }
    ...
    public void forEach(int i2, Allocation allocation, Allocation allocation2, FieldPacker fieldPacker, LaunchOptions launchOptions) {
        ...
        if (allocation3 == null && allocation4 == null) {
            ...
            RenderScript renderScript2 = this.mRS;
            renderScript2.nScriptForEachClipped(getID(renderScript2), i2, id, j2, bArr2, launchOptions.xstart, launchOptions.xend, launchOptions.ystart, launchOptions.yend, launchOptions.zstart, launchOptions.zend, this.mUseIncSupp);
        }
    }
