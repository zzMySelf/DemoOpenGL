...
public class ScriptC extends Script {
    ...
    public static synchronized long internalCreate(androidx.renderscript.RenderScript r8, android.content.res.Resources r9, int r10) {
        /*
    ...
    public static synchronized long internalStringCreate(RenderScript renderScript, String str, byte[] bArr) {
        long nScriptCCreate;
