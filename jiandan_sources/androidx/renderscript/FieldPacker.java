...
public class FieldPacker {
    ...
    public static void addToPack(FieldPacker fieldPacker, Object obj) {
    ...
    public static int getPackedSize(Object obj) {
    ...
    public short subI16() {
        ...
        int i3 = i2 - 1;
        this.mPos = i3;
        return (short) (((short) (bArr[i3] & 255)) | ((short) ((bArr[i2] & 255) << 8)));
    }
    ...
    public int subI32() {
        ...
        int i6 = i5 - 1;
        this.mPos = i6;
        return (bArr[i6] & 255) | i3 | ((bArr[i4] & 255) << Ascii.DLE) | ((bArr[i5] & 255) << 8);
    }
