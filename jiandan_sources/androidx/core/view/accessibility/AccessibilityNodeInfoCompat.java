...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_SHOW_ON_SCREEN = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_ON_SCREEN : null, AccessibilityBridge.ACTION_SHOW_ON_SCREEN, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
    ...
    private boolean getBooleanProperty(int i2) {
        ...
        if (extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i2) == i2) {
            return true;
        }
        return false;
    }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        ...
        if (i2 >= 19 && i2 < 26) {
            ...
            if (clickableSpans != null && clickableSpans.length > 0) {
                ...
                int i3 = 0;
                while (clickableSpans != null && i3 < clickableSpans.length) {
