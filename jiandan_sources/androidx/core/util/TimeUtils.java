...
public final class TimeUtils {
    ...
    public static int formatDurationLocked(long j, int i2) {
        ...
        if (i8 != 0) {
            ...
            i7 = 0;
            for (int accumField5 = accumField4 + accumField(i11, 2, true, accumField4 > 0 ? 3 : 0) + 1; accumField5 < i8; accumField5++) {
                cArr[i7] = Ascii.CASE_MASK;
                i7++;
            }
        } else {
            i7 = 0;
    ...
    public static int printField(char[] cArr, int i2, char c, int i3, boolean z, int i4) {
        int i5;
        if (!z && i2 <= 0) {
            return i3;
        }
