            ...
            while (i4 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                            ...
                            if (c3 != 'q') {
                                if (c3 == 'v') {
                                    ...
                                    if (c3 == 'M') {
                                        ...
                                        int i24 = i4 + 2;
                                        int i25 = i4 + 3;
                                        path.cubicTo(f17, f26, fArr3[i22], fArr3[i23], fArr3[i24], fArr3[i25]);
                                        f4 = fArr3[i22];
                                        f3 = fArr3[i23];
                                        f17 = fArr3[i24];
                                        f18 = fArr3[i25];
                                        ...
                                        int i26 = i4 + 0;
                                        int i27 = i4 + 1;
                                        path2.quadTo(f17, f18, fArr3[i26], fArr3[i27]);
                                        float f27 = fArr3[i26];
                                        float f28 = fArr3[i27];
                                        i3 = i4;
                                        f14 = f18;
                                        ...
                                        int i34 = i4 + 2;
                                        int i35 = i4 + 3;
                                        path.rCubicTo(f8, f7, fArr3[i32], fArr3[i33], fArr3[i34], fArr3[i35]);
                                        f4 = fArr3[i32] + f17;
                                        f3 = fArr3[i33] + f18;
                                        f17 += fArr3[i34];
                                        f5 = fArr3[i35];
                                        ...
                                        int i36 = i4 + 0;
                                        int i37 = i4 + 1;
                                        path2.rQuadTo(f9, f10, fArr3[i36], fArr3[i37]);
                                        float f30 = f9 + f17;
                                        float f31 = f10 + f18;
                                        f17 += fArr3[i36];
                                        f18 += fArr3[i37];
                        ...
                        int i46 = i4 + 6;
                        i3 = i4;
                        drawArc(path, f17, f18, fArr3[i45] + f17, fArr3[i46] + f18, fArr3[i4 + 0], fArr3[i4 + 1], fArr3[i4 + 2], fArr3[i4 + 3] != 0.0f, fArr3[i4 + 4] != 0.0f);
                        f = f17 + fArr3[i45];
                        f2 = f18 + fArr3[i46];
                    }
                    i4 = i3 + i2;
                    ...
                    int i47 = i3 + 5;
                    int i48 = i3 + 6;
                    drawArc(path, f17, f18, fArr3[i47], fArr3[i48], fArr3[i3 + 0], fArr3[i3 + 1], fArr3[i3 + 2], fArr3[i3 + 3] != 0.0f, fArr3[i3 + 4] != 0.0f);
                    f = fArr3[i47];
                    f2 = fArr3[i48];
                }
                f14 = f18;
