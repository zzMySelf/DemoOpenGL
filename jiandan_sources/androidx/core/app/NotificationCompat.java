...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z, int i2, boolean z2, boolean z3) {
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i4 = 0; i4 < remoteInputs.length; i4++) {
                ...
                remoteInputArr2[i4] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? remoteInput.getEditChoicesBeforeSending() : 0, remoteInput.getExtras(), (Set<String>) null);
            }
        ...
        if (action.getIcon() == null && (i3 = action2.icon) != 0) {
            return new Action(i3, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual);
        }
