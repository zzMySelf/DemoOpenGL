...
public class ShortcutManagerCompat {
    ...
    public static boolean pushDynamicShortcut(@androidx.annotation.NonNull android.content.Context r6, @androidx.annotation.NonNull androidx.core.content.pm.ShortcutInfoCompat r7) {
        ...
        L_0x0069:
            ...
            java.util.List r3 = r2.getShortcuts()     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            int r5 = r3.size()     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            if (r5 < r0) goto L_0x0086
            java.lang.String[] r0 = new java.lang.String[r4]     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            java.lang.String r3 = getShortcutInfoCompatWithLowestRank(r3)     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            r0[r1] = r3     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            r2.removeShortcuts(r0)     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
        L_0x0086:
            androidx.core.content.pm.ShortcutInfoCompat[] r0 = new androidx.core.content.pm.ShortcutInfoCompat[r4]     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            r0[r1] = r7     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
            r2.addShortcuts(r0)     // Catch:{ Exception -> 0x00da, all -> 0x00b5 }
