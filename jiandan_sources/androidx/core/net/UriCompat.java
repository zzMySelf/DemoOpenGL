...
public final class UriCompat {
    ...
    public static String toSafeString(@NonNull Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase("tel") || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase(IWalletLoginListener.LOGIN_TYPE_SMS) || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase(MailTo.MAILTO) || scheme.equalsIgnoreCase("nfc")) {
